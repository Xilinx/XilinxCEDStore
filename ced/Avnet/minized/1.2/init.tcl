...
proc getConfigDesignInfo {} { 
  return [dict create name {MiniZED_Redux} description {}]
}

proc getSupportedParts {} { 
  return [list zynq{xc7z007sclg225-1}]
}

proc getSupportedBoards {} { 
  return [list em.avnet.com:minized:1.2]
}
...
proc createDesign { project_name {project_location "."} {options ""}} { 
  ...
  catch {source -notrace "$currentDir/MiniZED_Redux_design.tcl"} retString 
