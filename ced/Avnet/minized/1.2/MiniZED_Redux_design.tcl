...
#
# MiniZED_Redux_design.tcl: Tcl script for re-creating project 'minized_retested_ced_2018.2'
#
# Generated by Vivado on Thu Oct 04 21:59:09 PDT 2018
...
set _xil_proj_name_ "minized_retested_ced_2018.2"
...
set script_file "MiniZED_Redux_design.tcl"
...
set_property -name "board_part_repo_paths" -value "/home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/arty-s7-50/board_files /home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/PicoZED_CED_1.0/board_files /home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/kcu105/board_files /home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/Video_x1_KCU105/board_files /home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/combineXDF/board_files /home/danielm/Desktop/vivLogs/checkBoards/ced/Partner/minized/board_files" -objects $obj
...
set_property -name "ip.user_files_dir" -value "/home/danielm/Desktop/vivLogs/2018.2/${_xil_proj_name_}/Avnet/minized/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "mem.enable_memory_map_generation" -value "1" -objects $obj
set_property -name "sim.central_dir" -value "/home/danielm/Desktop/vivLogs/2018.2/${_xil_proj_name_}/Avnet/minized/${_xil_proj_name_}/${_xil_proj_name_}.ip_user_files" -objects $obj
...
set files [list \
 "[file dirname [file normalize [info script]]]/sources/sources/design_1_wrapper.v" \
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GPIO2_BOARD_INTERFACE {pl_led_r} \
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z007sclg225-1 -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z007sclg225-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
