...
#
# ultra96_design.tcl: Tcl script for re-creating project 'Ultra96_example_project'
#
# Generated by Vivado on Wed Nov 07 17:47:24 -0800 2018
...
set _xil_proj_name_ "Ultra96_example_project"
...
set_property -name "board_part" -value "em.avnet.com:ultra96:part0:1.2" -objects $obj
...
set files [list \
 "[file dirname [file normalize [info script]]]/sources/hdl/design_1_wrapper.v" \
]
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property USER_COMMENTS.comment_0 "Ultra96™ is an Arm-based, Xilinx Zynq UltraScale+™ MPSoC development board based on the Linaro 96Boards 
specification. The 96Boards’ specifications are open and define a standard board layout for development platforms 
that can be used by software application, hardware device, kernel, and other system software developers. Ultra96 
represents a unique position in the 96Boards community with a wide range of potential peripherals and acceleration 
engines in the programmable logic that is not available from other offerings." [get_bd_designs $design_name]
  ...
  regenerate_bd_layout -layout_string {
   ...
   comment_0: "Ultra96™ is an Arm-based, Xilinx Zynq UltraScale+™ MPSoC development board based on the Linaro 96Boards 
specification. The 96Boards’ specifications are open and define a standard board layout for development platforms 
that can be used by software application, hardware device, kernel, and other system software developers. Ultra96 
represents a unique position in the 96Boards community with a wide range of potential peripherals and acceleration 
engines in the programmable logic that is not available from other offerings.",
   commentid: "comment_0|",
   font_comment_0: "14",
   guistr: "# # String gsaved with Nlview 6.8.5  2018-01-30 bk=1.4354 VDI=40 GEI=35 GUI=JA:1.6 non-TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -y 100 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 2 20 10 620
levelinfo -pg 1 0 320 640 -top 0 -bot 190
",
   linktoobj_comment_0: "",
  ...
  set_property USER_COMMENTS.comment_SED_SimulationMain "ultra96:\nSimulation testbench may not be included" [get_bd_designs $design_name]
