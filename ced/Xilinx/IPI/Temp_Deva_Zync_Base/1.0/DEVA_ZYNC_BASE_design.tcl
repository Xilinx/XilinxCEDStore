...
#
# DEVA_ZYNC_BASE_design.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Thu Sep 26 15:38:07 IST 2019
...
set script_file "DEVA_ZYNC_BASE_design.tcl"
...
set files [list \
 [file normalize "${origin_dir}/project_1/project_1.srcs/sources_1/bd/base_zynq/hdl/base_zynq_wrapper.vhd" ]\
]
...
set file "hdl/base_zynq_wrapper.vhd"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/project_1/project_1.srcs/sim_1/imports/base_zynq/zynq_tb.v"]\
]
...
# Proc to create BD base_zynq
proc cr_bd_base_zynq { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.885312",
   "Default View_TopLeft":"0,-212",
...
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1370 -y 340 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1370 -y 360 -defaultsOSRD
preplace port leds_4bits -pg 1 -lvl 5 -x 1370 -y 80 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 240 -y 420 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 940 -y 80 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 4 -x 1220 -y 220 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 3 -x 940 -y 220 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 630 -y 190 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 240 -y 170 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 270 470 50 790
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 280 450
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 460 330 800
preplace netloc axi_gpio_0_GPIO 1 3 2 NJ 80 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 3 1 NJ 220
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 780 60n
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 480 110n
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 360 NJ 360 NJ 360 NJ
preplace netloc processing_system7_0_DDR 1 1 4 NJ 340 NJ 340 NJ 340 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N 200
levelinfo -pg 1 0 240 630 940 1220 1370
pagesize -pg 1 -db -bbox -sgen 0 0 1500 560
"
}
...
# End of cr_bd_base_zynq()
cr_bd_base_zynq ""
set_property REGISTERED_WITH_MANAGER "1" [get_files base_zynq.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files base_zynq.bd ] 
