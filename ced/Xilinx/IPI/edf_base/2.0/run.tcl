...
set ncr_path [get_files -of [get_filesets utils_1]]
set_property NOC_SOLUTION_FILE $ncr_path [get_runs impl_1]
} }
...
puts "INFO: Versal Embedded Common Platform CED version-2.0 design creation is completed"
