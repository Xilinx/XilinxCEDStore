...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {pcie0_s_axis_cc_0:pcie0_m_axis_rc_0:pcie0_m_axis_cq_0:pcie0_s_axis_rq_0} \
   CONFIG.FREQ_HZ {250000000} \
 ] $pcie0_user_clk_0
  ...
  set_property -dict [list \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      PMC_MIO38 {{AUX_IO 0} {DIRECTION out} {DRIVE_STRENGTH 8mA} {OUTPUT_DATA default} {PULL pullup} {SCHMITT 1} {SLEW slow} {USAGE Reserved}} \
...
{IO {PMC_MIO 0 .. 11}}} \
      ...
      PS_CRL_CPM_TOPSW_REF_CTRL_FREQMHZ {625} \
      ...
      PS_MIO0 {{AUX_IO 0} {DIRECTION out} {DRIVE_STRENGTH 8mA} {OUTPUT_DATA default} {PULL pullup} {SCHMITT 1} {SLEW slow} {USAGE Unassigned}} \
