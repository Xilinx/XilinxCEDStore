...
proc create_hier_cell_dc_in_out { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins dc_input_pipeline/vid_intf1] [get_bd_intf_pins vid_intf1]
...
NON_KSB DDRMC5_SELF_REFRESH DISABLE DDRMC5_LBDQ_SWAP false DDRMC5_CAL_MASK_POLL ENABLE DDRMC5_BOARD_INTRF_EN false} \
  ...
  connect_bd_intf_net -intf_net dc_in_out_vid_intf1 [get_bd_intf_pins dc_in_out/vid_intf1] [get_bd_intf_pins ps_wizard_0/live_video1]
