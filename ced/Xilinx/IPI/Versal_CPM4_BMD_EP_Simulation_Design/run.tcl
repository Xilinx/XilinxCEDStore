...
set files [list \
 ...
 [file normalize "${currentDir}/src/pcie_app_versal_bmd.vh"] \
 [file normalize "${currentDir}/src/BMD_AXIST_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_CC_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_CQ_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_EP_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_RC_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_RQ_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_RQ_MUX_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_RQ_READ_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_RQ_WRITE_512.sv"] \
 [file normalize "${currentDir}/src/BMD_AXIST_TO_CTRL.sv"] \
 [file normalize "${currentDir}/src/pcie_app_versal_bmd.sv"] \
...
set files [list \
 ...
 [file normalize "${currentDir}/sim_files/pci_exp_usrapp_top.v"]\
...
set_property USER_COMMENTS.comment_0 {} [current_bd_design]
    ...
    1. Refer to https://github.com/Xilinx/XilinxCEDStore/tree/2023.2/ced/Xilinx/IPI/Versal_CPM4_BMD_Simulation_Design/readme.txt} [current_bd_design]

    regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "comment_0":"Next Steps:
    1. Refer to https://github.com/Xilinx/XilinxCEDStore/tree/2023.2/ced/Xilinx/IPI/Versal_CPM4_BMD_Simulation_Design/readme.txt",
   "commentid":"comment_0|",
   "font_comment_0":"18",
