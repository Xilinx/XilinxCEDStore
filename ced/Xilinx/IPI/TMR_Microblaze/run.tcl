...
proc create_hier_cell_MB3 { parentCell nameHier } {
 ...
 set microblaze_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect microblaze_0_axi_periph ]
  set_property -dict [list \
    CONFIG.NUM_MI {12} \
    CONFIG.NUM_SI {1} \
  ...
  set microblaze_0_xlconcat [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconcat:* microblaze_0_xlconcat ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {10} \
