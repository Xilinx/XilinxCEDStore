...
#  set boards [list vck190 vmk180 vpk120 vhk158]
  ...
  if {[string length [get_board_parts -filter {BOARD_NAME=~"*vek280" && VENDOR_NAME=="xilinx.com"}]] != 0 } {
    lappend boards "vek280"
  }
  if {[string length [get_board_parts -filter {BOARD_NAME=~"*vek385" && VENDOR_NAME=="xilinx.com"}]] != 0 } {
