...
connect_bd_net [get_bd_pins ps_wizard_0/hsm1_ref_clk] [get_bd_pins NoC_C3/sys_clk0] [get_bd_pins NoC_C2/sys_clk0] [get_bd_pins NoC_C4/sys_clk0]
...
connect_bd_intf_net [get_bd_intf_pins Master_NoC/M04_INI] [get_bd_intf_pins NoC_C2/S00_INI]
connect_bd_intf_net [get_bd_intf_pins Master_NoC/M05_INI] [get_bd_intf_pins NoC_C3/S00_INI]
connect_bd_intf_net [get_bd_intf_pins Master_NoC/M06_INI] [get_bd_intf_pins NoC_C4/S00_INI]
...
connect_bd_intf_net [get_bd_intf_pins aggr_noc/M05_INI] [get_bd_intf_pins NoC_C4/S01_INI]
connect_bd_intf_net [get_bd_intf_pins aggr_noc/M06_INI] [get_bd_intf_pins NoC_C4/S02_INI]
...
if { $use_cascaded_irqs } {
	...
	#create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:* ilconcat_0
	#set_property -dict [list CONFIG.NUM_PORTS {32} CONFIG.IN0_WIDTH {1}] [get_bd_cells ilconcat_0]
	
	create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconcat:* ilconcat_0
	set_property CONFIG.NUM_PORTS {32} [get_bd_cells ilconcat_0]
}
...
connect_bd_net [get_bd_pins ilconstant_2/dout] [get_bd_pins clk_wizard_0/${default_mbuf_port}_clr_n]
connect_bd_net [get_bd_pins clk_wizard_0/${default_mbuf_port}_ce] [get_bd_pins ilconstant_2/dout] }
...
# if { $mbufgce } {
	# set default_clk_port ${mbuf_cklport}4
# }
...
connect_bd_net -net $default_clock_net [get_bd_pins clk_wizard_0/$default_clk_port] [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins ctrl_smc/aclk] [get_bd_pins ps_wizard_0/lpd_axi_pl_aclk]
...
if { $use_cascaded_irqs } {
	...
	connect_bd_net [get_bd_pins axi_intc_cascaded_1/irq] [get_bd_pins ilconcat_0/In31]
	connect_bd_net [get_bd_pins axi_intc_parent/intr] [get_bd_pins ilconcat_0/dout]
...
set_property PFM.AXI_PORT {S00_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S01_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S02_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S03_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S04_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S05_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S06_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S07_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S08_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S09_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S10_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S11_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S12_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S13_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S14_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S15_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S16_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S17_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S18_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S19_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S20_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S21_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S22_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S23_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S24_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S25_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S26_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S27_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S28_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"} S29_AXI {memport "S_AXI_NOC" sptag "LPDDR2"  is_range "true"}} [get_bd_cells /NoC_C2]
