#############################################################
# VEK385 Extensible CED v1.2 updates for 2025.1.1 release
#############################################################
puts "INFO: Block design generation completed, yet to set PFM properties"

# Create PFM attributes
set pfmName "xilinx.com:vek385:vek385_base:1.0"
...
set clk_default { clk_out1 625 0 true clk_out2 100 1 false }
