...
proc createDesign {design_name options} {  
  ...
  proc create_root_design {currentDir design_name use_ddr clk_options irqs} {
    ...
    if {$irqs == "32"} {
      ...
      connect_bd_net [get_bd_pins clk_wiz_0/$default_clk_port] [get_bd_pins smartconnect_axilite/aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins ps_e/maxihpm0_fpd_aclk]
    ...
    if {!$use_ddr } {
      ...
      connect_bd_net [get_bd_pins clk_wiz_0/$default_clk_port] [get_bd_pins smartconnect_axihpm0fpd/aclk]
  ...
  puts "Debug Flag : Setting PFM properties for AXI Interfaces"
  set parVal []
