...
proc create_hier_cell_rst_module { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins dc_input_pipeline/S00_AXI]
  ...
  connect_bd_net [get_bd_pins ps_wizard_0/mmi_pl_dc_1x_clk] [get_bd_pins dc_input_pipeline/vid_clk1] \
