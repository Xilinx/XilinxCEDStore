...
######################## setting comments #######################
set_property USER_COMMENTS.comment_0 {MMI DPDC Functional design with Mixed as Presentation mode and num of lanes is X4} [current_bd_design]
#####################################################################
...
proc create_hier_cell_dc_input_pipeline { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net smartconnect_gp0_M01_AXI [get_bd_intf_pins smartconnect_gp0/M01_AXI] [get_bd_intf_pins avtpg_vp0/av_axi]
  connect_bd_intf_net -intf_net smartconnect_gp0_M02_AXI [get_bd_intf_pins smartconnect_gp0/M02_AXI] [get_bd_intf_pins avtpg_vp0/ctrl]
...
proc create_hier_cell_rst_module { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.MMI_CONFIG(DC_LIVE_VIDEO_SELECT) {V01} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins Live_input_gpio/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins vid_format_gpio/S_AXI]
  ...
  [get_bd_pins ps_wizard_0/lpd_axi_pl_aclk] 
  connect_bd_net -net clkx5_wiz_0_i2s_clk  [get_bd_pins mmi_aud_clk_wiz/i2s_clk_x2] \
  ...
  connect_bd_net [get_bd_pins mmi_vid_clk_wiz/pl_vid_2x_clk_o2] [get_bd_pins dc_input_pipeline/vid_clk1] \
  ...
  connect_bd_net -net clkx5_wiz_1_locked  [get_bd_pins mmi_aud_clk_wiz/locked] \
  [get_bd_pins rst_module/dcm_locked1]
  connect_bd_net -net rst_module_peripheral_aresetn [get_bd_pins rst_module/peripheral_aresetn] [get_bd_pins vid_format_status_gpio/s_axi_aresetn] \
