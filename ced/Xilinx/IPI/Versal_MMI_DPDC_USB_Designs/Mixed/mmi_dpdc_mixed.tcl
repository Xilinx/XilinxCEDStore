...
proc create_hier_cell_rst_module { parentCell nameHier } {
  ...
  connect_bd_net [get_bd_pins clkx5_wiz_0/pl_vid_2x_clk_o2] [get_bd_pins dc_input_pipeline/vid_clk1] \
  ...
  connect_bd_net -net rst_module_peripheral_aresetn [get_bd_pins rst_module/peripheral_aresetn] [get_bd_pins rd_clk_wiz_status_gpio/s_axi_aresetn] \
