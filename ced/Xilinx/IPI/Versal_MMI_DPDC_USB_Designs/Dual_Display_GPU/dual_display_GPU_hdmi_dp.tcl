...
set_property -dict [list CONFIG.W_TRAFFIC_CLASS {ISOCHRONOUS}] [get_bd_intf_pins /aggr_noc/S04_AXI]
set_property -dict [list CONFIG.W_TRAFFIC_CLASS {ISOCHRONOUS}] [get_bd_intf_pins /aggr_noc/S05_AXI]
...
connect_bd_net [get_bd_pins VCU_hier/vcu2_0/c0_enc_mcu_m_axi_noc_clk] [get_bd_pins aggr_noc/aclk3]
  ...
  set_property -dict [list \
    ...
    CONFIG.PS11_CONFIG(PL_LPD_IRQ_USAGE) {CH0 1 CH1 1 CH2 1 CH3 1 CH4 1 CH5 1 CH6 1 CH7 0 CH8 0 CH9 0 CH10 0 CH11 0 CH12 0 CH13 0 CH14 0 CH15 0 CH16 0 CH17 0 CH18 0 CH19 0 CH20 0 CH21 1 CH22 1 CH23 1} \
  ] [get_bd_cells ps_wizard_0]
...
set_property -dict [list \
  ...
  CONFIG.C_TILE0_ISP0_IO_TYPE {3} \
  CONFIG.C_TILE0_ISP1_CORE_CLK {600.1} \
  CONFIG.C_TILE0_ISP1_IO_TYPE {3} \
...
#set_property name rst_clk [get_bd_cells proc_sys_reset_0]
  ...
  connect_bd_intf_net [get_bd_intf_pins ctrl_smc/M04_AXI] [get_bd_intf_pins isp_smc/S00_AXI]

  #connect_bd_intf_net -intf_net ctrl_smc_M06_AXI [get_bd_intf_pins isp_smc/S00_AXI] [get_bd_intf_pins ps_wizard_0/FPD_AXI_PL]
 
  connect_bd_net [get_bd_pins rst_clk/peripheral_aresetn] [get_bd_pins isp_smc/aresetn]
  connect_bd_intf_net [get_bd_intf_pins isp_smc/M00_AXI] [get_bd_intf_pins  ISP_hier/visp_ss_tile0/S_AXI_LITE]
  
  connect_bd_intf_net [get_bd_intf_pins aggr_noc/S04_AXI] [get_bd_intf_pins ISP_hier/visp_ss_tile0/TILE0_ISP0_NMU]
  connect_bd_intf_net [get_bd_intf_pins aggr_noc/S05_AXI] [get_bd_intf_pins ISP_hier/visp_ss_tile0/TILE0_ISP1_NMU]
  connect_bd_net [get_bd_pins aggr_noc/aclk4] [get_bd_pins ISP_hier/visp_ss_tile0/tile0_nmu0_axi_clk]
  connect_bd_net [get_bd_pins aggr_noc/aclk5] [get_bd_pins ISP_hier/visp_ss_tile0/tile0_nmu1_axi_clk]
  
 
  connect_bd_net [get_bd_pins ISP_hier/visp_ss_tile0/tile0_ref_dpll_clk] [get_bd_pins ps_wizard_0/pl1_ref_clk]
  connect_bd_net [get_bd_pins rst_clk/peripheral_aresetn] \
  [get_bd_pins  ISP_hier/visp_ss_tile0/s_axi_lite_rstn] \
  [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_pl_isp_rstn]
 
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp_isr_irq] [get_bd_pins ps_wizard_0/pl_lpd_irq0]
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp_xmpu_interrupt] [get_bd_pins ps_wizard_0/pl_lpd_irq1]
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp0_fusa_irq] [get_bd_pins ps_wizard_0/pl_lpd_irq2]
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp0_isp_irq] [get_bd_pins ps_wizard_0/pl_lpd_irq3]
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp1_fusa_irq] [get_bd_pins ps_wizard_0/pl_lpd_irq4]
  connect_bd_net [get_bd_pins  ISP_hier/visp_ss_tile0/tile0_isp1_isp_irq] [get_bd_pins ps_wizard_0/pl_lpd_irq5]
 
 
  #connect_bd_net [get_bd_pins clkx5_wiz_0/clk_in1] [get_bd_pins ps_wizard_0/pl0_ref_clk]
  #connect_bd_net [get_bd_pins clkx5_wiz_0/resetn] [get_bd_pins ps_wizard_0/pl0_resetn]
  #disconnect_bd_net /ilconstant_1_dout [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins ps_wizard_0/lpd_axi_pl_aclk]
  #connect_bd_net [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins clkx5_wiz_0/clk_out1]
  #connect_bd_net [get_bd_pins ps_wizard_0/lpd_axi_pl_aclk] [get_bd_pins clkx5_wiz_0/clk_out1]
  connect_bd_net  [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins isp_smc/aclk] \
  ...
  assign_bd_address -offset 0xB1300000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs  ISP_hier/visp_ss_tile0/S_AXI_LITE/Reg] -force
...
set_property offset 0xB0F50000 [get_bd_addr_segs {ps_wizard_0/ps11_0_cortexa78_7/SEG_vcu_gpio_reset_Reg}]
  ...
  add_files -fileset constrs_1 $currentDir/Dual_Display_GPU/hdmi_vek385.xdc
