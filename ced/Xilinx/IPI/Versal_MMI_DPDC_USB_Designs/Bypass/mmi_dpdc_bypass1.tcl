...
proc create_hier_cell_rst_module { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ctrl_smc_M09_AXI [get_bd_intf_pins ctrl_smc/M09_AXI] [get_bd_intf_pins clkx5_wiz_1/s_axi_lite]
  connect_bd_intf_net -intf_net ctrl_smc_M10_AXI [get_bd_intf_pins ctrl_smc/M10_AXI] [get_bd_intf_pins Live_input_gpio/S_AXI]
  connect_bd_intf_net -intf_net ctrl_smc_M11_AXI [get_bd_intf_pins ctrl_smc/M11_AXI] [get_bd_intf_pins rd_clk_wiz_status_gpio/S_AXI]
