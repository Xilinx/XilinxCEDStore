...
# Create instance: mmi_vid_clk_wiz, and set properties
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M09_AXI [get_bd_intf_pins smartconnect_0/M09_AXI] [get_bd_intf_pins avtpg_s0/s_axi_ctrl]
  ...
  connect_bd_net -net mmi_vid_clk_wiz_pl_vid_2x_clk_o1  [get_bd_pins mmi_vid_clk_wiz/pl_vid_2x_clk_o1] \
  [get_bd_pins ps_wizard_0/pl_mmi_dc_2x_clk]
  connect_bd_net -net mmi_vid_clk_wiz_pl_vid_2x_clk_o2  [get_bd_pins mmi_vid_clk_wiz/pl_vid_2x_clk_o2] \
