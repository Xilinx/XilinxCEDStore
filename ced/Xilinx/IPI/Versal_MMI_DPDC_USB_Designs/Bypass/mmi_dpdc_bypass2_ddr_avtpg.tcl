...
######################## setting comments #######################
set_property USER_COMMENTS.comment_0 {MMI DPDC Bypass design with 2 MST each 2 pixel as Presentation mode and num of lanes is X4} [current_bd_design]
#####################################################################
...
proc create_hier_cell_avtpg_s1 { parentCell nameHier } {
 ...
 ] [get_bd_intf_pins $axi_noc2_frmbuf_rd/M00_INI]

  set_property -dict [ list \
   CONFIG.DATA_WIDTH {128} \
   CONFIG.R_TRAFFIC_CLASS {ISOCHRONOUS} \
   CONFIG.CONNECTIONS {M00_INI {read_bw {2000} write_bw {500} }} \
   CONFIG.DEST_IDS {} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl} \
  ...
  # Create instance: frmbuf_rd_rst_gpio_0, and set properties
  set frmbuf_rd_rst_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio frmbuf_rd_rst_gpio_0 ]
  set_property -dict [list \
    CONFIG.C_ALL_INPUTS {0} \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_DOUT_DEFAULT {0x00000001} \
    CONFIG.C_GPIO_WIDTH {1} \
  ] $frmbuf_rd_rst_gpio_0

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins ctrl] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins axi_noc2_frmbuf_rd/M00_INI] [get_bd_intf_pins M00_INI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins frmbuf_rd_rst_gpio_0/S_AXI] [get_bd_intf_pins S_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins v_frmbuf_rd_0/s_axi_CTRL] [get_bd_intf_pins s_axi_CTRL]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o  [get_bd_pins frmbuf_rd_rst_gpio_0/gpio_io_o] \
  ...
  [get_bd_pins axi_noc2_frmbuf_rd/aclk0] \
  [get_bd_pins frmbuf_rd_rst_gpio_0/s_axi_aclk]
  ...
  [get_bd_pins frmbuf_rd_rst_gpio_0/s_axi_aresetn]
...
proc create_hier_cell_rst_module { parentCell nameHier } {
 ...
 #Create ports
  ...
  set_property -dict [list \
    ...
    CONFIG.MMI_CONFIG(DPDC_STREAM1_MODE) {Video_only} \
    CONFIG.MMI_CONFIG(DPDC_STREAM1_PIXEL_MODE) {Dual} \
    CONFIG.MMI_CONFIG(DPDC_STREAM1_SDP_EN) {0} \
  ...
  # port to connect read frame buffer to Noc
  set_property -dict [list \
    CONFIG.NUM_NSI {6} \
...
# Create instance: mmi_vid_clk_wiz, and set properties
  ...
  # Create interface connections
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins avtpg_s1/M00_INI] [get_bd_intf_pins hier_NOC/NoC_C0_C1/S05_INI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins avtpg_s0/s_axi_ctrl]
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins smartconnect_0/M05_AXI] [get_bd_intf_pins avtpg_s1/ctrl]
  connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins smartconnect_0/M06_AXI] [get_bd_intf_pins avtpg_s1/s_axi_CTRL]
  connect_bd_intf_net -intf_net smartconnect_0_M07_AXI [get_bd_intf_pins smartconnect_0/M07_AXI] [get_bd_intf_pins avtpg_s0/av_axi]
  connect_bd_intf_net -intf_net smartconnect_0_M08_AXI [get_bd_intf_pins smartconnect_0/M08_AXI] [get_bd_intf_pins avtpg_s0/ctrl]
  connect_bd_intf_net -intf_net smartconnect_0_M09_AXI [get_bd_intf_pins smartconnect_0/M09_AXI] [get_bd_intf_pins avtpg_s1/S_AXI]
  ...
  connect_bd_net -net avtpg_s1_interrupt  [get_bd_pins avtpg_s1/interrupt] \
  ...
  connect_bd_net -net mmi_vid_clk_wiz_pl_vid_2x_clk  [get_bd_pins mmi_vid_clk_wiz/pl_vid_2x_clk] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces avtpg_s1/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs hier_NOC/NoC_C0_C1/DDR_MC_PORTS/DDR_CH0_LEGACYx2] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0420000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s0/i2s_transmitter_0/s_axi_ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xB0410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s0/v_tc_0/ctrl/Reg] -force
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  assign_bd_address -offset 0xB0A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs vid_format_gpio/S_AXI/Reg] -forc
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_0] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_1] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_1] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_1] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_2] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_2] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_3] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_3] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_3] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_4] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_4] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_4] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_5] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_5] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_5] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_6] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_6] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_6] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
  ...
  assign_bd_address -offset 0xB0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_7] [get_bd_addr_segs avtpg_s1/frmbuf_rd_rst_gpio_0/S_AXI/Reg] -force 
  ...
  assign_bd_address -offset 0xB0A30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_7] [get_bd_addr_segs avtpg_s1/v_frmbuf_rd_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xB0450000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_wizard_0/ps11_0_cortexa78_7] [get_bd_addr_segs avtpg_s1/v_tc_0/ctrl/Reg] -force
 ...
 # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces avtpg_s1/v_frmbuf_rd_0/Data_m_axi_mm_video] [get_bd_addr_segs hier_NOC/NoC_C0_C1/DDR_MC_PORTS/DDR_CH0_MEDx2]
  exclude_bd_addr_seg 
