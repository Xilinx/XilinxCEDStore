...
######################## setting comments #######################
set_property USER_COMMENTS.comment_0 {MMI DPDC Functional design with Live native as Presentation mode and num of lanes is X4} [current_bd_design]
#####################################################################
...
proc create_hier_cell_rst_module { parentCell nameHier } {
  ...
  connect_bd_intf_net -boundary_type upper [get_bd_intf_pins dc_input_pipeline/vid_intf1] [get_bd_intf_pins ps_wizard_0/live_video1]
  ...
  connect_bd_net [get_bd_pins ps_wizard_0/mmi_pl_dc_1x_clk] [get_bd_pins rst_module/slowest_sync_clk] \
