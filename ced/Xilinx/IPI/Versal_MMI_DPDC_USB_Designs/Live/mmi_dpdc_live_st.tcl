...
proc create_hier_cell_pl_video_s0p0 { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins v_frmbuf_wr_0/s_axis_video] [get_bd_intf_pins s_axis_video]
...
proc create_hier_cell_dc_pl_out_pipeline { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins pl_video_s0p0/s_axis_video] [get_bd_intf_pins s_axis_video]
  ...
  # Create port connections
  connect_bd_net -net In0_1  [get_bd_pins In0] \
  [get_bd_pins pl_video_s0p0/In0]
  connect_bd_net -net In1_1  [get_bd_pins In1] \
  [get_bd_pins pl_video_s0p0/In1]
...
NA DDRMC5_FPGA_DEVICE_TYPE NON_KSB DDRMC5_SELF_REFRESH DISABLE DDRMC5_LBDQ_SWAP false DDRMC5_CAL_MASK_POLL ENABLE DDRMC5_BOARD_INTRF_EN false} \
  ...
  connect_bd_intf_net -intf_net ps_wizard_0_vid_fdbk_axi [get_bd_intf_pins ps_wizard_0/vid_fdbk_axi] [get_bd_intf_pins dc_pl_out_pipeline/s_axis_video]
  ...
  connect_bd_net -net ps_wizard_0_vid_fdbk_hres_cntr  [get_bd_pins ps_wizard_0/vid_fdbk_hres_cntr] \
  [get_bd_pins dc_pl_out_pipeline/In0]
  connect_bd_net -net ps_wizard_0_vid_fdbk_vres_cntr  [get_bd_pins ps_wizard_0/vid_fdbk_vres_cntr] \
  [get_bd_pins dc_pl_out_pipeline/In1]
  ...
  [get_bd_pins ps_wizard_0/vid_fdbk_reset]
