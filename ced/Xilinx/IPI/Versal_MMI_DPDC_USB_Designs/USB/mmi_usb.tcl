...
0x4 CLK_50_DDR_ITAP_DLY 0x2A CLK_50_DDR_OTAP_DLY 0x3 CLK_100_SDR_OTAP_DLY 0x3 CLK_200_SDR_OTAP_DLY 0x2} \
  ...
  set_property -dict [list \
    ...
    CONFIG.DDRMC5_CONFIG(DDRMC5_F0_TCK) {1250} \
    ...
    CONFIG.DDRMC5_CONFIG(DDRMC5_F1_TCK) {1250} \
 ...
 ] [get_bd_intf_pins /axi_noc2_s0/S10_AXI]

  set_property -dict [ list \
   CONFIG.R_TRAFFIC_CLASS {ISOCHRONOUS} \
   CONFIG.CONNECTIONS {MC_0 {read_bw {2000} write_bw {500} read_avg_burst {4} write_avg_burst {4} initial_boot {true}}} \
   CONFIG.DEST_IDS {} \
   CONFIG.CATEGORY {ps_mmi} \
 ] [get_bd_intf_pins /axi_noc2_s0/S11_AXI]
 ...
 ] [get_bd_pins /axi_noc2_s0/aclk10]

  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S11_AXI} \
 ] [get_bd_pins /axi_noc2_s0/aclk11]

  # Create interface connections
  connect_bd_intf_net -intf_net C0_C1_LPDDR5X_sys_clk_1 [get_bd_intf_ports C0_C1_LPDDR5X_sys_clk] [get_bd_intf_pins axi_noc2_s0/sys_clk0]
  ...
  connect_bd_intf_net -intf_net ps_wizard_0_FPD_AXI_NOC8 [get_bd_intf_pins ps_wizard_0/FPD_AXI_NOC8] [get_bd_intf_pins axi_noc2_s0/S08_AXI]
  ...
  connect_bd_intf_net -intf_net ps_wizard_0_MMI_DC_AXI_NOC0 [get_bd_intf_pins ps_wizard_0/MMI_DC_AXI_NOC0] [get_bd_intf_pins axi_noc2_s0/S11_AXI]
  connect_bd_intf_net -intf_net ps_wizard_0_PMC_AXI_NOC0 [get_bd_intf_pins ps_wizard_0/PMC_AXI_NOC0] [get_bd_intf_pins axi_noc2_s0/S10_AXI]
