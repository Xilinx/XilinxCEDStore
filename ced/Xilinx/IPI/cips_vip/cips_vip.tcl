...
set_property -dict [list CONFIG.NUM_SI {7} CONFIG.NUM_MI {0} CONFIG.NUM_CLKS {7} CONFIG.NUM_MCP {4} CONFIG.MC_CHAN_REGION1 {DDR_LOW1}] [get_bd_cells axi_noc_0]
...
create_root_design  $currentDir $design_name "" 
	...
	2. Run Simulation.
	3. Refer to README.md} [current_bd_design]
