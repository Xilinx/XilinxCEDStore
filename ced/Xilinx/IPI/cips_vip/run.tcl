...
create_root_design  $currentDir $design_name "" 
	...
	2. Run Simulation.
	3. Refer to README.md https://github.com/Xilinx/XilinxCEDStore/tree/2024.1/ced/Xilinx/IPI/cips_vip/README.md} [current_bd_design]
   ...
   "comment_0":"Next Steps:
	1. Generate Block Design (Choose global for quick turnaround).
	2. Run Simulation.
	3. Refer to README.md https://github.com/Xilinx/XilinxCEDStore/tree/2024.1/ced/Xilinx/IPI/cips_vip/README.md",
   "commentid":"comment_0|",
   "font_comment_0":"18",
   ...
   "linktotype_comment_0":"bd_design" }
	...
	set originalTBFile [file join $currentDir test_bench vhk158 system.sv]
	set xdc [file join $currentDir xdc vhk158 top.xdc]
	} elseif {[regexp "vek280" $board_name]} {
	set originalTBFile [file join $currentDir test_bench vek280 system.sv]
	set xdc [file join $currentDir xdc vek280 top.xdc]
	} else {
