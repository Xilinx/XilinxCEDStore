...
proc create_root_design { parentCell link_width lane_rate } {
  ...
  # Create ports
  set dma0_irq_0 [ create_bd_port -dir O -from 127 -to 0 dma0_irq_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE0_BASEADDR) {0x0500_0000_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE0_LIMITADDR) {0x0500_0001_ffff} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE1_BASEADDR) {0x0500_0002_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE1_DEST) {CPM_AXI_PL1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE1_LIMITADDR) {0x0500_0003_ffff} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE2_BASEADDR) {0x0500_0004_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DMA_APERTURE2_DEST) {CPM_AXI_PL2} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_INBOUND_REGION1_BAR_NUM) {BAR_2} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_INBOUND_REGION1_FUNC) {PF*} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_INBOUND_REGION1_TRGTADDR) {0x500_0002_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_INBOUND_REGION2_BAR_NUM) {BAR_3} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_INBOUND_REGION2_TRGTADDR) {0x500_0004_0000} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_MMIO_APERTURE1_BASEADDR) {0x0500_0002_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_MMIO_APERTURE1_DEST) {CPM_AXI_PL1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_MMIO_APERTURE1_LIMITADDR) {0x500_0003_ffff} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_MMIO_APERTURE2_BASEADDR) {0x0500_0004_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_MMIO_APERTURE2_DEST) {CPM_AXI_PL2} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR2_SIZE) {256} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR3_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR3_SIZE) {256} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR4_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR4_SIZE) {256} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR5_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_BAR5_SIZE) {256} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_MSIX_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_MSIX_PBA_OFFSET) {0x14000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_MSIX_TABLE_OFFSET) {0x10000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_MSIX_VECTORS) {256} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PF0_MSI_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PROTOCOL) {PCIE_6_1} \
    CONFIG.CPM6_CONFIG(CPM6_PL_AXIL_DBI0_IF) {0} \
  ...
  [get_bd_pins axi_noc2_0/aclk1]
  connect_bd_net -net ps_wizard_0_dma0_irq  [get_bd_pins ps_wizard_0/dma0_irq] \
  [get_bd_ports dma0_irq_0]
