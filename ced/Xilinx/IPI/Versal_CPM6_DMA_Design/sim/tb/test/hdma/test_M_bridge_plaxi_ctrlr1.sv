...
class test_M_bridge_plaxi_ctrlr1 extends test_hdma_tasks;

  `uvm_component_utils(test_M_bridge_plaxi_ctrlr1);
...
//	bar4_addr[1:0] = 0;
	...
	// BAR Write
	bar_write   (pf, 1, bar1_addr, 4, bar1_data);
	bar_write   (pf, 2, bar2_addr, 4, bar2_data);
	bar_write   (pf, 3, bar3_addr, 4, bar3_data);
	bar_write   (pf, 4, bar4_addr, 4, bar4_data);
//	bar_write   (pf, 5, bar5_addr, bar5_data);

	// BAR Read4, 
	bar_read_chk(pf, 1, bar1_addr, 4, bar1_data);
	bar_read_chk(pf, 2, bar2_addr, 4, bar2_data);
	bar_read_chk(pf, 3, bar3_addr, 4, bar3_data);
	bar_read_chk(pf, 4, bar4_addr, 4, bar4_data);
