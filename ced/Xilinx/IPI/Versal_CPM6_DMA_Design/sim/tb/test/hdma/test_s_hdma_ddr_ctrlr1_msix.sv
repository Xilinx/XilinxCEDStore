/*
Test case : test_s_hdma_ddr_ctrlr1_msix
description:  This test case is to verify basic functionality of HDMA with DDR controller 1 
...
class test_s_hdma_ddr_ctrlr1_msix extends test_hdma_tasks;

  `uvm_component_utils(test_s_hdma_ddr_ctrlr1_msix);
...
//   rc_mem_callback mem_cb;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    // Program HDMA context for number of channels. thiw will program only address offset 0x0 and 0x88 for each channel, which is used for interrupt setup in this test.
