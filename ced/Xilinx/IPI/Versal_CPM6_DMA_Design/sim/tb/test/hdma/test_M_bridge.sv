...
class test_M_bridge extends test_hdma_tasks;

  `uvm_component_utils(test_M_bridge);
...
//	bar5_addr[1:0] = 0;
	...
	// BAR Write
	bar_write   (1, bar1_addr, bar1_data);
	bar_write   (2, bar2_addr, bar2_data);
	bar_write   (3, bar3_addr, bar3_data);
	bar_write   (4, bar4_addr, bar4_data);
	bar_write   (5, bar5_addr, bar5_data);  

	// BAR Read
	bar_read_chk(1, bar1_addr, bar1_data);
	bar_read_chk(2, bar2_addr, bar2_data);
	bar_read_chk(3, bar3_addr, bar3_data);
	bar_read_chk(4, bar4_addr, bar4_data);
	bar_read_chk(5, bar5_addr, bar5_data);
