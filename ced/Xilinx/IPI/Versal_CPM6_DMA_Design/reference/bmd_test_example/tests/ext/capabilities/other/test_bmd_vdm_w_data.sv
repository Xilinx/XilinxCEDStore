//==============================================================================
// test_bmd_vdm_w_data.sv - Capability Other BMD Tests
//==============================================================================
// Description:
//   BMD test that creates VDMs in-place of normal posted traffic
//==============================================================================

class test_bmd_vdm_w_data extends test_bmd;
    `uvm_component_utils(test_bmd_vdm_w_data)

    //--------------------------------------------------------------------------
    // Constructor
    //--------------------------------------------------------------------------
    function new(string name = "test_bmd_vdm_w_data", uvm_component parent = null);
    ...
    virtual task post_configure_phase(uvm_phase phase);
        ...
        csr_cfg.wr_fmt_1        = 1'b1;
    endtask

endclass : test_bmd_vdm_w_data
