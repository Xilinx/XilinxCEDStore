================================================================================
  Versal CPM6 HDMA Gen6 PIPE Simulation -- INTERNAL README (AMD/XSJ Servers)
...
--------------------------------------------------------------------------------
  ...
  In Vivado TCL console:
    ...
    # In the CED options dialog choose CTRL_CONFIG=CONTROLLER1, DDR_EN=false
...
--------------------------------------------------------------------------------
  ...
  2. No HDMA-specific UVM tests exist yet -- only the generic framework
     hello_world test is verified against this DUT (see
     cpm6/ctrl1ep_g6x8_hdma_1pf for a working reference regression run
     of the same hdma_ddr sources). sim/test/ still contains the BMD
