================================================================================
  Versal CPM6 DMA+DDR Gen6 PIPE Simulation -- INTERNAL README (AMD/XSJ Servers)
...
--------------------------------------------------------------------------------
  ...
  In Vivado TCL console:
    ...
    # In the CED options dialog choose CTRL_CONFIG=Controller_1, DDR_EN=true
...
--------------------------------------------------------------------------------
  ...
  3. Unclear whether CH0_LPDDR5_0_* top-level pins need a DDR5 simulation
     ...
     dma_ddr/design_1_bd.tcl before relying on the current tie-off in
     dut_inst.sv.

  4. No DMA-specific UVM tests exist yet -- only the generic framework
     hello_world test is verified against dma_ddr_top (see
