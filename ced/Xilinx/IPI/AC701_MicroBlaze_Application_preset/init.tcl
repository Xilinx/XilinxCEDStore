...
proc getConfigDesignInfo {} { 
  return [dict create name {MicroBlaze_Application_Preset_AC701} description {}]
}
...
proc getSupportedBoards {} { 
  return [list xilinx.com:ac701:1.4]
}
...
proc createDesign { project_name {project_location "."} {options ""}} { 
  ...
  catch {source -notrace "$currentDir/MicroBlaze_Application_Preset_AC701_design.tcl"} retString 
