...
//--------------------------------------------------------------------------------
//Tool Version: Vivado v.2022.2.0 (lin64) Build 3572804 Wed Jun 22 19:15:18 MDT 2022
//Date        : Fri Jun 24 19:34:21 2022
//Host        : 
...
import cpm5n_v1_0_7_pkg::*;
  ...
  localparam NUM_INTFC =7;
  wire [NUM_INTFC-1:0] vio_throttle_back_pres;
  wire [NUM_INTFC-1:0] vio_throttle_halt;
  
  wire [NUM_INTFC-1:0] uport_throttle_vld_in, uport_throttle_rdy_in;
  wire [NUM_INTFC-1:0] uport_throttle_vld_out, uport_throttle_rdy_out;
  wire                 csi0_local_crdts_0_vld_throt;
  wire                 csi0_dst_crdt_0_tvalid_throt;
  wire                 csi0_prcmpl_req1_0_vld_throt;
  wire                 csi0_prcmpl_req0_0_vld_throt;
  wire                 csi0_npr_req_0_vld_throt    ;
  wire                 csi0_port_resp1_0_vld_throt ;
  wire                 csi0_port_resp0_0_vld_throt ;

  wire                 csi0_local_crdts_0_rdy_throt;
  wire                 csi0_dst_crdt_0_tready_throt;
  wire                 csi0_prcmpl_req1_0_rdy_throt;
  wire                 csi0_prcmpl_req0_0_rdy_throt;
  wire                 csi0_npr_req_0_rdy_throt    ;
  wire                 csi0_port_resp1_0_rdy_throt ;
  wire                 csi0_port_resp0_0_rdy_throt ;

   
  //using 250MHz clk as PL Ref clk;
  assign cpm_top_user_clk_0 = pl0_ref_clk_0;
  ...
  design_1 design_1_i
        ...
        */
        ...
        /*
        .csi0_dst_crdt_0_tdata          ('d0 ), //   (csi0_dst_crdt_0_tdata),
        .csi0_dst_crdt_0_tready         ( ), //   (csi0_dst_crdt_0_tready),
        .csi0_dst_crdt_0_tvalid         ('d0 ), //   (csi0_dst_crdt_0_tvalid),
        .csi0_local_crdts_0_buf_id      ( ), //   (csi0_local_crdts_0_buf_id),
        .csi0_local_crdts_0_data        ( ), //   (csi0_local_crdts_0_data),
        .csi0_local_crdts_0_flow_type   ( ), //   (csi0_local_crdts_0_flow_type),
        .csi0_local_crdts_0_rdy         ('d1 ), //   (csi0_local_crdts_0_rdy),
        .csi0_local_crdts_0_snk_id      ( ), //   (csi0_local_crdts_0_snk_id),
        .csi0_local_crdts_0_src_furc_id ( ), //   (csi0_local_crdts_0_src_furc_id),
        .csi0_local_crdts_0_vld         ( ), //   (csi0_local_crdts_0_vld),
        
        .csi0_npr_req_0_eop        ('d0 ), // (csi0_npr_req_0_eop),
        .csi0_npr_req_0_err        ('d0 ), // (csi0_npr_req_0_err),
        .csi0_npr_req_0_rdy        ('d0 ), // (csi0_npr_req_0_rdy),
        .csi0_npr_req_0_seg        ('d0 ), // (csi0_npr_req_0_seg),
        .csi0_npr_req_0_sop        ('d0 ), // (csi0_npr_req_0_sop),
        .csi0_npr_req_0_vld        ('d0 ), // (csi0_npr_req_0_vld),
        .csi0_port_resp0_0_eop     ( ), // (csi0_port_resp0_0_eop),
        .csi0_port_resp0_0_err     ( ), // (csi0_port_resp0_0_err),
        .csi0_port_resp0_0_rdy     ('d1 ), // (csi0_port_resp0_0_rdy),
        .csi0_port_resp0_0_seg     ( ), // (csi0_port_resp0_0_seg),
        .csi0_port_resp0_0_sop     ( ), // (csi0_port_resp0_0_sop),
        .csi0_port_resp0_0_vld     ( ), // (csi0_port_resp0_0_vld),
        .csi0_port_resp1_0_eop     ( ), // (csi0_port_resp1_0_eop),
        .csi0_port_resp1_0_err     ( ), // (csi0_port_resp1_0_err),
        .csi0_port_resp1_0_rdy     ('d1 ), // (csi0_port_resp1_0_rdy),
        .csi0_port_resp1_0_seg     ( ), // (csi0_port_resp1_0_seg),
        .csi0_port_resp1_0_sop     ( ), // (csi0_port_resp1_0_sop),
        .csi0_port_resp1_0_vld     ( ), // (csi0_port_resp1_0_vld),
        .csi0_prcmpl_req0_0_eop    ('d0 ), // (csi0_prcmpl_req0_0_eop),
        .csi0_prcmpl_req0_0_err    ('d0 ), // (csi0_prcmpl_req0_0_err),
        .csi0_prcmpl_req0_0_rdy    (    ), // (csi0_prcmpl_req0_0_rdy),
        .csi0_prcmpl_req0_0_seg    ('d0 ), // (csi0_prcmpl_req0_0_seg),
        .csi0_prcmpl_req0_0_sop    ('d0 ), // (csi0_prcmpl_req0_0_sop),
        .csi0_prcmpl_req0_0_vld    ('d0 ), // (csi0_prcmpl_req0_0_vld),
        .csi0_prcmpl_req1_0_eop    ('d0 ), // (csi0_prcmpl_req1_0_eop),
        .csi0_prcmpl_req1_0_err    ('d0 ), // (csi0_prcmpl_req1_0_err),
        .csi0_prcmpl_req1_0_rdy    (    ), // (csi0_prcmpl_req1_0_rdy),
        .csi0_prcmpl_req1_0_seg    ('d0 ), // (csi0_prcmpl_req1_0_seg),
        .csi0_prcmpl_req1_0_sop    ('d0 ), // (csi0_prcmpl_req1_0_sop),
        .csi0_prcmpl_req1_0_vld    ('d0 ), // (csi0_prcmpl_req1_0_vld),
	*/
         
        .csi1_dst_crdt_0_tdata         (csi0_dst_crdt_0_tdata),
        .csi1_dst_crdt_0_tready        (csi0_dst_crdt_0_tready),
        .csi1_dst_crdt_0_tvalid        (csi0_dst_crdt_0_tvalid_throt),
        .csi1_local_crdt_0_buf_id      (csi0_local_crdts_0_buf_id),
        .csi1_local_crdt_0_data        (csi0_local_crdts_0_data),
        .csi1_local_crdt_0_flow_type   (csi0_local_crdts_0_flow_type),
        .csi1_local_crdt_0_rdy         (csi0_local_crdts_0_rdy_throt),
        .csi1_local_crdt_0_snk_id      (csi0_local_crdts_0_snk_id),
        .csi1_local_crdt_0_src_furc_id (csi0_local_crdts_0_src_furc_id),
        .csi1_local_crdt_0_vld         (csi0_local_crdts_0_vld),
        .csi1_npr_req_0_eop            (csi0_npr_req_0_eop),
        .csi1_npr_req_0_err            (csi0_npr_req_0_err),
        .csi1_npr_req_0_rdy            (csi0_npr_req_0_rdy),
        .csi1_npr_req_0_seg            (csi0_npr_req_0_seg),
        .csi1_npr_req_0_sop            (csi0_npr_req_0_sop),
        .csi1_npr_req_0_vld            (csi0_npr_req_0_vld_throt),
        .csi1_port_resp0_0_eop         (csi0_port_resp0_0_eop),
        .csi1_port_resp0_0_err         (csi0_port_resp0_0_err),
        .csi1_port_resp0_0_rdy         (csi0_port_resp0_0_rdy_throt),
        .csi1_port_resp0_0_seg         (csi0_port_resp0_0_seg),
        .csi1_port_resp0_0_sop         (csi0_port_resp0_0_sop),
        .csi1_port_resp0_0_vld         (csi0_port_resp0_0_vld),
        .csi1_port_resp1_0_eop         (csi0_port_resp1_0_eop),
        .csi1_port_resp1_0_err         (csi0_port_resp1_0_err),
        .csi1_port_resp1_0_rdy         (csi0_port_resp1_0_rdy_throt),
        .csi1_port_resp1_0_seg         (csi0_port_resp1_0_seg),
        .csi1_port_resp1_0_sop         (csi0_port_resp1_0_sop),
        .csi1_port_resp1_0_vld         (csi0_port_resp1_0_vld),
        .csi1_prcmpl_req0_0_eop        (csi0_prcmpl_req0_0_eop),
        .csi1_prcmpl_req0_0_err        (csi0_prcmpl_req0_0_err),
        .csi1_prcmpl_req0_0_rdy        (csi0_prcmpl_req0_0_rdy),
        .csi1_prcmpl_req0_0_seg        (csi0_prcmpl_req0_0_seg),
        .csi1_prcmpl_req0_0_sop        (csi0_prcmpl_req0_0_sop),
        .csi1_prcmpl_req0_0_vld        (csi0_prcmpl_req0_0_vld_throt),
        .csi1_prcmpl_req1_0_eop        (csi0_prcmpl_req1_0_eop),
        .csi1_prcmpl_req1_0_err        (csi0_prcmpl_req1_0_err),
        .csi1_prcmpl_req1_0_rdy        (csi0_prcmpl_req1_0_rdy),
        .csi1_prcmpl_req1_0_seg        (csi0_prcmpl_req1_0_seg),
        .csi1_prcmpl_req1_0_sop        (csi0_prcmpl_req1_0_sop),
        .csi1_prcmpl_req1_0_vld        (csi0_prcmpl_req1_0_vld_throt)
	//.vio_throttle_back_pres        (vio_throttle_back_pres),
	//.vio_throttle_halt             (vio_throttle_halt)
	);
  ...
  assign uport_throttle_vld_in = {csi0_local_crdts_0_vld, 
                                  csi0_dst_crdt_0_tvalid,
                                  csi0_prcmpl_req1_0_vld, csi0_prcmpl_req0_0_vld,
                                  csi0_npr_req_0_vld,
                                  csi0_port_resp1_0_vld, csi0_port_resp0_0_vld};
  assign uport_throttle_rdy_in = {csi0_local_crdts_0_rdy, 
                                  csi0_dst_crdt_0_tready,
                                  csi0_prcmpl_req1_0_rdy, csi0_prcmpl_req0_0_rdy,
                                  csi0_npr_req_0_rdy,
                                  csi0_port_resp1_0_rdy, csi0_port_resp0_0_rdy};
  
  assign csi0_local_crdts_0_vld_throt = uport_throttle_vld_out[6];
  assign csi0_dst_crdt_0_tvalid_throt = uport_throttle_vld_out[5];
  assign csi0_prcmpl_req1_0_vld_throt = uport_throttle_vld_out[4];
  assign csi0_prcmpl_req0_0_vld_throt = uport_throttle_vld_out[3];
  assign csi0_npr_req_0_vld_throt     = uport_throttle_vld_out[2];
  assign csi0_port_resp1_0_vld_throt  = uport_throttle_vld_out[1];
  assign csi0_port_resp0_0_vld_throt  = uport_throttle_vld_out[0];
  
  assign csi0_local_crdts_0_rdy_throt = uport_throttle_rdy_out[6];
  assign csi0_dst_crdt_0_tready_throt = uport_throttle_rdy_out[5];
  assign csi0_prcmpl_req1_0_rdy_throt = uport_throttle_rdy_out[4];
  assign csi0_prcmpl_req0_0_rdy_throt = uport_throttle_rdy_out[3];
  assign csi0_npr_req_0_rdy_throt     = uport_throttle_rdy_out[2];
  assign csi0_port_resp1_0_rdy_throt  = uport_throttle_rdy_out[1];
  assign csi0_port_resp0_0_rdy_throt  = uport_throttle_rdy_out[0];


  //axis_vio_0 U_THROTTLE_VIO (
  //  .clk (pl0_ref_clk_0),
  //  .probe_out0 (vio_throttle_back_pres ),
  //  .probe_out1 (vio_throttle_halt )

  //);

  localparam THROTTLE_EN = 0;  // Keep it 0 for Simulation
  ...
  begin
    ...
    axis_throttle #(
      ...
      .user_reset_n (pl0_rst_n ),
      .back_pres    (vio_throttle_back_pres ),
      .halt         (vio_throttle_halt ),
      .valid_i      (uport_throttle_vld_in ),
      .ready_i      (uport_throttle_rdy_in ),
      .valid_o      (uport_throttle_vld_out),
      .ready_o      (uport_throttle_rdy_out)
    );
  end
  else
  begin
    assign uport_throttle_vld_out = uport_throttle_vld_in;
    assign uport_throttle_rdy_out = uport_throttle_rdy_in;
  ...
  assign csi2f_port0_out.vld[0]                      = csi0_port_resp0_0_vld_throt  ; 
  ...
  assign csi2f_port0_out.vld[1]                      = csi0_port_resp1_0_vld_throt  ; 
  ...
  assign f2csi_port0_prcmpl_in.rdy[0]                = csi0_prcmpl_req0_0_rdy_throt;
  ...
  assign f2csi_port0_prcmpl_in.rdy[1]                = csi0_prcmpl_req1_0_rdy_throt;
  ...
  assign f2csi_port0_npr_in.rdy                      = csi0_npr_req_0_rdy_throt ;
  ...
  assign dest_crdt_port0_in.ser_ing_intf_rdy         = csi0_dst_crdt_0_tready_throt; 
  ...
  assign local_crdt_port0_out.local_crdt_vld         = csi0_local_crdts_0_vld_throt;            
