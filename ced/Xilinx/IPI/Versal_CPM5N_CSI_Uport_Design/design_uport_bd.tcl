...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0xD0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs M_AXI_CSI_UPORT_axil/Reg] -force
  assign_bd_address -offset 0xD0090000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_cmpl_check_seed/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD0040000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_cmpl_data/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_npr_cmd/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD0080000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_npr_data/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD00A0000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_check_seed/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD0020000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_cmd/S_AXI/Mem0] -force
  assign_bd_address -offset 0xD00C0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_data/S_AXI/Mem0] -force
