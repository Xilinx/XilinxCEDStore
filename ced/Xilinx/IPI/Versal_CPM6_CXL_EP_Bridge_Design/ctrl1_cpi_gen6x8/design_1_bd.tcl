...
proc create_hier_cell_PA_3 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_data [get_bd_intf_pins cpi_a2f_data] [get_bd_intf_pins cxl_mem_wrapper_0/cpi_a2f_data]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_global [get_bd_intf_pins cpi_a2f_global] [get_bd_intf_pins cxl_mem_wrapper_0/cpi_a2f_global]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_req [get_bd_intf_pins cpi_a2f_req] [get_bd_intf_pins cxl_mem_wrapper_0/cpi_a2f_req]
...
proc create_root_design { parentCell {cxl_protocol CXL_3_1} {cxl_width X8} } {
  ...
  set cxl1_pm_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_cpm6:cxl_pm_rtl:1.0 cxl1_pm_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PROTOCOL) {Disabled} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ACS_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ARI_CAP_EN) {1} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DEV_SERIAL_NO) {0xabcd_0000_0000_5678} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DMA_APERTURE0_BASEADDR) {0x0000_0201_0000_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DMA_APERTURE0_DEST) {CPM_AXI_PL0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DMA_APERTURE0_LIMITADDR) {0x0000_0201_0001_ffff} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DSN_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ECRC_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ELBI_IF) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_EXT_CFG_SPACE_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_FLR_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_IDE_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_INBOUND_REGION0_BAR_NUM) {BAR_2} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_INBOUND_REGION0_FUNC) {PF_0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_INBOUND_REGION0_LIMITADDR) {0x000_0001_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_INBOUND_REGION0_MATCH_MODE) {BAR} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_INBOUND_REGION0_TRGTADDR) {0x201_0000_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_LINK_WIDTH) $cxl_width \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_MMIO_APERTURE0_BASEADDR) {0x0201_0000_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_MMIO_APERTURE0_DEST) {CPM_AXI_PL0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_MMIO_APERTURE0_LIMITADDR) {0x0201_0000_ffff} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_MODE) {BRIDGE} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_NUM_INBOUND_REGIONS) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_NUM_MMIO_APERTURES) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PASID_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PERST) {PS_MIO_19} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_BAR2_64BIT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_BAR2_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_BAR2_PREFETCHABLE) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_BAR2_SIZE) {64} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_BAR4_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_INTERFACE_VALUE) {10} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSI_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSI_VECTORS) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_SUB_CLASS_VALUE) {02} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PROTOCOL) $cxl_protocol \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_HDM_DECODER_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_INTF) CPI \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_MEM_HWINIT_MODE) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_NUM_AGENTS) {4} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_RANGE1_SIZE) {0x0000_0004_0000_0000} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_RESET_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_RST_MEMCLR_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_TX_PARITY) {Odd} \
    CONFIG.CPM6_CONFIG(CPM6_CXL1_VIRAL_CAP_EN) {1} \
    ...
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL0_LINK_WIDTH) {X8} \
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL0_MODE) {None} \
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL0_PROTOCOL) {Disabled} \
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL1_LINK_WIDTH) $cxl_width \
  ...
  # ps_wizard_0's cxl1_status_* pins into ctrl_reg_ep_0's EP_CTRL_STS layout
  ...
  # ps_wizard_0/cxl1_status_pl_ready; created unconditionally since this
  # design is CPI-only.
  ...
  # gen6x8 clocking: derive fabric clk from pl1_ref_clk via clkx5_wiz (width adjusted for cpm6 not applicable; freq adjusted for cpm6)
  set clkx5_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clkx5_wiz:1.0 clkx5_wiz_0 ]
  set_property -dict [list \
    CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {335.000,100.000,100.000,100.000,100.000,100.000,100.000} \
  ...
  connect_bd_intf_net -intf_net cxl1_pm_0_1 [get_bd_intf_ports cxl1_pm_0] [get_bd_intf_pins ps_wizard_0/cxl1_pm]
  ...
  # ===========================================================================
  # PA_N <-> ps_wizard_0 CPI connections (cxl1_cpiN_* pins). Grouped here as
  # a single block rather than scattered individually.
  # ===========================================================================
  connect_bd_intf_net -intf_net PA_1_cpi_f2a_data [get_bd_intf_pins PA_1/cpi_f2a_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_f2a_data]
  connect_bd_intf_net -intf_net PA_1_cpi_f2a_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_f2a_global] [get_bd_intf_pins PA_1/cpi_f2a_global]
  connect_bd_intf_net -intf_net PA_1_cpi_f2a_rsp [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_f2a_rsp] [get_bd_intf_pins PA_1/cpi_f2a_rsp]
  connect_bd_intf_net -intf_net PA_2_cpi_f2a_data [get_bd_intf_pins PA_2/cpi_f2a_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_f2a_data]
  connect_bd_intf_net -intf_net PA_2_cpi_f2a_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_f2a_global] [get_bd_intf_pins PA_2/cpi_f2a_global]
  connect_bd_intf_net -intf_net PA_2_cpi_f2a_rsp [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_f2a_rsp] [get_bd_intf_pins PA_2/cpi_f2a_rsp]
  connect_bd_intf_net -intf_net PA_3_cpi_f2a_data [get_bd_intf_pins PA_3/cpi_f2a_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_f2a_data]
  connect_bd_intf_net -intf_net PA_3_cpi_f2a_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_f2a_global] [get_bd_intf_pins PA_3/cpi_f2a_global]
  connect_bd_intf_net -intf_net PA_3_cpi_f2a_rsp [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_f2a_rsp] [get_bd_intf_pins PA_3/cpi_f2a_rsp]
  connect_bd_intf_net -intf_net cpi_a2f_data_1 [get_bd_intf_pins PA_1/cpi_a2f_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_a2f_data]
  connect_bd_intf_net -intf_net cpi_a2f_data_2 [get_bd_intf_pins PA_2/cpi_a2f_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_a2f_data]
  connect_bd_intf_net -intf_net cpi_a2f_data_3 [get_bd_intf_pins PA_3/cpi_a2f_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_a2f_data]
  connect_bd_intf_net -intf_net cxl_mem_wrapper_0_cpi_f2a_data [get_bd_intf_pins PA_0/cpi_f2a_data] [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_f2a_data]
  connect_bd_intf_net -intf_net cxl_mem_wrapper_0_cpi_f2a_global [get_bd_intf_pins PA_0/cpi_f2a_global] [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_f2a_global]
  connect_bd_intf_net -intf_net cxl_mem_wrapper_0_cpi_f2a_rsp [get_bd_intf_pins PA_0/cpi_f2a_rsp] [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_f2a_rsp]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_data [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_a2f_data] [get_bd_intf_pins PA_0/cpi_a2f_data]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_global [get_bd_intf_pins PA_0/cpi_a2f_global] [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_a2f_global]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi0_a2f_req [get_bd_intf_pins ps_wizard_0/cxl1_cpi0_a2f_req] [get_bd_intf_pins PA_0/cpi_a2f_req]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi1_a2f_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_a2f_global] [get_bd_intf_pins PA_1/cpi_a2f_global]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi1_a2f_req [get_bd_intf_pins ps_wizard_0/cxl1_cpi1_a2f_req] [get_bd_intf_pins PA_1/cpi_a2f_req]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi2_a2f_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_a2f_global] [get_bd_intf_pins PA_2/cpi_a2f_global]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi2_a2f_req [get_bd_intf_pins ps_wizard_0/cxl1_cpi2_a2f_req] [get_bd_intf_pins PA_2/cpi_a2f_req]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi3_a2f_global [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_a2f_global] [get_bd_intf_pins PA_3/cpi_a2f_global]
  connect_bd_intf_net -intf_net ps_wizard_0_cxl1_cpi3_a2f_req [get_bd_intf_pins ps_wizard_0/cxl1_cpi3_a2f_req] [get_bd_intf_pins PA_3/cpi_a2f_req]
  ...
  [get_bd_pins ps_wizard_0/cxl1_status_pl_ready]
  ...
  connect_bd_net -net ps_wizard_0_cxl1_rstn  [get_bd_pins ps_wizard_0/cxl1_rstn] \
  ...
  connect_bd_net -net ps_wizard_0_cxl1_status_dev_mem_en  [get_bd_pins ps_wizard_0/cxl1_status_dev_mem_en] \
  ...
  # ep_status_concat_0: remaining CXL1 controller status inputs (from
  # ps_wizard_0's cxl1_status_* pins - see ctrl_reg_ep.v's ep_status port
  # comment for the bit-layout this feeds into ctrl_reg_ep_0/ep_status)
  connect_bd_net -net ps_wizard_0_cxl1_status_link_up [get_bd_pins ps_wizard_0/cxl1_status_link_up] [get_bd_pins ep_status_concat_0/In0]
  connect_bd_net -net ps_wizard_0_cxl1_status_io_en [get_bd_pins ps_wizard_0/cxl1_status_io_en] [get_bd_pins ep_status_concat_0/In1]
  connect_bd_net -net ps_wizard_0_cxl1_status_dev_cache_en [get_bd_pins ps_wizard_0/cxl1_status_dev_cache_en] [get_bd_pins ep_status_concat_0/In3]
  connect_bd_net -net ps_wizard_0_cxl1_status_flit_mode [get_bd_pins ps_wizard_0/cxl1_status_flit_mode] [get_bd_pins ep_status_concat_0/In4]
  connect_bd_net -net ps_wizard_0_cxl1_status_bi_enable [get_bd_pins ps_wizard_0/cxl1_status_bi_enable] [get_bd_pins ep_status_concat_0/In5]
  connect_bd_net -net ps_wizard_0_cxl1_status_emd_enable [get_bd_pins ps_wizard_0/cxl1_status_emd_enable] [get_bd_pins ep_status_concat_0/In6]
  connect_bd_net -net ps_wizard_0_cxl1_status_disable_caching [get_bd_pins ps_wizard_0/cxl1_status_disable_caching] [get_bd_pins ep_status_concat_0/In7]
  connect_bd_net -net ps_wizard_0_cxl1_status_mdh_disable [get_bd_pins ps_wizard_0/cxl1_status_mdh_disable] [get_bd_pins ep_status_concat_0/In8]
  connect_bd_net -net ps_wizard_0_cxl1_status_reset [get_bd_pins ps_wizard_0/cxl1_status_reset] [get_bd_pins ep_status_concat_0/In9]
  connect_bd_net -net ps_wizard_0_cxl1_status_initiate_cxl_rst [get_bd_pins ps_wizard_0/cxl1_status_initiate_cxl_rst] [get_bd_pins ep_status_concat_0/In10]
  connect_bd_net -net ps_wizard_0_cxl1_status_initiate_cache_wr_invld [get_bd_pins ps_wizard_0/cxl1_status_initiate_cache_wr_invld] [get_bd_pins ep_status_concat_0/In11]
  connect_bd_net -net ep_status_rsvd13_0_dout [get_bd_pins ep_status_rsvd13_0/dout] [get_bd_pins ep_status_concat_0/In12]
  connect_bd_net -net ps_wizard_0_cxl1_status_dev_rst_mem_clr_enable [get_bd_pins ps_wizard_0/cxl1_status_dev_rst_mem_clr_enable] [get_bd_pins ep_status_concat_0/In13]
  connect_bd_net -net ep_status_rsvd15_0_dout [get_bd_pins ep_status_rsvd15_0/dout] [get_bd_pins ep_status_concat_0/In14]
  connect_bd_net -net ps_wizard_0_cxl1_status_vlsm_mc_state [get_bd_pins ps_wizard_0/cxl1_status_vlsm_mc_state] [get_bd_pins ep_status_concat_0/In15]
  connect_bd_net -net ep_status_rsvd23_20_0_dout [get_bd_pins ep_status_rsvd23_20_0/dout] [get_bd_pins ep_status_concat_0/In16]
  connect_bd_net -net ps_wizard_0_cxl1_status_error [get_bd_pins ps_wizard_0/cxl1_status_error] [get_bd_pins ep_status_concat_0/In17]
  ...
  connect_bd_net -net ps_wizard_0_pl0_ref_clk  [get_bd_pins clkx5_wiz_0/clk_out1] \
