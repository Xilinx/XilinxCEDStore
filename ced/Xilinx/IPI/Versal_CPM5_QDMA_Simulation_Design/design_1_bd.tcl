...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.CPM_CONFIG { \
      ...
      CPM_PCIE0_PF0_PCIEBAR2AXIBAR_QDMA_0 {0x20800000000} \
      CPM_PCIE0_PF0_PCIEBAR2AXIBAR_QDMA_2 {0x20808000000} \
      CPM_PCIE0_PF0_PCIEBAR2AXIBAR_QDMA_4 {0xE0000000} \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      PMC_CRP_HSM1_REF_CTRL_FREQMHZ {133.332} \
...
{IO {PMC_MIO 0 .. 11}}} \
      ...
      PS_CRF_ACPU_CTRL_ACT_FREQMHZ {1649.983521} \
      PS_CRF_ACPU_CTRL_DIVISOR0 {1} \
      PS_CRF_ACPU_CTRL_FREQMHZ {1650} \
      PS_CRF_ACPU_CTRL_SRCSEL {APLL} \
      PS_CRF_APLL_CTRL_CLKOUTDIV {2} \
      PS_CRF_APLL_CTRL_FBDIV {99} \
      ...
      PS_CRF_FPD_LSBUS_CTRL_DIVISOR0 {4} \
      ...
      PS_CRF_FPD_TOP_SWITCH_CTRL_FREQMHZ {950} \
      ...
      PS_CRL_CPU_R5_CTRL_ACT_FREQMHZ {799.992004} \
      ...
      PS_CRL_LPD_LSBUS_CTRL_DIVISOR0 {4} \
      ...
      PS_CRL_LPD_TOP_SWITCH_CTRL_FREQMHZ {700} \
      ...
      PS_MIO0 {{AUX_IO 0} {DIRECTION in} {DRIVE_STRENGTH 8mA} {OUTPUT_DATA default} {PULL pullup} {SCHMITT 0} {SLEW slow} {USAGE Reserved}} \
...
17}}} \
      ...
      SMON_MEAS40 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_500} {SUPPLY_NUM 0}} \
      SMON_MEAS41 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_501} {SUPPLY_NUM 0}} \
      SMON_MEAS42 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_502} {SUPPLY_NUM 0}} \
      SMON_MEAS43 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_503} {SUPPLY_NUM 0}} \
...
connect_bd_intf_net -intf_net versal_cips_0_dma0_st_rx_msg [get_bd_intf_pins axis_ila_0/SLOT_0_AXIS] [get_bd_intf_pins versal_cips_0/dma0_st_rx_msg]
  ...
  connect_bd_net -net versal_cips_0_dma0_axi_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axis_ila_0/resetn] [get_bd_pins versal_cips_0/dma0_axi_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_noc_0/aclk2] [get_bd_pins axis_ila_0/clk] [get_bd_pins versal_cips_0/dma0_intrfc_clk] [get_bd_pins versal_cips_0/pl0_ref_clk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins versal_cips_0/cpm_irq0] [get_bd_pins versal_cips_0/cpm_irq1] [get_bd_pins versal_cips_0/dma0_dsc_crdt_in_valid] [get_bd_pins versal_cips_0/dma0_mgmt_req_vld] [get_bd_pins versal_cips_0/dma0_usr_irq_valid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins versal_cips_0/dma0_intrfc_resetn] [get_bd_pins versal_cips_0/dma0_mgmt_cpl_rdy] [get_bd_pins versal_cips_0/dma0_qsts_out_rdy] [get_bd_pins versal_cips_0/dma0_tm_dsc_sts_rdy] [get_bd_pins xlconstant_1/dout]
  ...
  assign_bd_address -offset 0x020808000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces versal_cips_0/CPM_PCIE_NOC_0] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x020808000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces versal_cips_0/CPM_PCIE_NOC_1] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
