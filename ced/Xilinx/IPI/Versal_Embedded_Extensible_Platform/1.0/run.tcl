...
source "$currentDir/vrk160_comn.tcl"

} elseif {[regexp "vek385" $board_name]} {

source "$currentDir/vek385_comn.tcl" 

}  elseif {[regexp "vck190" $board_name]} {

source "$currentDir/vck190_comn.tcl"

}  elseif {[regexp "vek280" $board_name]} {

source "$currentDir/vek280_comn.tcl"

#}  elseif {[regexp "xilinx_vck190" $board_name]} {

#source "$currentDir/xilinx_vck190_comn.tcl"

#}  elseif {[regexp "xilinx_vek280" $board_name]} {

#source "$currentDir/xilinx_vek280_comn.tcl"

} else {

puts "INFO: CED is not available for $board_name!!" }
