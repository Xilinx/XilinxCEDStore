...
module user_control 
  #(
   ...
   reg [31:0] rd_addr_q;    // CR-1271459
   always @(posedge axi_aclk) begin
      if (!axi_aresetn) rd_addr_q <= 32'h0;
      else if (m_axil_arvalid) rd_addr_q <= rd_addr;
      else rd_addr_q <= rd_addr_q;
   end
...
//	 perf_ctl <= 5'b11001;
	 ...
	 case (wr_addr)
	   32'h00 : c2h_st_qid     <= m_axil_wdata[11:0];
...
//	 wb_dat[31:0] <= {wb_dat[31:20],c2h_st_len[15:0], ~(control_reg_c2h[5] | control_reg_c2h[2]), 3'h0};
   ...
   always_comb begin
      case (rd_addr_q)   // CR-1271459
         32'h00 : m_axil_rdata = (32'h0 | c2h_st_qid[11:0]);
         ...
         32'h10 : m_axil_rdata = (32'h0 | {h2c_qid[11:0], h2c_crc_match, 1'b0, h2c_zero_byte_reg, h2c_match});
...
//   assign clr_h2c_match = control_reg_h2c[0] & ~control_h2c_clr;
   ...
   wire [11:0] 		  wr_credit_qid;
   wire [11:0] 		  rd_credit_qid;
   reg 			  tm_dsc_sts_qinv_d1;
   reg 			  tm_dsc_sts_vld_d1;
   reg [15:0] 		  tm_dsc_sts_avl_d1;
   reg [11:0] 		  tm_dsc_sts_qid_d1;
