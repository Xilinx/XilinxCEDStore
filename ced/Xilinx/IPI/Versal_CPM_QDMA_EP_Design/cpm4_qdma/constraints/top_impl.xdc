...
#
## set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_dqs_c[16]"] ;# Ban###############k 703 VCCO - VCC1V2_DDR4 - IO_L21N_XCC_N7P1_M1P43_703
##
...
#
##set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_odt[1]"] ;# Bank 70###4 VCCO - VCC1V2_DDR4 - IO_L0N_XCC_N0P1_M1P55_704
#
...
#
##set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_cs_n[1]"] ;# Bank 7#####################04 VCCO - VCC1V2_DDR4 - IO_L16N_N5P3_M1P87_704
#
...
#
##set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_cs_n[3]"] ;# Bank 7###################04 VCCO - VCC1V2_DDR4 - IO_L2P_N0P4_M1P58_704
#
...
#
# set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_dqs_c[12]"] ;# Ban#################k 704 VCCO - VCC1V2_DDR4 - IO_L21N_XCC_N7P1_M1P97_704
#
...
#
##set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_ck_t[1]"] ;# Bank 704 VCCO - VCC1V2_DDR4 - IO_L3P_XCC_N1P0_M1P60_#######704
##
##set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_ck_c[1]"] ;# Bank 704 VCCO - VCC1V2_DDR4 - IO_L3N_XCC_N1P1_M1P61_##704
#
...
#
## set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_dqs_c[11]"] ;# Bank 705 VCCO - VCC1V2_DDR4 - IO_L9N_GC_XCC_N3P1_#M1P127_705
##
...
#
## set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_dqs_c[9]"] ;# Bank 705 VCCO - VCC1V2_DDR4 - IO_L21N_XCC_N7P1_M1P###151_705
#
...
##
## set_property PACKAGE_PIN <NONE>     [get_ports "CH0_DDR4_0_dqs_c[17]"] ;# Bank 705 VCCO - VCC1V2_DDR4 - IO_L3N_XCC_N1P1_M1P###115_705
##
