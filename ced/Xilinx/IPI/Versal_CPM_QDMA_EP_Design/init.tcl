...
proc addOptions {DESIGNOBJ PROJECT_PARAM.BOARD_PART} {
	lappend x [dict create name "CPM_Config" type "string" value "CPM4" value_list {"CPM4" "CPM5"} enabled true]
        lappend x [dict create name "CPM4_Preset" type "string" value "CPM4_QDMA_Gen4x8_MM_ST_Design" value_list {CPM4_QDMA_Gen4x8_MM_ST_Design CPM4_QDMA_Gen4x8_MM_ST_Performance_Design } enabled true]
        lappend x [dict create name "CPM5_Preset" type "string" value "CPM5_QDMA_Gen4x8_MM_ST_Design" value_list {CPM5_QDMA_Gen4x8_MM_ST_Design CPM5_QDMA_Gen4x8_ST_Performance_Design CPM5_QDMA_Dual_Gen4x8_MM_ST_Design CPM5_QDMA_Gen5x8_MM_Performance_Design} enabled true]
	return $x
}
