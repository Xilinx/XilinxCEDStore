...
if { ${design_name_rp} eq "" } {
  ...
  # Add USER_COMMENTS on $design_name_rp
  set_property USER_COMMENTS.comment_0 "NOTE: Do not remove, rename or change polarity of unconnected or connected BD I/O ports. It's added to maintain same IP wrapper for all devices" [get_bd_designs $design_name_rp]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set cpm_user_clk [ create_bd_port -dir O -type clk cpm_user_clk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {pcie0_m_axis_cq_0:pcie0_m_axis_rc_0:pcie0_s_axis_cc_0:pcie0_s_axis_rq_0} \
 ] $cpm_user_clk
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC DEFAULT $cpm_user_clk
