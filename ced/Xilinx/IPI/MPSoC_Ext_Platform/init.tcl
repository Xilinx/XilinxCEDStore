...
proc getSupportedBoards {} {
   return [get_board_parts -filter {(PART_NAME =~"*xczu*" && VENDOR_NAME=="xilinx.com")||(PART_NAME =~"*xck26*"&& VENDOR_NAME=="xilinx.com")||(PART_NAME =~"*xck24*"&& VENDOR_NAME=="xilinx.com") } -latest_file_version -quiet]
}
