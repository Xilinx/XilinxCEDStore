...
proc create_hier_cell_qdma_0_support { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.pf1_sub_class_interface_menu {PCI_to_PCI_bridge} \
    ...
    CONFIG.pf2_sub_class_interface_menu {PCI_to_PCI_bridge} \
    ...
    CONFIG.pf3_sub_class_interface_menu {PCI_to_PCI_bridge} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.pf1_class_code_sub_qdma {04} \
    CONFIG.pf1_sub_class_interface_menu_qdma {PCI_to_PCI_bridge} \
    CONFIG.pf2_base_class_menu_qdma {Bridge_device} \
    CONFIG.pf2_class_code_base_qdma {06} \
    CONFIG.pf2_class_code_sub_qdma {04} \
    CONFIG.pf2_device_id {B2C8} \
    CONFIG.pf2_sub_class_interface_menu_qdma {PCI_to_PCI_bridge} \
    CONFIG.pf3_base_class_menu_qdma {Bridge_device} \
    CONFIG.pf3_class_code_base_qdma {06} \
    CONFIG.pf3_class_code_sub_qdma {04} \
    CONFIG.pf3_device_id {B3C8} \
    CONFIG.pf3_sub_class_interface_menu_qdma {PCI_to_PCI_bridge} \
    CONFIG.pl_link_cap_max_link_speed {16.0_GT/s} \
    CONFIG.pl_link_cap_max_link_width {X8} \
  ] $qdma_0
  ...
  set_property -dict [list \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      PMC_MIO_TREE_PERIPHERALS {#####################################GPIO 1#####UART 0#UART 0#########Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#############Gem0#Gem0} \
      PMC_MIO_TREE_SIGNALS {#####################################gpio_1_pin[37]#####rxd#txd#########rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#############gem0_mdc#gem0_mdio}\
\
