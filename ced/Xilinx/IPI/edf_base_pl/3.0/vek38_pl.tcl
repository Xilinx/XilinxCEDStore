...
set sys_uart [get_board_component_interfaces *pl_uart*]
...
# set properties on ctrl_smc IP instance
set_property -dict [list CONFIG.NUM_CLKS {1} CONFIG.NUM_MI {5} CONFIG.NUM_SI {1}] $ctrl_smc
...
connect_bd_net [get_bd_pins rst_clk/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn]
...
connect_bd_net [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins ctrl_smc/aclk] \
  [get_bd_pins rst_clk/slowest_sync_clk] \
  [get_bd_pins axi_uart16550_0/s_axi_aclk] \
  [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] \
  
connect_bd_net [get_bd_pins rst_clk/peripheral_aresetn] [get_bd_pins ctrl_smc/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn]
...
connect_bd_net [get_bd_pins ps_wizard_0/pl0_resetn] [get_bd_pins clk_wizard_0/resetn]
