...
\
  ...
  connect_bd_net -net axcache_coherent_dout  [get_bd_pins axcache_coherent/dout] \
  [get_bd_pins zynq_ultra_ps_e_0/saxigp0_awcache] \
  [get_bd_pins zynq_ultra_ps_e_0/saxigp0_arcache]
  ...
  connect_bd_net -net axprot_unsecure_dout  [get_bd_pins axprot_unsecure/dout] \
  [get_bd_pins zynq_ultra_ps_e_0/saxigp0_awprot] \
  [get_bd_pins zynq_ultra_ps_e_0/saxigp0_arprot]
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW] -force
  ...
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW] -force
...
create_root_design "" $design_name $options 
	...
	1. Select Generate Bitstream in the Flow Navigator to create .bit file.
	2. Select File -> Export -> Export Hardware to export .xsa file.
	3. Refer to README.md in below url for Vitis steps
	https://github.com/abommera/XilinxCEDStore/tree/2025.1/ced/Xilinx/IPI/	
ZynqMP-AXIDMA-WTS-Example } [current_bd_design]
save_bd_design
