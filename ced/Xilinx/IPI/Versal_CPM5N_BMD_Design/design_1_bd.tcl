...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net psx_wizard_0_pl0_ref_clk [get_bd_ports cpm_bot_user_clk_0] [get_bd_pins psx_wizard_0/cpm_bot_user_clk] [get_bd_pins psx_wizard_0/pl0_ref_clk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins psx_wizard_0/cpm_gpi] [get_bd_pins xlconstant_0/dout]
