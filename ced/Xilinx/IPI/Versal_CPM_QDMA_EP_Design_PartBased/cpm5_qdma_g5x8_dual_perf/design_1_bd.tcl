...
proc create_root_design { parentCell } {
  ...
  set M_AXIL_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXIL_0 ]
  ...
  set M_AXIL_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXIL_1 ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {42} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.PROTOCOL {AXI4LITE} \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXIL_0:M_AXIL_0:M_AXIL_1:S_AXIL_1} \
 ] $dma0_user_clk_0
...
NONE HBM_PC1_USER_DEFINED_ADDRESS_MAP NONE} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.DEST_IDS {M03_AXI:0x0:M01_AXI:0x80:M02_AXI:0x40:M00_AXI:0xc0} \
   CONFIG.NOC_PARAMS {} \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI:M02_AXI:M03_AXI} \
  ...
  assign_bd_address -offset 0x000880000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces versal_cips_0/CPM_PCIE_NOC_0] [get_bd_addr_segs axi_noc_0/S00_AXI/C0_DDR_LOW1] -force
  ...
  assign_bd_address -offset 0x000880000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces versal_cips_0/CPM_PCIE_NOC_1] [get_bd_addr_segs axi_noc_0/S01_AXI/C0_DDR_LOW1] -force
