...
module design_1_wrapper
  ...
  wire [1:0]pcie0_cfg_control_0_flr_done;
  ...
  wire [1:0]pcie0_cfg_interrupt_0_pending;
...
wire pl_ref_clk;
  design_1 design_1_i
       (.gt_refclk0_0_clk_n(gt_refclk0_0_clk_n),
        ...
        .pcie0_cfg_control_0_flr_done({{2'b00},pcie0_cfg_control_0_flr_done}),
        ...
        .pcie0_cfg_interrupt_0_pending({{2'b00},pcie0_cfg_interrupt_0_pending}),
        ...
        .pcie0_cfg_msix_mint_vector_0(pcie0_cfg_msix_mint_vector_0),
        ...
        .pcie0_cfg_10b_tag_requester_enable_0(pcie0_cfg_10b_tag_requester_enable_0),
        .pcie0_cfg_atomic_requester_enable_0(pcie0_cfg_atomic_requester_enable_0),
        .pcie0_cfg_ext_tag_enable_0(pcie0_cfg_ext_tag_enable_0),
...
//------------------------------------------------------------------------------------------------------------------//
  pcie_app_versal #(
   ...
   // .sys_rst                                        ( ch0_phyready_0 ), //sys_rst_n_c
    ...
    .pcie_rq_seq_num                               ( pcie0_cfg_status_0_rq_seq_num0     ) ,
    .pcie_rq_seq_num_vld                           ( pcie0_cfg_status_0_rq_seq_num_vld0 ) ,
    //.pcie_rq_seq_num                               ( pcie0_cfg_status_0_rq_seq_num1     ) ,
    //.pcie_rq_seq_num_vld                           ( pcie0_cfg_status_0_rq_seq_num_vld1 ) ,
    .pcie_rq_tag                                    ( {{4'h0},pcie0_cfg_status_0_rq_tag0}),
...
assign sig_ila = {'h0,pcie0_cfg_status_0_err_nonfatal_out,pcie0_cfg_status_0_err_fatal_out,pcie0_cfg_status_0_local_error_out,pcie0_cfg_status_0_local_error_valid,pcie0_cfg_status_0_err_cor_out};


//axis_ila_0 u_ila_0 (
//  .clk(pl_ref_clk),        // input wire clk
//  .probe0(sig_ila)  // input wire [0 : 0] probe0
//);        
