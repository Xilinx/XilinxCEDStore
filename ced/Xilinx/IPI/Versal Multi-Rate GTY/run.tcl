...
IS_CURRENT_QUAD 1}}}\
  ...
  set_property -dict [list \
   ...
   CONFIG.PS_PMC_CONFIG {DESIGN_MODE 1 PCIE_APERTURES_DUAL_ENABLE 0 PCIE_APERTURES_SINGLE_ENABLE 0\
...
PS_GEN_IPI5_ENABLE 1 PS_GEN_IPI6_ENABLE 1 PS_I2C1_PERIPHERAL {{ENABLE 1} {IO\
{PMC_MIO 44 .. 45}}} PS_MIO19 {{AUX_IO 0} {DIRECTION in} {DRIVE_STRENGTH 8mA}\
...
{PULL disable} {SCHMITT 0} {SLEW slow} {USAGE Reserved}} PS_MIO7 {{AUX_IO 0}\
...
slow} {USAGE Reserved}} PS_PCIE1_PERIPHERAL_ENABLE 0 PS_PCIE2_PERIPHERAL_ENABLE\
0 PS_PCIE_RESET {{ENABLE 1} {IO {PMC_MIO 38 .. 39}}} PS_UART0_PERIPHERAL\
{{ENABLE 1} {IO {PMC_MIO 42 .. 43}}} PS_USB3_PERIPHERAL {{ENABLE 1} {IO\
{PMC_MIO 13 .. 25}}} SMON_ALARMS Set_Alarms_On SMON_ENABLE_TEMP_AVERAGING 0\
