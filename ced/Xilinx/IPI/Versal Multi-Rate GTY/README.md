...
Boot Mode: JTAG
## Block Diagram
![image](https://user-images.githubusercontent.com/73725387/100679769-0bd13a80-3325-11eb-8a46-095d660e5733.png)
...
2. Synthesize and open synthesized design
3. Add top level constraints
    ...
    * Click **Save**. Vivado may ask to create and specify the top level constraint file name if there is none existing in the current design. Follow instructions in the Vivado pop-up to create xdc.
...
4. Run implementation and generate PDI. Make sure timing is clean.
...
* Open gt_quad_base IP to confirm APB3 clock frequency is set to 200 MHz. We will be using the LPDDR4 SI570 Clock2 on VMK180 to drive APB3CLK and its default frequency is 200 MHz.
![image](https://user-images.githubusercontent.com/73725387/100335132-7b43d480-2f89-11eb-8c28-5f5e5803121e.png)
...
3. Customize for 5 inputs and 3 outputs, and connect as follows:
...
#### 8. Implementation and PDI generation
