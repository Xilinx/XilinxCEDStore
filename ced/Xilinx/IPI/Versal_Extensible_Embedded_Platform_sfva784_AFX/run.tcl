...
# Create instance: CIPS_0, and set properties
 set CIPS_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:versal_cips CIPS_0 ]
  ...
  CONFIG.PS_PMC_CONFIG { \
    ...
    PMC_SD1 {{CD_ENABLE 1} {CD_IO {PMC_MIO 28}} {POW_ENABLE 0} {POW_IO {PMC_MIO 51}} {RESET_ENABLE 0} {RESET_IO {PMC_MIO 12}} {WP_ENABLE 1} {WP_IO {PMC_MIO 50}}} \
...
create_root_design $currentDir $design_name $use_lpddr $clk_options $irqs $use_aie
	...
	if { $use_lpddr } {
	set xdc [file join $currentDir constrs_1 lpddr_ddr_top.xdc]
