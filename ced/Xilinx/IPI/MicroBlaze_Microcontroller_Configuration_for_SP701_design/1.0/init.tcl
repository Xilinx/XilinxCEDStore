...
proc getConfigDesignInfo {} { 
  return [dict create name {MicroBlaze_Microcontroller_Configuration_for_SP701} description {}]
}
...
proc createDesign { project_name {project_location "."} {options ""}} { 
  ...
  catch {source -notrace "$currentDir/MicroBlaze_Microcontroller_Configuration_for_SP701_design.tcl"} retString 
