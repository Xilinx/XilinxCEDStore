...
module design_1_wrapper #(
   parameter [1:0]        AXISTEN_IF_RQ_STRADDLE           = 2'b10, //00: max 1 packet, 01: max 2 TLPs, 10: max 4 TLPs, 11: rsvd
   parameter [1:0]        AXISTEN_IF_RC_STRADDLE           = 2'b11,
   parameter [1:0]        AXISTEN_IF_CQ_STRADDLE           = 0,
   parameter [1:0]        AXISTEN_IF_CC_STRADDLE           = 0,
  ...
  wire [C_DATA_WIDTH-1:0]pcie1_m_axis_rc_0_tdata;
  wire [KEEP_WIDTH-115:0]pcie1_m_axis_rc_0_tkeep;
  wire pcie1_m_axis_rc_0_tlast;
  wire pcie1_m_axis_rc_0_tready;
  wire [AXI4_RC_TUSER_WIDTH-1:0]pcie1_m_axis_rc_0_tuser;
  ...
  wire [KEEP_WIDTH-115:0]pcie1_s_axis_cc_0_tkeep;
  ...
  wire [C_DATA_WIDTH-1:0]pcie1_s_axis_rq_0_tdata;
  wire [KEEP_WIDTH-115:0]pcie1_s_axis_rq_0_tkeep;
...
//------------------------------------------------------------------------------------------------------------------//
  pcie_app_versal_bmd #( 
   ...
   // .sys_rst                                        ( ch0_phyready_0 ), //sys_rst_n_c
    ...
    .pcie_rq_seq_num2                               ( pcie1_cfg_status_0_rq_seq_num2     ) ,
    .pcie_rq_seq_num_vld2                           ( pcie1_cfg_status_0_rq_seq_num_vld2 ) ,
    .pcie_rq_seq_num3                               ( pcie1_cfg_status_0_rq_seq_num3     ) ,
    .pcie_rq_seq_num_vld3                           ( pcie1_cfg_status_0_rq_seq_num_vld3 ) ,	
 ...
 //   .pcie_tfc_nph_av                                 ( pcie1_transmit_fc_0_nph_av[1:0]),
  //  .pcie_tfc_npd_av                                ( pcie1_transmit_fc_0_npd_av[1:0]),
   ...
   // .cfg_msg_transmit_done                          ( pcie1_cfg_msg_tx_0_transmit_done ),
    .cfg_10b_tag_requester_enable                   (pcie1_cfg_10b_tag_requester_enable_0),
 ...
 //  .cfg_req_pm_transition_l23_ready                ( cfg_req_pm_transition_l23_ready ), //VG to check
  ...
  /*  .cfg_interrupt_msi_enable                       ( pcie1_cfg_msi_0_enable ),
    ...
    .cfg_interrupt_msix_mask   ({3'b0,pcie1_cfg_msix_0_mask[0]}),
    .cfg_interrupt_msix_vf_mask  (),
    .cfg_interrupt_msix_vf_enable  (6'b0),
