...
set V_board_unique [get_board_parts -filter {(BOARD_NAME =~"*vck190*" && VENDOR_NAME=="xilinx.com")||(BOARD_NAME =~"*vek280*" && VENDOR_NAME=="xilinx.com")||(BOARD_NAME =~"*vhk158*" && VENDOR_NAME=="xilinx.com")||(BOARD_NAME =~"*vmk180*" && VENDOR_NAME=="xilinx.com")||(BOARD_NAME =~"*vpk120*" && VENDOR_NAME=="xilinx.com")||(BOARD_NAME =~"*vpk180*" && VENDOR_NAME=="xilinx.com")} -latest_file_version -quiet]
...
proc addOptions {DESIGNOBJ PROJECT_PARAM.BOARD_PART} {
	lappend x [dict create name "Preset" type "string" value "Microcontroller" value_list {"Microcontroller Microcontroller______DDR_is_not_included" "Application Application____________DDR_included"} enabled true]
	return $x
}
