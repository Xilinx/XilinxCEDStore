...
variable design_name_cdm
set design_name_cdm cdm_usr_ram

# If you do not already have an existing IP Integrator design open,
# you can create a design using the following command:
#    create_bd_design $design_name_cdm
...
if { ${design_name_cdm} eq "" } {
   # USE CASES:
   #    1) Design_name not set

   set errMsg "Please set the variable <design_name_cdm> to a non-empty value."
   set nRet 1

} elseif { ${cur_design} ne "" && ${list_cells} eq "" } {
   # USE CASES:
   #    2): Current design opened AND is empty AND names same.
   #    3): Current design opened AND is empty AND names diff; design_name_cdm NOT in project.
   #    4): Current design opened AND is empty AND names diff; design_name_cdm exists in project.

   if { $cur_design ne $design_name_cdm } {
      common::send_gid_msg -ssname BD::TCL -id 2001 -severity "INFO" "Changing value of <design_name_cdm> from <$design_name_cdm> to <$cur_design> since current design is empty."
      set design_name_cdm [get_property NAME $cur_design]
   }
   common::send_gid_msg -ssname BD::TCL -id 2002 -severity "INFO" "Constructing design in IPI design <$cur_design>..."

} elseif { ${cur_design} ne "" && $list_cells ne "" && $cur_design eq $design_name_cdm } {
   # USE CASES:
   #    5) Current design opened AND has components AND same names.

   set errMsg "Design <$design_name_cdm> already exists in your project, please set the variable <design_name_cdm> to another value."
   set nRet 1
} elseif { [get_files -quiet ${design_name_cdm}.bd] ne "" } {
   # USE CASES: 
   #    6) Current opened design, has components, but diff names, design_name_cdm exists in project.
   #    7) No opened design, design_name_cdm exists in project.
   ...
   # USE CASES:
   #    8) No opened design, design_name_cdm not in project.
   #    9) Current opened design, has components, but diff names, design_name_cdm not in project.

   common::send_gid_msg -ssname BD::TCL -id 2003 -severity "INFO" "Currently there is no design <$design_name_cdm> in project, so creating one..."

   create_bd_design $design_name_cdm

   common::send_gid_msg -ssname BD::TCL -id 2004 -severity "INFO" "Making design <$design_name_cdm> as current_bd_design."
   current_bd_design $design_name_cdm

}

common::send_gid_msg -ssname BD::TCL -id 2005 -severity "INFO" "Currently the variable <design_name_cdm> is equal to \"$design_name_cdm\"."
...
proc create_root_design { parentCell } {
  ...
  set S_AXIL_CDMRAM [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXIL_CDMRAM ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
  ...
  set msgstld_perf_reg [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 msgstld_perf_reg ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {32} \
   CONFIG.FREQ_HZ {250000000} \
  ...
  # Create ports
  set MSGLD_CMD_RAM_addrb [ create_bd_port -dir I -from 12 -to 0 MSGLD_CMD_RAM_addrb ]
  ...
  set MSGLD_Payload_RAM_addrb [ create_bd_port -dir I -from 12 -to 0 MSGLD_Payload_RAM_addrb ]
  ...
  set MSGST_CMD_RAM_addrb [ create_bd_port -dir I -from 12 -to 0 MSGST_CMD_RAM_addrb ]
  ...
  set MSGST_Payload_RAM_addrb [ create_bd_port -dir I -from 12 -to 0 MSGST_Payload_RAM_addrb ]
  ...
  set MSG_Response_RAM_addrb [ create_bd_port -dir I -from 12 -to 0 MSG_Response_RAM_addrb ]
  ...
  set clk_in [ create_bd_port -dir I -type clk -freq_hz 250000000 clk_in ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_CDM:M_CDM_ADAPT_CTRL_REGS:S_AXIL_CDMRAM:msgstld_perf_reg} \
 ] $clk_in
  ...
  connect_bd_intf_net -intf_net S_AXIL_CDMRAM_1 [get_bd_intf_ports S_AXIL_CDMRAM] [get_bd_intf_pins smartconnect_0/S01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_ports msgstld_perf_reg] [get_bd_intf_pins smartconnect_0/M06_AXI]

  # Create port connections
  connect_bd_net -net MSGLD_CMD_RAM_addrb_1 [get_bd_ports MSGLD_CMD_RAM_addrb] [get_bd_pins MSGLD_CMD_RAM/addrb]
  connect_bd_net -net MSGLD_CMD_RAM_doutb1 [get_bd_pins MSGLD_CMD_RAM/doutb] [get_bd_ports MSGLD_CMD_RAM_doutb]
  ...
  connect_bd_net -net MSGLD_Payload_RAM_web_1 [get_bd_ports MSGLD_Payload_RAM_web] [get_bd_pins MSGLD_Payload_RAM/web] [get_bd_pins util_reduced_logic_2/Op1]
  connect_bd_net -net MSGST_CMD_RAM_addrb_1 [get_bd_ports MSGST_CMD_RAM_addrb] [get_bd_pins MSGST_CMD_RAM/addrb]
  connect_bd_net -net MSGST_CMD_RAM_doutb1 [get_bd_pins MSGST_CMD_RAM/doutb] [get_bd_ports MSGST_CMD_RAM_doutb]
  ...
  connect_bd_net -net MSGST_Payload_RAM_web_1 [get_bd_ports MSGST_Payload_RAM_web] [get_bd_pins MSGST_Payload_RAM/web] [get_bd_pins util_reduced_logic_1/Op1]
  ...
  connect_bd_net -net MSG_Response_RAM_web_1 [get_bd_ports MSG_Response_RAM_web] [get_bd_pins MSG_Response_RAM/web] [get_bd_pins util_reduced_logic_0/Op1]
  ...
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins util_reduced_logic_0/Res] [get_bd_pins MSG_Response_RAM/enb]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins util_reduced_logic_1/Res] [get_bd_pins MSGST_Payload_RAM/enb]
  connect_bd_net -net util_reduced_logic_2_Res [get_bd_pins util_reduced_logic_2/Res] [get_bd_pins MSGLD_Payload_RAM/enb]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins MSGLD_CMD_RAM/rstb] [get_bd_pins MSGLD_Payload_RAM/rstb] [get_bd_pins MSGST_CMD_RAM/rstb] [get_bd_pins MSGST_Payload_RAM/rstb] [get_bd_pins MSG_Response_RAM/rstb]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs MSGLD_CMD_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs MSGLD_Payload_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x0000A000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs MSGST_CMD_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs MSGST_Payload_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00006000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs MSG_Response_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs M_CDM_ADAPT_CTRL_REGS/Reg] -force
  assign_bd_address -offset 0x0000C000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXIL_CDMRAM] [get_bd_addr_segs msgstld_perf_reg/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs MSGLD_CMD_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00004000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs MSGLD_Payload_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x0000A000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs MSGST_CMD_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs MSGST_Payload_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00006000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs MSG_Response_bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs M_CDM_ADAPT_CTRL_REGS/Reg] -force
  assign_bd_address -offset 0x0000C000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_CDM] [get_bd_addr_segs msgstld_perf_reg/Reg] -force
