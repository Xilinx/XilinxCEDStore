...
proc create_root_design { parentCell } {
  ...
  set addra_cmpl_data [ create_bd_port -dir I -from 12 -to 0 addra_cmpl_data ]
  set douta_cmpl_data [ create_bd_port -dir O -from 31 -to 0 douta_cmpl_data ]
  set wea_cmpl_data [ create_bd_port -dir I -from 3 -to 0 wea_cmpl_data ]
  ...
  # Create instance: axi_bram_ctrl_cmpl_data_bram1, and set properties
  set axi_bram_ctrl_cmpl_data_bram1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:emb_mem_gen axi_bram_ctrl_cmpl_data_bram1 ]
  set_property CONFIG.MEMORY_TYPE {True_Dual_Port_RAM} $axi_bram_ctrl_cmpl_data_bram1
  ...
  connect_bd_net -net addra_0_2 [get_bd_ports addra_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/addra]
  ...
  connect_bd_net -net addrb_cmpl_data_1 [get_bd_ports addrb_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram/addrb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/addrb]
  ...
  connect_bd_net -net axi_bram_ctrl_cmpl_check_seed_bram_doutb [get_bd_pins axi_bram_ctrl_cmpl_check_seed_bram/doutb] [get_bd_ports doutb_cmpl_check_seed]
  connect_bd_net -net axi_bram_ctrl_cmpl_data_bram1_douta [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/douta] [get_bd_ports douta_cmpl_data]
  connect_bd_net -net axi_bram_ctrl_cmpl_data_bram1_doutb [get_bd_pins axi_bram_ctrl_cmpl_cmd/doutb] [get_bd_ports doutb_cmpl_cmd]
  connect_bd_net -net axi_bram_ctrl_cmpl_data_bram_doutb [get_bd_pins axi_bram_ctrl_cmpl_data_bram/doutb] [get_bd_ports doutb_cmpl_data]
  connect_bd_net -net axi_bram_ctrl_npr_cmd_bram_doutb [get_bd_pins axi_bram_ctrl_npr_cmd_bram/doutb] [get_bd_ports doutb_npr_cmd]
  connect_bd_net -net axi_bram_ctrl_npr_data_bram_doutb [get_bd_pins axi_bram_ctrl_npr_data_bram/doutb] [get_bd_ports doutb_npr_data]
  connect_bd_net -net axi_bram_ctrl_pr_check_seed_bram_doutb [get_bd_pins axi_bram_ctrl_pr_check_seed_bram/doutb] [get_bd_ports doutb_pr_check_seed]
  connect_bd_net -net axi_bram_ctrl_pr_cmd_bram_doutb [get_bd_pins axi_bram_ctrl_pr_cmd_bram/doutb] [get_bd_ports doutb_pr_cmd]
  connect_bd_net -net axi_bram_ctrl_pr_data_bram_doutb [get_bd_pins axi_bram_ctrl_pr_data_bram/doutb] [get_bd_ports doutb_pr_data]
  ...
  connect_bd_net -net dinb_cmpl_data_1 [get_bd_ports dinb_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram/dinb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/dinb]
  ...
  connect_bd_net -net enb_cmpl_data_1 [get_bd_ports enb_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram/enb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/enb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/ena]
  ...
  connect_bd_net -net rstb_cmpl_data_1 [get_bd_ports rstb_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram/rstb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/rstb] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/rsta]
  ...
  connect_bd_net -net wea_0_2 [get_bd_ports wea_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/wea]
  ...
  connect_bd_net -net web_cmpl_data_1 [get_bd_ports web_cmpl_data] [get_bd_pins axi_bram_ctrl_cmpl_data_bram/web] [get_bd_pins axi_bram_ctrl_cmpl_data_bram1/web]
  ...
  assign_bd_address -offset 0x00B00000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs M_AXI_CSI_UPORT_axil/Reg] -force
  assign_bd_address -offset 0x00B90000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_cmpl_check_seed/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00B40000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_cmpl_data/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00B10000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_npr_cmd/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00B80000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_npr_data/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00BA0000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_check_seed/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00B20000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_cmd/S_AXI/Mem0] -force
  assign_bd_address -offset 0x00BC0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces S_AXI_UPORT] [get_bd_addr_segs axi_bram_ctrl_pr_data/S_AXI/Mem0] -force
