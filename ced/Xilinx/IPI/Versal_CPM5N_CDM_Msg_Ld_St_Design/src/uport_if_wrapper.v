...
//--------------------------------------------------------------------------------
//Tool Version: Vivado v.2022.2.0 (lin64) Build 3588945 Sat Jul 16 16:30:55 MDT 2022
//Date        : Tue Jul 19 15:32:28 2022
//Host        : 
//Command     : generate_target uport_if_wrapper.bd
//Design      : uport_if_wrapper
...
module uport_if_wrapper
  ...
  uport_if uport_if_i
       (.ACLK_UPORT(ACLK_UPORT),
        ...
        .addra_cmpl_data(addra_cmpl_data),
        ...
        .douta_cmpl_data(douta_cmpl_data),
