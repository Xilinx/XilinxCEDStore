...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_pins MSG_Response_RAM/enb] [get_bd_pins util_reduced_logic_0/Res]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins MSGST_Payload_RAM/enb] [get_bd_pins util_reduced_logic_1/Res]
  connect_bd_net -net util_reduced_logic_2_Res [get_bd_pins MSGLD_Payload_RAM/enb] [get_bd_pins util_reduced_logic_2/Res]
