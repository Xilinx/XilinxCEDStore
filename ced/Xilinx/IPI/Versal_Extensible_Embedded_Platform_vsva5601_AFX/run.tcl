...
set_property CONFIG.PS_PMC_CONFIG { \
  ...
  PMC_SD0_SLOT_TYPE {SD 2.0} \
  PMC_SD1 {{CD_ENABLE 1} {CD_IO {PMC_MIO 28}} {POW_ENABLE 0} {POW_IO {PMC_MIO 12}} {RESET_ENABLE 0} {RESET_IO {PMC_MIO 12}} {WP_ENABLE 1} {WP_IO {PMC_MIO 50}}} \
  PMC_SD1_PERIPHERAL {{CLK_100_SDR_OTAP_DLY 0x00} {CLK_200_SDR_OTAP_DLY 0x00} {CLK_50_DDR_ITAP_DLY 0x00} {CLK_50_DDR_OTAP_DLY 0x00} {CLK_50_SDR_ITAP_DLY 0x2C} {CLK_50_SDR_OTAP_DLY 0x00} {ENABLE 1} {IO {PMC_MIO 26 .. 36}}} \
...
set_property -dict [list CONFIG.NUM_SI {9} CONFIG.NUM_MI {0} CONFIG.NUM_NSI {0} CONFIG.NUM_NMI {1} CONFIG.NUM_CLKS {10}] [get_bd_cells cips_noc]
...
# CONFIG.MC_MEMORY_DEVICE_DENSITY {16Gb} CONFIG.MC_TRFC {550000} CONFIG.MC_TXPR {896} CONFIG.MC_ROWADDRESSWIDTH {17} CONFIG.MC_USER_DEFINED_ADDRESS_MAP {17RA-2BA-2BG-10CA}
 # CONFIG.MC_TRFCMIN {550000} CONFIG.MC_ECC_SCRUB_SIZE {16384} CONFIG.MC_DDR_INIT_TIMEOUT {0x000EC34C}] [get_bd_cells noc_ddr4]
  ...
  set_property -dict [list \
    ...
    CONFIG.MC_FREQ_SEL {SYS_CLK_FROM_MEMORY_CLK} \
...
set_property -dict [ list  CONFIG.FREQ_HZ {300000000} ] $C0_DDR4_SYSCLK
...
connect_bd_intf_net [get_bd_intf_pins CIPS_0/PMC_NOC_AXI_3] [get_bd_intf_pins cips_noc/S08_AXI]
...
connect_bd_net [get_bd_pins CIPS_0/pmc_axi_noc_axi3_clk] [get_bd_pins cips_noc/aclk9]
...
if { $use_aie } {
set_property -dict [list CONFIG.NUM_MI {1} CONFIG.NUM_CLKS {11}] [get_bd_cells cips_noc]
...
set_property -dict [list CONFIG.CONNECTIONS {M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /cips_noc/S08_AXI]
set_property -dict [list CONFIG.ASSOCIATED_BUSIF {M00_AXI}] [get_bd_pins /cips_noc/aclk10]
...
set_property -dict [list CONFIG.CONNECTIONS {M01_INI { read_bw {128} write_bw {128}} M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} M00_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /cips_noc/S08_AXI]
set_property -dict [list CONFIG.ASSOCIATED_BUSIF {}] [get_bd_pins /cips_noc/aclk10]
} else {
set_property -dict [list CONFIG.NUM_NMI {2}] [get_bd_cells cips_noc]
...
create_root_design $currentDir $design_name $use_lpddr $clk_options $irqs $use_aie
	...
	set_property PFM.AXI_PORT {S09_AXI {memport "S_AXI_NOC" sptag "" memory "" is_range "true"} S10_AXI {memport "S_AXI_NOC" sptag "" memory "" is_range "true"} M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"}} [get_bd_cells /cips_noc]
