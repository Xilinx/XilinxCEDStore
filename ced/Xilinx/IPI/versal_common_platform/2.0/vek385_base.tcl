...
set_property -dict [list \
  ...
  CONFIG.PS11_CONFIG(SMON_MEAS43) {ENABLE 1 MODE 2V_unipolar NAME VCC_SOC AVERAGE_EN 0 ALARM_ENABLE 0 ALARM_LOWER 0.00 ALARM_UPPER 2.00 SUPPLY_NUM 37} \
  CONFIG.PS11_CONFIG(SMON_MEAS44) {ENABLE 1 MODE 1V_unipolar NAME VP_VN AVERAGE_EN 0 ALARM_ENABLE 0 ALARM_LOWER 0.00 ALARM_UPPER 1.00 SUPPLY_NUM 38} \
] [get_bd_cells ps_wizard_0]
...
# Create interface connections
#connect_bd_intf_net [get_bd_intf_ports pl_uart_bank705] [get_bd_intf_pins axi_uart16550_0/UART]
...
# connect_bd_net -net clk_wizard_0_clk_out1   [get_bd_pins board_misc_sc_gpio_out/s_axi_aclk] \
