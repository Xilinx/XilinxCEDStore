...
proc getConfigDesignInfo {} { 
  return [dict create name {MicroBlaze_Realtime_Preset_SP701} description {}]
}
...
proc createDesign { project_name {project_location "."} {options ""}} { 
  ...
  catch {source -notrace "$currentDir/MicroBlaze_Realtime_Preset_SP701_design.tcl"} retString 
