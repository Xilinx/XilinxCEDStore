...
apply_board_connection -board_interface "gpio_dp" -ip_intf "axi_gpio_1/GPIO" -diagram $design_name 

# create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio axi_gpio_2
# apply_board_connection -board_interface "gpio_pb" -ip_intf "axi_gpio_2/GPIO" -diagram $design_name 

create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uart16550 axi_uart16550_0
apply_board_connection -board_interface "pl_uart_bank713" -ip_intf "axi_uart16550_0/UART" -diagram $design_name 
...
connect_bd_intf_net [get_bd_intf_pins ctrl_smc/M03_AXI] [get_bd_intf_pins axi_uart16550_0/S_AXI] 

connect_bd_net [get_bd_pins clkx5_wiz_0/locked] [get_bd_pins rst_clk/dcm_locked]
connect_bd_net [get_bd_pins ps_wizard_0/pl0_ref_clk] [get_bd_pins clkx5_wiz_0/clk_in1] 
connect_bd_net [get_bd_pins ps_wizard_0/pl0_resetn] [get_bd_pins clkx5_wiz_0/resetn]
