...
connect_bd_net [get_bd_pins ilconstant_0/dout] [get_bd_pins clk_wizard_0/${default_mbuf_port}_clr_n]
connect_bd_net [get_bd_pins clk_wizard_0/${default_mbuf_port}_ce] [get_bd_pins ilconstant_0/dout] }
...
for {set i 0} {$i < $num_clks} {incr i} {
	if {($i == $mbufgce_clk_num) &&($mbufgce == 1)} {
	connect_bd_net -net ps_wizard_0_pl_resetn1 [get_bd_pins proc_sys_reset_o4/ext_reset_in]
	} else {
...
connect_bd_net -net $default_clock_net [get_bd_pins clk_wizard_0/$default_clk_port] [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins ctrl_smc/aclk]
