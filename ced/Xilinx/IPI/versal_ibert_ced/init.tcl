...
proc getSupportedParts {} {
  ...
  set newlist [list]
  foreach item $mylist {
    if {[string range $item 0 7] != "xave2002" && [string range $item 0 7] != "xave2102" && [string range $item 0 7] != "xave2202" && [string range $item 0 8] != "xc2ve3504" && [string range $item 0 8] != "xc2ve3558" && [string range $item 0 8] != "xc2ve3804" && [string range $item 0 8] != "xc2ve3858" && [string range $item 0 8] != "xc2vm3558" && [string range $item 0 8] != "xc2vm3858"} {
