  ...
  foreach q [get_all_quads $pkg] {
    if {[dictDefault $options ${q}_en.VALUE false] == "true"} {
      ...
      if {[regexp {X\d+Y\d+} $ref_loc] == 0} {
        set my_q $ref_loc
        set source_lr [dictDefault $options ${my_q}_lr.VALUE [get_default_lr $my_q]]
        set qt [get_quad_type $q]
        set max_share_lr [get_max_refclk_sharing_linerate $qt]
        # Validate that refclk sharing is still allowed at this line rate;
        # the GUI range may have been updated but the stale VALUE can persist
        if {$source_lr >= $max_share_lr} {
          log "  refclk sharing not allowed: line_rate $source_lr >= max $max_share_lr, falling back to local refclk"
          set ref_loc $default_loc
        } else {
...
proc createDesign {design_name options} {
  ...
  proc create_root_design { parentCell design_name protocols} {
	...
	set_property name gt_refclk_$name [get_bd_intf_ports CLK_IN_D_0]
      ...
      if {$logStuff} { 
        puts $f "set_property -dict \[list CONFIG.INTF0_GT_SETTINGS(LR0_SETTINGS) \"$values\"\] \[get_bd_cells gtwiz_versal_$name\]"
        flush $f
      }
      ...
      if {$num_quads == 1} {     
        set_property -dict [list \
          ...
          CONFIG.INTF0_GT_SETTINGS(LR0_SETTINGS) $values \
          ] [get_bd_cells gtwiz_versal_$name]
	
	connect_bd_net [get_bd_pins bufg_gt_tx_$name/usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_$name/usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX3_usrclk]
	...
	make_bd_intf_pins_external  [get_bd_intf_pins gtwiz_versal_$name/Quad0_GT_Serial]
        ...
        if {$type eq "GTM"} {
          ...
          connect_bd_net [get_bd_pins util_ds_buf_$name/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0]
	} else {
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_$name/usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX3_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_$name/usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_RX3_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_RX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_RX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_RX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_RX3_usrclk]
	...
	if {$type eq "GTM"} {  
	  ...
	  connect_bd_net [get_bd_pins util_ds_buf_$name/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD1_GTREFCLK0]
	} else {
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_$name/usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD0_TX3_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD1_TX3_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD2_TX0_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD2_TX1_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD2_TX2_usrclk] [get_bd_pins gtwiz_versal_$name/QUAD2_TX3_usrclk]
	...
	if {$type eq "GTM"} {
	  ...
	  connect_bd_net [get_bd_pins util_ds_buf_$name/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD1_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD2_GTREFCLK0]
        } else {
	...
	if {$type eq "GTM"} {
	  ...
	  connect_bd_net [get_bd_pins util_ds_buf_$name/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD1_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD2_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD3_GTREFCLK0]
        } else {
	  connect_bd_net [get_bd_pins util_ds_buf_$name/IBUF_OUT] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD1_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD2_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD3_GTREFCLK0]
        }	  
	...
	if {$type eq "GTM"} {  
	  ...
	  connect_bd_net [get_bd_pins util_ds_buf_$name/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_$name/QUAD0_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD1_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD2_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD3_GTREFCLK0] [get_bd_pins gtwiz_versal_$name/QUAD4_GTREFCLK0]
	} else {
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_$name/gtwiz_freerun_clk]
    } else {
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_0_$name/usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_0_$name/usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_0_$name/QUAD0_RX3_usrclk]
	...
	make_bd_intf_pins_external  [get_bd_intf_pins gtwiz_versal_0_$name/Quad0_GT_Serial]
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_0_$name/gtwiz_freerun_clk]	
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_1_$name/usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_1_$name/usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_1_$name/QUAD0_RX3_usrclk]	
	...
	if {$type eq "GTM"} {  
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_0_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_1_$name/gtwiz_freerun_clk]	 
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_2_$name/usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_2_$name/usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_2_$name/QUAD0_RX3_usrclk]	
	...
	if {$type eq "GTM"} {
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_0_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_1_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_2_$name/gtwiz_freerun_clk]
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_3_$name/usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_3_$name/usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_3_$name/QUAD0_RX3_usrclk]	
	...
	if {$type eq "GTM"} {
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_0_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_1_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_2_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_3_$name/gtwiz_freerun_clk]	
	...
	connect_bd_net [get_bd_pins bufg_gt_tx_4_$name/usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_TX3_usrclk]
	connect_bd_net [get_bd_pins bufg_gt_rx_4_$name/usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_4_$name/QUAD0_RX3_usrclk]	
	...
	if {$type eq "GTM"} {  
      ...
      connect_bd_net [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins gtwiz_versal_0_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_1_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_2_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_3_$name/gtwiz_freerun_clk] [get_bd_pins gtwiz_versal_4_$name/gtwiz_freerun_clk]
