...
################################################################
# This is a generated script based on design: design_ep
#
...
variable design_name_ep
set design_name_ep design_ep
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./design_ep_switch_straddle
  ...
  set str_bd_filepath ${str_bd_folder}/${design_name_ep}/${design_name_ep}.bd

  # Check if remote design exists on disk
  if { [file exists $str_bd_filepath ] == 1 } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2030 -severity "ERROR" "The remote BD file path <$str_bd_filepath> already exists!"}
     common::send_gid_msg -ssname BD::TCL -id 2031 -severity "INFO" "To create a non-remote BD, change the variable <run_remote_bd_flow> to <0>."
     common::send_gid_msg -ssname BD::TCL -id 2032 -severity "INFO" "Also make sure there is no design <$design_name_ep> existing in your current project."

     return 1
  }

  # Check if design exists in memory
  set list_existing_designs [get_bd_designs -quiet $design_name_ep]
  if { $list_existing_designs ne "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2033 -severity "ERROR" "The design <$design_name_ep> already exists in this project! Will not create the remote BD <$design_name_ep> at the folder <$str_bd_folder>."}

     common::send_gid_msg -ssname BD::TCL -id 2034 -severity "INFO" "To create a non-remote BD, change the variable <run_remote_bd_flow> to <0> or please set a different value to variable <design_name_ep>."

     return 1
  }

  # Check if design exists on disk within project
  set list_existing_designs [get_files -quiet */${design_name_ep}.bd]
  if { $list_existing_designs ne "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2035 -severity "ERROR" "The design <$design_name_ep> already exists in this project at location:
    $list_existing_designs"}
     catch {common::send_gid_msg -ssname BD::TCL -id 2036 -severity "ERROR" "Will not create the remote BD <$design_name_ep> at the folder <$str_bd_folder>."}

     common::send_gid_msg -ssname BD::TCL -id 2037 -severity "INFO" "To create a non-remote BD, change the variable <run_remote_bd_flow> to <0> or please set a different value to variable <design_name_ep>."

     return 1
  }

  # Now can create the remote BD
  # NOTE - usage of <-dir> will create <$str_bd_folder/$design_name_ep/$design_name_ep.bd>
  create_bd_design -dir $str_bd_folder $design_name_ep
} else {

  # Create regular design
  if { [catch {create_bd_design $design_name_ep} errmsg] } {
     common::send_gid_msg -ssname BD::TCL -id 2038 -severity "INFO" "Please set a different value to variable <design_name_ep>."

     return 1
  }
}

current_bd_design $design_name_ep
...
-20 RX_RATE_GROUP A RX_TERMINATION PROGRAMMABLE RX_TERMINATION_PROG_VALUE 800} \
    CONFIG.INTF0_PARENTID {design_ep_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_intf_net -intf_net pcie_versal_0_pcie_ext_pipe_ep [get_bd_intf_ports pipe_ep] [get_bd_intf_pins pcie_versal_0/pcie_ext_pipe_ep]
