...
create_clock -period 10.000 -name sys_clk_dsp [get_ports {dsp_pcie_refclk_clk_p}]
...
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[0]} -of_objects [get_cells -hierarchical bufg_gt_pclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[1]} -of_objects [get_cells -hierarchical bufg_gt_pclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[2]} -of_objects [get_cells -hierarchical bufg_gt_pclk -filter NAME=~*switch_dsp/*]]

set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[0]} -of_objects [get_cells -hierarchical bufg_gt_coreclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[1]} -of_objects [get_cells -hierarchical bufg_gt_coreclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[2]} -of_objects [get_cells -hierarchical bufg_gt_coreclk -filter NAME=~*switch_dsp/*]]

set_case_analysis 1 [get_pins -filter {REF_PIN_NAME=~DIV[0]} -of_objects [get_cells -hierarchical bufg_gt_userclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[1]} -of_objects [get_cells -hierarchical bufg_gt_userclk -filter NAME=~*switch_dsp/*]]
set_case_analysis 0 [get_pins -filter {REF_PIN_NAME=~DIV[2]} -of_objects [get_cells -hierarchical bufg_gt_userclk -filter NAME=~*switch_dsp/*]]
...
set_clock_groups -name async0 -asynchronous -group [get_clocks {sys_clk_dsp}] -group [get_clocks GT_REFCLK0]
