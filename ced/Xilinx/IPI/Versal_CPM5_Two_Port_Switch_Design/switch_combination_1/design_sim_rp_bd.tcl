...
-20 RX_RATE_GROUP A RX_TERMINATION PROGRAMMABLE RX_TERMINATION_PROG_VALUE 800} \
    CONFIG.INTF0_PARENTID {design_sim_rp_pcie_phy_0} \
...
/pcie_phy/GT_TX2 QUAD0_TX3 /pcie_phy/GT_TX3} \
    CONFIG.PCIE_NO_OF_QUADS_BYPASS {true} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_net -net const_1b0_dout [get_bd_pins const_1b0/dout] [get_bd_pins gtwiz_versal_0/gtwiz_freerun_clk]
  connect_bd_net -net const_1b1_dout [get_bd_pins const_1b1/dout] [get_bd_pins bufg_gt_sysclk/BUFG_GT_CE]
  connect_bd_net -net gt_quad_0_ch0_phyready [get_bd_pins gtwiz_versal_0/QUAD0_ch0_phyready] [get_bd_pins pcie_phy/ch0_phyready]
  connect_bd_net -net gt_quad_0_ch0_phystatus [get_bd_pins gtwiz_versal_0/QUAD0_ch0_phystatus] [get_bd_pins pcie_phy/ch0_phystatus]
  connect_bd_net -net gt_quad_0_ch0_rxoutclk [get_bd_pins gtwiz_versal_0/QUAD0_RX0_outclk] [get_bd_pins pcie_phy/gt_rxoutclk]
  connect_bd_net -net gt_quad_0_ch0_txoutclk [get_bd_pins gtwiz_versal_0/QUAD0_TX0_outclk] [get_bd_pins pcie_phy/gt_txoutclk]
  connect_bd_net -net gt_quad_0_ch1_phyready  [get_bd_pins gtwiz_versal_0/QUAD0_ch1_phyready] [get_bd_pins pcie_phy/ch1_phyready]
  connect_bd_net -net gt_quad_0_ch1_phystatus [get_bd_pins gtwiz_versal_0/QUAD0_ch1_phystatus] [get_bd_pins pcie_phy/ch1_phystatus]
  connect_bd_net -net gt_quad_0_ch2_phyready [get_bd_pins gtwiz_versal_0/QUAD0_ch2_phyready] [get_bd_pins pcie_phy/ch2_phyready]
  connect_bd_net -net gt_quad_0_ch2_phystatus  [get_bd_pins gtwiz_versal_0/QUAD0_ch2_phystatus] [get_bd_pins pcie_phy/ch2_phystatus]
  connect_bd_net -net gt_quad_0_ch3_phyready  [get_bd_pins gtwiz_versal_0/QUAD0_ch3_phyready] [get_bd_pins pcie_phy/ch3_phyready]
  connect_bd_net -net gt_quad_0_ch3_phystatus  [get_bd_pins gtwiz_versal_0/QUAD0_ch3_phystatus] [get_bd_pins pcie_phy/ch3_phystatus]
  connect_bd_net -net pcie_phy_gt_pcieltssm  [get_bd_pins pcie_phy/gt_pcieltssm] [get_bd_pins gtwiz_versal_0/QUAD0_pcieltssm]
  connect_bd_net -net pcie_phy_gtrefclk  [get_bd_pins pcie_phy/gtrefclk] [get_bd_pins gtwiz_versal_0/QUAD0_GTREFCLK0]
  connect_bd_net -net pcie_phy_pcierstb  [get_bd_pins pcie_phy/pcierstb] [get_bd_pins gtwiz_versal_0/QUAD0_ch0_pcierstb] [get_bd_pins gtwiz_versal_0/QUAD0_ch1_pcierstb] [get_bd_pins gtwiz_versal_0/QUAD0_ch2_pcierstb] [get_bd_pins gtwiz_versal_0/QUAD0_ch3_pcierstb]
  ...
  connect_bd_net -net pcie_phy_phy_pclk [get_bd_pins pcie_phy/phy_pclk] [get_bd_pins pcie_versal_0/phy_pclk] [get_bd_pins gtwiz_versal_0/QUAD0_TX0_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_RX0_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_TX1_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_RX1_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_TX2_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_RX2_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_TX3_usrclk] [get_bd_pins gtwiz_versal_0/QUAD0_RX3_usrclk]
