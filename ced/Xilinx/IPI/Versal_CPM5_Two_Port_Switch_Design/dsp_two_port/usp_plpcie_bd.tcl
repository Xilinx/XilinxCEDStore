...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_0/TX0_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_TX0.0 /gt_quad_0/TX1_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_TX1.1 /gt_quad_0/TX2_GT_IP_Interface\
usp_plpcie_pcie_phy_0./pcie_phy/GT_TX2.2 /gt_quad_0/TX3_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_TX3.3 /gt_quad_0/RX0_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_RX0.0 /gt_quad_0/RX1_GT_IP_Interface\
usp_plpcie_pcie_phy_0./pcie_phy/GT_RX1.1 /gt_quad_0/RX2_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_RX2.2 /gt_quad_0/RX3_GT_IP_Interface usp_plpcie_pcie_phy_0./pcie_phy/GT_RX3.3} \
    CONFIG.GT_TYPE {GTYP} \
...
MULTI RX_BUFFER_RESET_ON_CB_CHANGE ENABLE RX_BUFFER_RESET_ON_COMMAALIGN DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET K28.5 RX_COMMA_VALID_ONLY 0} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_0 {/gt_quad_0 usp_plpcie_pcie_phy_0.IP_CH0,usp_plpcie_pcie_phy_0.IP_CH1,usp_plpcie_pcie_phy_0.IP_CH2,usp_plpcie_pcie_phy_0.IP_CH3 MSTRCLK 1,0,0,0 IS_CURRENT_QUAD\
1}} RX_QUAD_CH {RXQuad_0_/gt_quad_0 {/gt_quad_0 usp_plpcie_pcie_phy_0.IP_CH0,usp_plpcie_pcie_phy_0.IP_CH1,usp_plpcie_pcie_phy_0.IP_CH2,usp_plpcie_pcie_phy_0.IP_CH3 MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}}}\
\
    CONFIG.REFCLK_LIST {} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_net -net common_commands_in_0_1 [get_bd_ports common_commands_in_0] [get_bd_pins pcie_versal_0/common_commands_in]
  ...
  connect_bd_net -net pcie_versal_0_common_commands_out [get_bd_pins pcie_versal_0/common_commands_out] [get_bd_ports common_commands_out_0]
  ...
  connect_bd_net -net pcie_versal_0_pipe_tx_0_sigs [get_bd_pins pcie_versal_0/pipe_tx_0_sigs] [get_bd_ports pipe_tx_0_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_10_sigs [get_bd_pins pcie_versal_0/pipe_tx_10_sigs] [get_bd_ports pipe_tx_10_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_11_sigs [get_bd_pins pcie_versal_0/pipe_tx_11_sigs] [get_bd_ports pipe_tx_11_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_12_sigs [get_bd_pins pcie_versal_0/pipe_tx_12_sigs] [get_bd_ports pipe_tx_12_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_13_sigs [get_bd_pins pcie_versal_0/pipe_tx_13_sigs] [get_bd_ports pipe_tx_13_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_14_sigs [get_bd_pins pcie_versal_0/pipe_tx_14_sigs] [get_bd_ports pipe_tx_14_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_15_sigs [get_bd_pins pcie_versal_0/pipe_tx_15_sigs] [get_bd_ports pipe_tx_15_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_1_sigs [get_bd_pins pcie_versal_0/pipe_tx_1_sigs] [get_bd_ports pipe_tx_1_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_2_sigs [get_bd_pins pcie_versal_0/pipe_tx_2_sigs] [get_bd_ports pipe_tx_2_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_3_sigs [get_bd_pins pcie_versal_0/pipe_tx_3_sigs] [get_bd_ports pipe_tx_3_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_4_sigs [get_bd_pins pcie_versal_0/pipe_tx_4_sigs] [get_bd_ports pipe_tx_4_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_5_sigs [get_bd_pins pcie_versal_0/pipe_tx_5_sigs] [get_bd_ports pipe_tx_5_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_6_sigs [get_bd_pins pcie_versal_0/pipe_tx_6_sigs] [get_bd_ports pipe_tx_6_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_7_sigs [get_bd_pins pcie_versal_0/pipe_tx_7_sigs] [get_bd_ports pipe_tx_7_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_8_sigs [get_bd_pins pcie_versal_0/pipe_tx_8_sigs] [get_bd_ports pipe_tx_8_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_9_sigs [get_bd_pins pcie_versal_0/pipe_tx_9_sigs] [get_bd_ports pipe_tx_9_sigs_0]
  ...
  connect_bd_net -net pipe_rx_0_sigs_0_1 [get_bd_ports pipe_rx_0_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_0_sigs]
  connect_bd_net -net pipe_rx_10_sigs_0_1 [get_bd_ports pipe_rx_10_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_10_sigs]
  connect_bd_net -net pipe_rx_11_sigs_0_1 [get_bd_ports pipe_rx_11_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_11_sigs]
  connect_bd_net -net pipe_rx_12_sigs_0_1 [get_bd_ports pipe_rx_12_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_12_sigs]
  connect_bd_net -net pipe_rx_13_sigs_0_1 [get_bd_ports pipe_rx_13_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_13_sigs]
  connect_bd_net -net pipe_rx_14_sigs_0_1 [get_bd_ports pipe_rx_14_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_14_sigs]
  connect_bd_net -net pipe_rx_15_sigs_0_1 [get_bd_ports pipe_rx_15_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_15_sigs]
  connect_bd_net -net pipe_rx_1_sigs_0_1 [get_bd_ports pipe_rx_1_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_1_sigs]
  connect_bd_net -net pipe_rx_2_sigs_0_1 [get_bd_ports pipe_rx_2_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_2_sigs]
  connect_bd_net -net pipe_rx_3_sigs_0_1 [get_bd_ports pipe_rx_3_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_3_sigs]
  connect_bd_net -net pipe_rx_4_sigs_0_1 [get_bd_ports pipe_rx_4_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_4_sigs]
  connect_bd_net -net pipe_rx_5_sigs_0_1 [get_bd_ports pipe_rx_5_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_5_sigs]
  connect_bd_net -net pipe_rx_6_sigs_0_1 [get_bd_ports pipe_rx_6_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_6_sigs]
  connect_bd_net -net pipe_rx_7_sigs_0_1 [get_bd_ports pipe_rx_7_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_7_sigs]
  connect_bd_net -net pipe_rx_8_sigs_0_1 [get_bd_ports pipe_rx_8_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_8_sigs]
  connect_bd_net -net pipe_rx_9_sigs_0_1 [get_bd_ports pipe_rx_9_sigs_0] [get_bd_pins pcie_versal_0/pipe_rx_9_sigs]
