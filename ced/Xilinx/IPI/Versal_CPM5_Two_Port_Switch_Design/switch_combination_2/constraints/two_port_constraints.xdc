...
set_property LOC GTYP_QUAD_X1Y0 [get_cells -hierarchical -filter { PRIMITIVE_SUBGROUP==GT && NAME =~ *switch_usp*gtwiz_versal_0*}]
...
set_false_path -from [get_clocks -of_objects [get_pins gen_ext_pipe_sim_usp.switch_usp/gtwiz_versal_0/inst/intf_quad_map_inst/quad_top_inst/gt_quad_base_0_inst/inst/quad_inst/CH0_TXOUTCLK]] -to [get_clocks gen_ext_pipe_sim_dsp.switch_dsp/versal_cips_0/inst/cpm_0/inst/CPM_INST/CPM5RCLK0INT0] 
set_false_path -from [get_clocks -of_objects [get_pins gen_ext_pipe_sim_usp.switch_usp/pcie_phy/inst/diablo_gt_phy_wrapper/gt_top_i/diablo_gt_phy_wrapper/phy_clk_i/bufg_gt_userclk/O]] -to [get_clocks gen_ext_pipe_sim_dsp.switch_dsp/versal_cips_0/inst/cpm_0/inst/CPM_INST/CPM5RCLK0INT0] 
