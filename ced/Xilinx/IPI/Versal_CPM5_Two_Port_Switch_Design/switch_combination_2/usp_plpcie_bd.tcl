...
################################################################
# This is a generated script based on design: usp_plpcie
#
...
variable design_name_plpcie
set design_name_plpcie usp_plpcie

# If you do not already have an existing IP Integrator design open,
# you can create a design using the following command:
#    create_bd_design $design_name_plpcie
...
if { ${design_name_plpcie} eq "" } {
   # USE CASES:
   #    1) Design_name not set

   set errMsg "Please set the variable <design_name_plpcie> to a non-empty value."
   set nRet 1

} elseif { ${cur_design} ne "" && ${list_cells} eq "" } {
   # USE CASES:
   #    2): Current design opened AND is empty AND names same.
   #    3): Current design opened AND is empty AND names diff; design_name_plpcie NOT in project.
   #    4): Current design opened AND is empty AND names diff; design_name_plpcie exists in project.

   if { $cur_design ne $design_name_plpcie } {
      common::send_gid_msg -ssname BD::TCL -id 2001 -severity "INFO" "Changing value of <design_name_plpcie> from <$design_name_plpcie> to <$cur_design> since current design is empty."
      set design_name_plpcie [get_property NAME $cur_design]
   }
   common::send_gid_msg -ssname BD::TCL -id 2002 -severity "INFO" "Constructing design in IPI design <$cur_design>..."

} elseif { ${cur_design} ne "" && $list_cells ne "" && $cur_design eq $design_name_plpcie } {
   # USE CASES:
   #    5) Current design opened AND has components AND same names.

   set errMsg "Design <$design_name_plpcie> already exists in your project, please set the variable <design_name_plpcie> to another value."
   set nRet 1
} elseif { [get_files -quiet ${design_name_plpcie}.bd] ne "" } {
   # USE CASES: 
   #    6) Current opened design, has components, but diff names, design_name_plpcie exists in project.
   #    7) No opened design, design_name_plpcie exists in project.
   ...
   # USE CASES:
   #    8) No opened design, design_name_plpcie not in project.
   #    9) Current opened design, has components, but diff names, design_name_plpcie not in project.

   common::send_gid_msg -ssname BD::TCL -id 2003 -severity "INFO" "Currently there is no design <$design_name_plpcie> in project, so creating one..."

   create_bd_design $design_name_plpcie

   common::send_gid_msg -ssname BD::TCL -id 2004 -severity "INFO" "Making design <$design_name_plpcie> as current_bd_design."
   current_bd_design $design_name_plpcie

}

common::send_gid_msg -ssname BD::TCL -id 2005 -severity "INFO" "Currently the variable <design_name_plpcie> is equal to \"$design_name_plpcie\"."
...
proc create_root_design { parentCell } {
  ...
  set pcie_cfg_msix_internal [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:pcie4_cfg_msix_rtl:1.0 pcie_cfg_msix_internal ]
  ...
  set pcie_cfg_ext [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:pcie3_cfg_ext_rtl:1.0 pcie_cfg_ext ]
  ...
  set common_commands_in_0 [ create_bd_port -dir I -from 25 -to 0 common_commands_in_0 ]
  set common_commands_out_0 [ create_bd_port -dir O -from 25 -to 0 common_commands_out_0 ]
  set core_clk [ create_bd_port -dir O -type clk core_clk ]
  set phy_rdy_out [ create_bd_port -dir O phy_rdy_out ]
  set pipe_rx_0_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_0_sigs_0 ]
  set pipe_rx_10_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_10_sigs_0 ]
  set pipe_rx_11_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_11_sigs_0 ]
  set pipe_rx_12_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_12_sigs_0 ]
  set pipe_rx_13_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_13_sigs_0 ]
  set pipe_rx_14_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_14_sigs_0 ]
  set pipe_rx_15_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_15_sigs_0 ]
  set pipe_rx_1_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_1_sigs_0 ]
  set pipe_rx_2_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_2_sigs_0 ]
  set pipe_rx_3_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_3_sigs_0 ]
  set pipe_rx_4_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_4_sigs_0 ]
  set pipe_rx_5_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_5_sigs_0 ]
  set pipe_rx_6_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_6_sigs_0 ]
  set pipe_rx_7_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_7_sigs_0 ]
  set pipe_rx_8_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_8_sigs_0 ]
  set pipe_rx_9_sigs_0 [ create_bd_port -dir I -from 83 -to 0 pipe_rx_9_sigs_0 ]
  set pipe_tx_0_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_0_sigs_0 ]
  set pipe_tx_10_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_10_sigs_0 ]
  set pipe_tx_11_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_11_sigs_0 ]
  set pipe_tx_12_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_12_sigs_0 ]
  set pipe_tx_13_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_13_sigs_0 ]
  set pipe_tx_14_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_14_sigs_0 ]
  set pipe_tx_15_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_15_sigs_0 ]
  set pipe_tx_1_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_1_sigs_0 ]
  set pipe_tx_2_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_2_sigs_0 ]
  set pipe_tx_3_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_3_sigs_0 ]
  set pipe_tx_4_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_4_sigs_0 ]
  set pipe_tx_5_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_5_sigs_0 ]
  set pipe_tx_6_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_6_sigs_0 ]
  set pipe_tx_7_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_7_sigs_0 ]
  set pipe_tx_8_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_8_sigs_0 ]
  set pipe_tx_9_sigs_0 [ create_bd_port -dir O -from 83 -to 0 pipe_tx_9_sigs_0 ]
  ...
  set const_1b0 [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant const_1b0 ]

  # Create instance: const_1b1, and set properties
  set const_1b1 [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant const_1b1 ]
  set_property -dict [list \
    CONFIG.CONST_VAL {1} \
  ...
  set_property -dict [list \
    ...
    CONFIG.VFG0_MSIX_CAP_PBA_BIR {BAR_0} \
    CONFIG.VFG0_MSIX_CAP_PBA_OFFSET {00000050} \
    CONFIG.VFG0_MSIX_CAP_TABLE_BIR {BAR_0} \
    CONFIG.VFG0_MSIX_CAP_TABLE_OFFSET {00000040} \
    CONFIG.VFG0_MSIX_CAP_TABLE_SIZE {001} \
    ...
    CONFIG.pf4_base_class_menu {Memory_controller} \
    CONFIG.pf4_class_code_base {05} \
    CONFIG.pf4_class_code_interface {00} \
    CONFIG.pf4_class_code_sub {80} \
    CONFIG.pf4_msix_enabled {false} \
    CONFIG.pf4_sriov_bar5_prefetchable {false} \
    CONFIG.pf4_sub_class_interface_menu {Other_memory_controller} \
    CONFIG.pf4_vendor_id {10EE} \
    CONFIG.pf5_base_class_menu {Memory_controller} \
    CONFIG.pf5_class_code_base {05} \
    CONFIG.pf5_class_code_interface {00} \
    CONFIG.pf5_class_code_sub {80} \
    CONFIG.pf5_msix_enabled {false} \
    CONFIG.pf5_sriov_bar5_prefetchable {false} \
    CONFIG.pf5_sub_class_interface_menu {Other_memory_controller} \
    CONFIG.pf5_vendor_id {10EE} \
    CONFIG.pf6_base_class_menu {Memory_controller} \
    CONFIG.pf6_class_code_base {05} \
    CONFIG.pf6_class_code_interface {00} \
    CONFIG.pf6_class_code_sub {80} \
    CONFIG.pf6_msix_enabled {false} \
    CONFIG.pf6_sriov_bar5_prefetchable {false} \
    CONFIG.pf6_sub_class_interface_menu {Other_memory_controller} \
    CONFIG.pf6_vendor_id {10EE} \
    CONFIG.pf7_base_class_menu {Memory_controller} \
    CONFIG.pf7_class_code_base {05} \
    CONFIG.pf7_class_code_interface {00} \
    CONFIG.pf7_class_code_sub {80} \
    CONFIG.pf7_msix_enabled {false} \
    CONFIG.pf7_sriov_bar5_prefetchable {false} \
    CONFIG.pf7_sub_class_interface_menu {Other_memory_controller} \
...
-20 RX_RATE_GROUP A RX_TERMINATION PROGRAMMABLE RX_TERMINATION_PROG_VALUE 800} \
    CONFIG.INTF0_PARENTID {usp_plpcie_pcie_phy_0} \
    CONFIG.INTF0_PCIE_ENABLE {true} \
    CONFIG.INTF_PARENT_PIN_LIST {QUAD0_RX0 /pcie_phy/GT_RX0 QUAD0_RX1 /pcie_phy/GT_RX1 QUAD0_RX2 /pcie_phy/GT_RX2 QUAD0_RX3 /pcie_phy/GT_RX3 QUAD0_TX0 /pcie_phy/GT_TX0 QUAD0_TX1 /pcie_phy/GT_TX1 QUAD0_TX2\
/pcie_phy/GT_TX2 QUAD0_TX3 /pcie_phy/GT_TX3} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_intf_net -intf_net pcie_cfg_msix_internal_0_1 [get_bd_intf_ports pcie_cfg_msix_internal] [get_bd_intf_pins pcie_versal_0/pcie_cfg_msix_internal]
  ...
  connect_bd_intf_net -intf_net pcie_versal_0_pcie_cfg_ext [get_bd_intf_ports pcie_cfg_ext] [get_bd_intf_pins pcie_versal_0/pcie_cfg_ext]
  ...
  [get_bd_pins pcie_versal_0/sys_clk]
  connect_bd_net -net ccix_optimized_tlp_tx_and_rx_enable_1  [get_bd_ports ccix_optimized_tlp_tx_and_rx_enable] \
  [get_bd_pins pcie_versal_0/ccix_optimized_tlp_tx_and_rx_enable]
  connect_bd_net -net common_commands_in_0_1  [get_bd_ports common_commands_in_0] \
  [get_bd_pins pcie_versal_0/common_commands_in]
  ...
  [get_bd_pins pcie_versal_0/phy_userclk]
  connect_bd_net -net pcie_phy_phy_userclk2  [get_bd_pins pcie_phy/phy_userclk2] \
  [get_bd_pins pcie_versal_0/phy_userclk2]
  connect_bd_net -net pcie_versal_0_ccix_rx_credit_av  [get_bd_pins pcie_versal_0/ccix_rx_credit_av] \
  [get_bd_ports ccix_rx_credit_av]
  connect_bd_net -net pcie_versal_0_common_commands_out  [get_bd_pins pcie_versal_0/common_commands_out] \
  [get_bd_ports common_commands_out_0]
  connect_bd_net -net pcie_versal_0_core_clk  [get_bd_pins pcie_versal_0/core_clk] \
  [get_bd_ports core_clk]
  connect_bd_net -net pcie_versal_0_pcie_ltssm_state  [get_bd_pins pcie_versal_0/pcie_ltssm_state] \
  [get_bd_pins pcie_phy/pcie_ltssm_state]
  connect_bd_net -net pcie_versal_0_phy_rdy_out  [get_bd_pins pcie_versal_0/phy_rdy_out] \
  [get_bd_ports phy_rdy_out]
  connect_bd_net -net pcie_versal_0_pipe_tx_0_sigs  [get_bd_pins pcie_versal_0/pipe_tx_0_sigs] \
  [get_bd_ports pipe_tx_0_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_10_sigs  [get_bd_pins pcie_versal_0/pipe_tx_10_sigs] \
  [get_bd_ports pipe_tx_10_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_11_sigs  [get_bd_pins pcie_versal_0/pipe_tx_11_sigs] \
  [get_bd_ports pipe_tx_11_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_12_sigs  [get_bd_pins pcie_versal_0/pipe_tx_12_sigs] \
  [get_bd_ports pipe_tx_12_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_13_sigs  [get_bd_pins pcie_versal_0/pipe_tx_13_sigs] \
  [get_bd_ports pipe_tx_13_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_14_sigs  [get_bd_pins pcie_versal_0/pipe_tx_14_sigs] \
  [get_bd_ports pipe_tx_14_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_15_sigs  [get_bd_pins pcie_versal_0/pipe_tx_15_sigs] \
  [get_bd_ports pipe_tx_15_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_1_sigs  [get_bd_pins pcie_versal_0/pipe_tx_1_sigs] \
  [get_bd_ports pipe_tx_1_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_2_sigs  [get_bd_pins pcie_versal_0/pipe_tx_2_sigs] \
  [get_bd_ports pipe_tx_2_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_3_sigs  [get_bd_pins pcie_versal_0/pipe_tx_3_sigs] \
  [get_bd_ports pipe_tx_3_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_4_sigs  [get_bd_pins pcie_versal_0/pipe_tx_4_sigs] \
  [get_bd_ports pipe_tx_4_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_5_sigs  [get_bd_pins pcie_versal_0/pipe_tx_5_sigs] \
  [get_bd_ports pipe_tx_5_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_6_sigs  [get_bd_pins pcie_versal_0/pipe_tx_6_sigs] \
  [get_bd_ports pipe_tx_6_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_7_sigs  [get_bd_pins pcie_versal_0/pipe_tx_7_sigs] \
  [get_bd_ports pipe_tx_7_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_8_sigs  [get_bd_pins pcie_versal_0/pipe_tx_8_sigs] \
  [get_bd_ports pipe_tx_8_sigs_0]
  connect_bd_net -net pcie_versal_0_pipe_tx_9_sigs  [get_bd_pins pcie_versal_0/pipe_tx_9_sigs] \
  [get_bd_ports pipe_tx_9_sigs_0]
  connect_bd_net -net pcie_versal_0_user_clk  [get_bd_pins pcie_versal_0/user_clk] \
  [get_bd_ports user_clk]
  connect_bd_net -net pcie_versal_0_user_lnk_up  [get_bd_pins pcie_versal_0/user_lnk_up] \
  [get_bd_ports user_lnk_up]
  connect_bd_net -net pcie_versal_0_user_reset  [get_bd_pins pcie_versal_0/user_reset] \
  [get_bd_ports user_reset]
  connect_bd_net -net pipe_rx_0_sigs_0_1  [get_bd_ports pipe_rx_0_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_0_sigs]
  connect_bd_net -net pipe_rx_10_sigs_0_1  [get_bd_ports pipe_rx_10_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_10_sigs]
  connect_bd_net -net pipe_rx_11_sigs_0_1  [get_bd_ports pipe_rx_11_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_11_sigs]
  connect_bd_net -net pipe_rx_12_sigs_0_1  [get_bd_ports pipe_rx_12_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_12_sigs]
  connect_bd_net -net pipe_rx_13_sigs_0_1  [get_bd_ports pipe_rx_13_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_13_sigs]
  connect_bd_net -net pipe_rx_14_sigs_0_1  [get_bd_ports pipe_rx_14_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_14_sigs]
  connect_bd_net -net pipe_rx_15_sigs_0_1  [get_bd_ports pipe_rx_15_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_15_sigs]
  connect_bd_net -net pipe_rx_1_sigs_0_1  [get_bd_ports pipe_rx_1_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_1_sigs]
  connect_bd_net -net pipe_rx_2_sigs_0_1  [get_bd_ports pipe_rx_2_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_2_sigs]
  connect_bd_net -net pipe_rx_3_sigs_0_1  [get_bd_ports pipe_rx_3_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_3_sigs]
  connect_bd_net -net pipe_rx_4_sigs_0_1  [get_bd_ports pipe_rx_4_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_4_sigs]
  connect_bd_net -net pipe_rx_5_sigs_0_1  [get_bd_ports pipe_rx_5_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_5_sigs]
  connect_bd_net -net pipe_rx_6_sigs_0_1  [get_bd_ports pipe_rx_6_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_6_sigs]
  connect_bd_net -net pipe_rx_7_sigs_0_1  [get_bd_ports pipe_rx_7_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_7_sigs]
  connect_bd_net -net pipe_rx_8_sigs_0_1  [get_bd_ports pipe_rx_8_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_8_sigs]
  connect_bd_net -net pipe_rx_9_sigs_0_1  [get_bd_ports pipe_rx_9_sigs_0] \
  [get_bd_pins pcie_versal_0/pipe_rx_9_sigs]
