...
0x4 CLK_50_DDR_ITAP_DLY 0x2A CLK_50_DDR_OTAP_DLY 0x3 CLK_100_SDR_OTAP_DLY 0x3 CLK_200_SDR_OTAP_DLY 0x2} \
  ...
  set axi_noc2_s0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_noc2 axi_noc2_s0 ]
   ...
   if {[regexp "vek385_" $board_name]} {
    ...
    CONFIG.DDRMC5_CONFIG(DDRMC5_PERIODIC_READ) {DISABLE} \
  ...
  connect_bd_intf_net -intf_net CLK_IN_D_0_1 [get_bd_intf_ports lpddr5_clk0_1] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
