...
set prj_name project_rc_x16g4_sd
set design_top design_rc_wrapper

set_param cips.enableNocApertures false

create_project $prj_name $prj_name -part xcvc1902-vsva2197-2MP-e-S
set_property board_part xilinx.com:vck190:part0:2.2 [current_project] 
#source cpm_working.tcl 
#source bd.tcl
...
add_files -fileset constrs_1 -norecurse ./xdc/cpm_rc.xdc

make_wrapper -files [get_files ./$prj_name/$prj_name.srcs/sources_1/bd/design_rc/design_rc.bd] -top 
add_files -norecurse ./$prj_name/$prj_name.srcs/sources_1/bd/design_rc/hdl/design_rc_wrapper.v
...
write_hw_platform -fixed -force -include_bit -file design_rc_wrapper.xsa
