...
# ########################################################################
  ...
  set dma1_user_clk_0 [ create_bd_port -dir O -type clk dma1_user_clk_0 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M_AXIL:S_AXIL_1} \
 ] $dma1_user_clk_0
...
set_property CONFIG.PS_PMC_CONFIG { PS_PCIE_EP_RESET2_IO {PS_MIO 19} PS_PCIE_RESET {{ENABLE 1}} } [get_bd_cells versal_cips_1] }
  ...
  connect_bd_intf_net -intf_net axi_noc_0_M02_AXI [get_bd_intf_pins axi_noc_0/M02_AXI] [get_bd_intf_pins smartconnect_2/S00_AXI]
  ...
  connect_bd_net -net dma1_intrfc_resetn_0_1 [get_bd_ports dma1_intrfc_resetn_0] [get_bd_pins versal_cips_1/dma1_intrfc_resetn]
  connect_bd_net -net versal_cips_0_pl0_user_clk [get_bd_pins versal_cips_1/pl0_ref_clk] [get_bd_ports dma1_user_clk_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_noc_0/aclk2] [get_bd_pins pcie_qdma_mailbox_1/axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins versal_cips_1/dma1_intrfc_clk]
  ...
  connect_bd_net -net versal_cips_1_dma1_axi_aresetn [get_bd_pins versal_cips_1/dma1_axi_aresetn] [get_bd_ports dma1_axi_aresetn_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins pcie_qdma_mailbox_1/axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_2/aresetn]

  # Create address segments
  assign_bd_address -offset 0x020180000000 -range 0x00100000 -target_address_space [get_bd_addr_spaces versal_cips_1/CPM_PCIE_NOC_0] [get_bd_addr_segs M_AXIL/Reg] -force
