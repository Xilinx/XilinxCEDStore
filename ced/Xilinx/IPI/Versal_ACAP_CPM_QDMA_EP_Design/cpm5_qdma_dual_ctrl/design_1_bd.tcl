...
set_property CONFIG.PS_PMC_CONFIG { PS_PCIE_EP_RESET2_IO {PS_MIO 19} PS_PCIE_RESET {{ENABLE 1}} } [get_bd_cells versal_cips_1] }
  ...
  connect_bd_net -net versal_cips_0_dma0_axi_aresetn [get_bd_ports dma0_axi_aresetn_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins pcie_qdma_mailbox_0/axi_aresetn] [get_bd_pins pcie_qdma_mailbox_1/axi_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins smartconnect_2/aresetn] [get_bd_pins versal_cips_1/dma0_axi_aresetn]
  connect_bd_net -net versal_cips_0_pl0_user_clk [get_bd_ports dma0_user_clk_0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_noc_0/aclk2] [get_bd_pins pcie_qdma_mailbox_0/axi_aclk] [get_bd_pins pcie_qdma_mailbox_1/axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins versal_cips_1/dma0_intrfc_clk] [get_bd_pins versal_cips_1/dma1_intrfc_clk] [get_bd_pins versal_cips_1/pl0_ref_clk]
  connect_bd_net -net versal_cips_1_cpm_cor_irq [get_bd_ports cpm_cor_irq_0] [get_bd_pins versal_cips_1/cpm_cor_irq]
  connect_bd_net -net versal_cips_1_cpm_misc_irq [get_bd_ports cpm_misc_irq_0] [get_bd_pins versal_cips_1/cpm_misc_irq]
  connect_bd_net -net versal_cips_1_cpm_pcie_noc_axi0_clk [get_bd_pins axi_noc_0/aclk0] [get_bd_pins versal_cips_1/cpm_pcie_noc_axi0_clk]
  connect_bd_net -net versal_cips_1_cpm_pcie_noc_axi1_clk [get_bd_pins axi_noc_0/aclk1] [get_bd_pins versal_cips_1/cpm_pcie_noc_axi1_clk]
  connect_bd_net -net versal_cips_1_cpm_uncor_irq [get_bd_ports cpm_uncor_irq_0] [get_bd_pins versal_cips_1/cpm_uncor_irq]
  connect_bd_net -net versal_cips_1_dma1_axi_aresetn [get_bd_ports dma1_axi_aresetn_0] [get_bd_pins versal_cips_1/dma1_axi_aresetn]
