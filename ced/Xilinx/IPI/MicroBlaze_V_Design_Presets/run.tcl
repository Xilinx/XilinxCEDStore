...
if {[regexp "xcsu200p" $fpga_part]} {
...
} elseif { [regexp "xcvu" $fpga_part]||[regexp "xcku" $fpga_part] } {
    set mem_ctrl ddr4
    set mem_int /ddr4_0/addn_ui_clkout1
    } else {
    set mem_ctrl ddr3
    set mem_int /mig_7series_0/ui_addn_clk_0 
        ...
        set lpddrmc_board_interface [set lpddrmc_board_interface_1 ""]
...
if {[regexp -nocase {scu200} $board_name]} {
        ...
        if {([lsearch $temp_options Preset.VALUE] == -1) || ([lsearch $temp_options "Microcontroller"] != -1)} {
           ...
           if {[regexp scu35 $board_name] || [regexp scu200 $board_name]} {
              ...
              puts "INFO:: SpartanUS+ Board Selected"
                ...
                apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {sys_diff_clock ( System differential clock ) } Manual_Source {Auto}}  [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
            ...
            if {[regexp scu35 $board_name]} {
                puts "INFO:: SCU35 Board Selected"
                ...
                #      connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
                #     connect_bd_net -net mdm_1_Debug_SYS_Rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
                connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_axi_periph/aclk] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
                connect_bd_net -net microblaze_riscv_0_intr [get_bd_pins microblaze_riscv_0_xlconcat/dout] [get_bd_pins microblaze_riscv_0_axi_intc/intr]
                connect_bd_net [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
                # connect_bd_net [get_bd_pins microblaze_riscv_0_axi_intc/processor_rst] [get_bd_pins proc_sys_reset_0/mb_reset]
                #      connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset] [get_bd_pins microblaze_riscv_0_local_memory/SYS_Rst]
                ...
                if { $mem_ctrl != "ddr4" } {
                    ...
                    connect_bd_net -net microblaze_riscv_0_intr [get_bd_pins microblaze_riscv_0_xlconcat/dout] [get_bd_pins microblaze_riscv_0_axi_intc/intr]
                    connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/aresetn] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn]

                    if {[regexp sp701 $board_name]} {
                    connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_axi_periph/aclk] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
                    connect_bd_net -net rst_mig_7series_0_100M_mb_reset [get_bd_pins rst_mig_7series_0_100M/mb_reset] [get_bd_pins microblaze_riscv_0/Reset]
					} else {
                    connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_axi_periph/aclk] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_riscv_0_axi_intc/processor_clk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk] [get_bd_pins rst_mig_7series_0_100M/slowest_sync_clk]
                   ...
                   if {[regexp scu200 $board_name]} {
                        ...
                        # Create interface connections
                        apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {sys_diff_clock ( 200 MHz System differential clock ) } Manual_Source {Auto}}  [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
                        apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {reset ( FPGA Reset ) } Manual_Source {Auto}}  [get_bd_pins clk_wiz_1/reset]
                        apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {reset ( FPGA Reset ) } Manual_Source {Auto}}  [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
                        ...
                        connect_bd_intf_net -intf_net microblaze_riscv_0_interrupt [get_bd_intf_pins microblaze_riscv_0_axi_intc/interrupt] [get_bd_intf_pins microblaze_riscv_0/INTERRUPT]
                        connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset] [get_bd_pins microblaze_riscv_0_local_memory/SYS_Rst]
                       # connect_bd_net [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
                        connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/aresetn] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn]
                        ...
                        connect_bd_net -net microblaze_riscv_0_Clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_riscv_0/Clk] [get_bd_pins microblaze_riscv_0_axi_periph/aclk] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_riscv_0_local_memory/LMB_Clk]
                    ...
                    if { $ddr4_board_interface_1 != "" } {
                        ...
                        connect_bd_net -net rst_ddr4_0_100M_peripheral_aresetn [get_bd_pins rst_ddr4_0_100M/peripheral_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/aresetn] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn]
...
#                        apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {default_sysclk1_300 ( 300 MHz System differential clock1 ) } Manual_Source {Auto}}  [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
                        ...
                        # apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config { Clk {/clk_wiz_1/clk_out1 (100 MHz)} Freq {100} Ref_Clk0 {} Ref_Clk1 {} Ref_Clk2 {}}  [get_bd_pins axi_smartconnect_0/aclk]
                        connect_bd_net [get_bd_pins axi_smartconnect_0/aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]

                        #    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config { Clk {/clk_wiz_1/clk_out1 (100 MHz)} Freq {100} Ref_Clk0 {} Ref_Clk1 {} Ref_Clk2 {}}  [get_bd_pins axi_smartconnect_0/S00_ACLK]
                        #    apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config { Clk {/clk_wiz_1/clk_out1 (100 MHz)} Freq {100} Ref_Clk0 {} Ref_Clk1 {} Ref_Clk2 {}}  [get_bd_pins axi_smartconnect_0/S01_ACLK]
             ...
             puts "INFO: Application_Processor preset enabled"
              ...
              if { $mem_ctrl != "ddr4" } {
                ...
                apply_bd_automation -rule xilinx.com:bd_rule:microblaze_riscv -config { axi_intc {1} axi_periph {Enabled} cache {32KB} clk {/mig_7series_0/ui_addn_clk_0 (100 MHz)} debug_module {Debug Enabled} ecc {None} local_mem {128KB} preset {Application}}  [get_bd_cells microblaze_riscv_0]
                apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/mig_7series_0/ui_addn_clk_0 (100 MHz)} Clk_slave {/mig_7series_0/ui_clk (200 MHz)} Clk_xbar {Auto} Master {/microblaze_riscv_0 (Cached)} Slave {/mig_7series_0/S_AXI} ddr_seg {Auto} intc_ip {New AXI SmartConnect} master_apm {0}}  [get_bd_intf_pins mig_7series_0/S_AXI]
                apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {reset ( FPGA Reset ) } Manual_Source {Auto}}  [get_bd_pins mig_7series_0/sys_rst]
                connect_bd_net [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins rst_mig_7series_0_100M/ext_reset_in]

             if {[regexp sp701 $board_name]} {
                        set_property -dict [list CONFIG.G_TEMPLATE_LIST {7}] [get_bd_cells microblaze_riscv_0] }
...
#                puts "INFO:: scu200 Board Selected"
                        ...
                        # Create Application CED design with LPDDR5 for SCU200 Board
                        set mem_int /clk_wiz_1/clk_out1
                       ...
                       # connect_bd_net [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
                        connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins microblaze_riscv_0_axi_periph/aresetn] [get_bd_pins microblaze_riscv_0_axi_intc/s_axi_aresetn]
                        connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_riscv_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
                ...
                set usl_ethernet [lindex [board::get_board_component_interfaces *gmii*] 0]

                if { $usl_ethernet != "" } {

                    create_bd_cell -type ip -vlnv xilinx.com:ip:axi_ethernet:* axi_ethernet_0
                    apply_board_connection -board_interface "gem0_gmii" -ip_intf "axi_ethernet_0/gmii" -diagram $design_name
                    apply_board_connection -board_interface "gem0_mdio_mdc" -ip_intf "axi_ethernet_0/mdio" -diagram $design_name 
                    apply_board_connection -board_interface "gem0_phy_reset_out" -ip_intf "axi_ethernet_0/phy_rst_n" -diagram $design_name 
                    
                    set_property -dict [list \
                      CONFIG.RXMEM {32k} \
                      CONFIG.TXMEM {32k} \
                    ] [get_bd_cells axi_ethernet_0]
                    ...
                    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/clk_wiz_1/clk_out1 (100 MHz)} Clk_xbar {/clk_wiz_1/clk_out1 (100 MHz)} Master {/axi_ethernet_0_dma/M_AXI_MM2S} Slave {/lpddrmc_0/S0_AXI} ddr_seg {Auto} intc_ip {/axi_smc} master_apm {0}}  [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_MM2S]
                    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/clk_wiz_1/clk_out1 (100 MHz)} Clk_xbar {/clk_wiz_1/clk_out1 (100 MHz)} Master {/axi_ethernet_0_dma/M_AXI_S2MM} Slave {/lpddrmc_0/S0_AXI} ddr_seg {Auto} intc_ip {/axi_smc} master_apm {0}}  [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_S2MM]
                    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {/clk_wiz_1/clk_out1 (100 MHz)} Clk_xbar {/clk_wiz_1/clk_out1 (100 MHz)} Master {/axi_ethernet_0_dma/M_AXI_SG} Slave {/lpddrmc_0/S0_AXI} ddr_seg {Auto} intc_ip {/axi_smc} master_apm {0}}  [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_SG]
                    ...
                    ############################################################################    
                    # Create address segments and add static address for LPDDR5 from ethernet DMA
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_MM2S/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK]
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_MM2S/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK_1]
                     
                     assign_bd_address -offset 0x80000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_MM2S [get_bd_addr_segs lpddrmc_0/LPDDRMC_S0_AXI/LPDDRMC_ADDRESS_BLOCK] -force
                     assign_bd_address -offset 0xC0000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_MM2S [get_bd_addr_segs lpddrmc_0/LPDDRMC_S1_AXI/LPDDRMC_ADDRESS_BLOCK] -force
                     
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_S2MM/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK]
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_S2MM/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK_1]
                     
                     assign_bd_address -offset 0x80000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_S2MM [get_bd_addr_segs lpddrmc_0/LPDDRMC_S0_AXI/LPDDRMC_ADDRESS_BLOCK] -force
                     assign_bd_address -offset 0xC0000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_S2MM [get_bd_addr_segs lpddrmc_0/LPDDRMC_S1_AXI/LPDDRMC_ADDRESS_BLOCK] -force
                     
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_SG/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK]
                     include_bd_addr_seg [get_bd_addr_segs -excluded axi_ethernet_0_dma/Data_SG/SEG_lpddrmc_0_LPDDRMC_ADDRESS_BLOCK_1]
                     
                     assign_bd_address -offset 0x80000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_SG [get_bd_addr_segs lpddrmc_0/LPDDRMC_S0_AXI/LPDDRMC_ADDRESS_BLOCK] -force
                     assign_bd_address -offset 0xC0000000 -range 1G -target_address_space /axi_ethernet_0_dma/Data_SG [get_bd_addr_segs lpddrmc_0/LPDDRMC_S1_AXI/LPDDRMC_ADDRESS_BLOCK] -force

                     assign_bd_address
                     # puts "Debug: Application preset SCU200 Address assignment completed" 
                ...
                if { $ddr4_board_interface_1 != "" } {
                    ...
                    create_bd_cell -type ip -vlnv xilinx.com:ip:ddr4 ddr4_0
                    apply_board_connection -board_interface "$ddr4_board_interface_1" -ip_intf "ddr4_0/C0_DDR4" -diagram $design_name
                    apply_bd_automation -rule xilinx.com:bd_rule:microblaze_riscv -config { axi_intc {1} axi_periph {Enabled} cache {32KB} clk {/ddr4_0/addn_ui_clkout1 (100 MHz)} debug_module {Debug Enabled} ecc {None} local_mem {128KB} preset {Application}}  [get_bd_cells microblaze_riscv_0]
                    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/ddr4_0/addn_ui_clkout1 (100 MHz)} Clk_slave {/ddr4_0/c0_ddr4_ui_clk (300 MHz)} Clk_xbar {Auto} Master {/microblaze_riscv_0 (Cached)} Slave {/ddr4_0/C0_DDR4_S_AXI} ddr_seg {Auto} intc_ip {New AXI SmartConnect} master_apm {0}}  [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
                    ...
                    apply_bd_automation -rule xilinx.com:bd_rule:microblaze_riscv -config { axi_intc {1} axi_periph {Enabled} cache {32KB} clk {New Clocking Wizard} debug_module {Debug Enabled} ecc {None} local_mem {128KB} preset {Application}}  [get_bd_cells microblaze_riscv_0]
                    apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {default_sysclk1_300 ( 300 MHz System differential clock1 ) } Manual_Source {Auto}}  [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
                    apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {reset ( FPGA Reset ) } Manual_Source {Auto}}  [get_bd_pins clk_wiz_1/reset]
                    apply_bd_automation -rule xilinx.com:bd_rule:board -config { Board_Interface {reset ( FPGA Reset ) } Manual_Source {Auto}}  [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in]
                }
            ...
            if {($ddr3_board_interface_1 == "") && ($ddr4_board_interface_1 == "")} {
                ...
                set_property -dict [list CONFIG.NUM_SI {5} CONFIG.NUM_MI {1} CONFIG.NUM_MI {1}] [get_bd_cells axi_smartconnect_0]
                connect_bd_intf_net [get_bd_intf_pins microblaze_riscv_0/M_AXI_DC] -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/S00_AXI]
                connect_bd_intf_net [get_bd_intf_pins microblaze_riscv_0/M_AXI_IC] -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/S01_AXI]
                connect_bd_intf_net [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_SG] -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/S02_AXI]
                connect_bd_intf_net [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_MM2S] -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/S03_AXI]
                connect_bd_intf_net [get_bd_intf_pins axi_ethernet_0_dma/M_AXI_S2MM] -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/S04_AXI]

                connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_smartconnect_0/M00_AXI] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
        ...
        foreach iic $iic_list {
            ...
            if { $iic_cnt != 0} {
                ...
                #    apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/microblaze_0 (Periph)" Clk "Auto" }  [get_bd_intf_pins axi_iic_${iic_cnt}/S_AXI]
...
if {[regexp -nocase {scu200} $board_name]} {
    ...
    # SCU200 board file exposes UART interfaces exactly as: uart0 uartb uartc
    set uart0_ifc "uart0"
    set uartb_ifc "uartb"
    set uartc_ifc "uartc"

    puts "INFO: SCU200 UART interfaces: $uart_list"
    puts "INFO: Mapping UARTB->axi_uartlite_0, UARTC->axi_uartlite_1, UART0->axi_uartlite_2"

    # UARTB -> axi_uartlite_0
    create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite axi_uartlite_0
    set_property -dict [list CONFIG.C_BAUDRATE {115200}] [get_bd_cells axi_uartlite_0]
    apply_board_connection -board_interface "$uartb_ifc" -ip_intf "axi_uartlite_0/UART" -diagram $design_name
    lappend inpt axi_uartlite_0/interrupt

    # UARTC -> axi_uartlite_1
    create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite axi_uartlite_1
    set_property -dict [list CONFIG.C_BAUDRATE {115200}] [get_bd_cells axi_uartlite_1]
    apply_board_connection -board_interface "$uartc_ifc" -ip_intf "axi_uartlite_1/UART" -diagram $design_name
    lappend inpt axi_uartlite_1/interrupt

    # UART0 -> axi_uartlite_2
    create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite axi_uartlite_2
    set_property -dict [list CONFIG.C_BAUDRATE {115200}] [get_bd_cells axi_uartlite_2]
    apply_board_connection -board_interface "$uart0_ifc" -ip_intf "axi_uartlite_2/UART" -diagram $design_name
    lappend inpt axi_uartlite_2/interrupt

    # AXI connections (use your standard clock master; mem_int is used widely in your script)
    foreach u {0 1 2} {
        ...
        } $mem_int $mem_int $u]  [get_bd_intf_pins axi_uartlite_$u/S_AXI]
    }

} else {

    # ---- keep your original generic UART enumeration for other boards ----
        set uart_list [ get_board_component_interfaces -filter {BUSDEF_NAME == uart_rtl} ]
        set uart_cnt 0
        foreach uart $uart_list {

            if { $uart_cnt != 0} {
                create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite axi_uartlite_${uart_cnt}
                # apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/microblaze_0 (Periph)" Clk "Auto" }  [get_bd_intf_pins axi_uartlite_${uart_cnt}/S_AXI]
                apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/clk_wiz_1/clk_out1 (100 MHz)} Clk_slave {Auto} Clk_xbar {/clk_wiz_1/clk_out1 (100 MHz)} Master {/microblaze_riscv_0 (Periph)} Slave {/axi_uartlite_${uart_cnt}/S_AXI} ddr_seg {Auto} intc_ip {/microblaze_riscv_0_axi_periph} master_apm {0}}  [get_bd_intf_pins axi_uartlite_${uart_cnt}/S_AXI]
                set_property -dict [list CONFIG.C_BAUDRATE {115200}] [get_bd_cells axi_uartlite_${uart_cnt}]
                apply_board_connection -board_interface "$uart" -ip_intf "axi_uartlite_${uart_cnt}/UART" -diagram $design_name
                lappend inpt axi_uartlite_${uart_cnt}/interrupt
                set uart_cnt [expr $uart_cnt + 1]
