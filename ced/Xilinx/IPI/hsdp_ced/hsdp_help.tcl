...
proc createDesign {design_name options} {
  ...
  proc create_soft_design { parentCell design_name } {
    ...
    set_property -dict [ list \
     CONFIG.CPM_PCIE0_ARI_CAP_ENABLED {0} \
     ...
     CONFIG.CPM_PCIE1_ARI_CAP_ENABLED {0} \
     ...
     CONFIG.PMC_CRP_PL0_REF_CTRL_ACT_FREQMHZ {149.998505} \
     CONFIG.PMC_CRP_PL0_REF_CTRL_DIVISOR0 {8} \
     CONFIG.PMC_CRP_PL0_REF_CTRL_FREQMHZ {156.25} \
     ...
     CONFIG.PMC_MIO_TREE_SIGNALS {#####################################gpio_1_pin[37]#####rxd#txd##################################} \
     ...
     CONFIG.PS_CRL_IOU_SWITCH_CTRL_ACT_FREQMHZ {239.997604} \
     CONFIG.PS_CRL_IOU_SWITCH_CTRL_DIVISOR0 {5} \
     CONFIG.PS_CRL_IOU_SWITCH_CTRL_SRCSEL {PPLL} \
     ...
     CONFIG.PS_HSDP_EGRESS_TRAFFIC {PL} \
     CONFIG.PS_HSDP_INGRESS_TRAFFIC {PL} \
    ...
    set_property -dict [list CONFIG.PMC_MIO_37_OUTPUT_DATA {high} CONFIG.PMC_MIO_37_DIRECTION {out} CONFIG.PMC_MIO_37_USAGE {GPIO}] $versal_cips_0
    ...
    connect_bd_net -net bufg_gt_1_usrclk [get_bd_pins aurora_64b66b_0/rxusrclk_in] [get_bd_pins bufg_gt_1/usrclk] [get_bd_pins gt_quad_base/ch0_rxusrclk]
