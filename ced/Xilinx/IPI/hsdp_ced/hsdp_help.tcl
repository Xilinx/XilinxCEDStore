...
proc createDesign {design_name options} {
  ...
  } elseif {$gttype eq "GTM2"} {
    set util_ds_buf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf util_ds_buf ]
    set_property CONFIG.C_BUF_TYPE {IBUFDS_GTM2} $util_ds_buf
  } else {
    set util_ds_buf [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ds_buf util_ds_buf ]
...
set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net aurora_64b66b_0_diff_gt_ref_clock_1 [get_bd_intf_ports aurora_64b66b_0_diff_gt_ref_clock] [get_bd_intf_pins util_ds_buf/CLK_IN_D3]
  } else {
  ...
  connect_bd_net -net util_ds_buf_IBUF_OUT  [get_bd_pins util_ds_buf/IBUFDS_GTM2_O] [get_bd_pins gtwiz_versal_0/QUAD0_GTREFCLK0]
  } else {
  ...
  proc make_xdc {design_name options} {
    ...
    if {$gttype eq "GTM"} {
      ...
      set inst "${design_name}_i/util_ds_buf/U0/USE_IBUFDS_GTM2.GEN_IBUFDS_GTM2\[0\].IBUFDS_GTM2_U"
    } else {
