...
proc create_root_design { parentCell link_width lane_rate } {
  ...
  set_property -dict [list \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ASPM_L0P_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ASPM_L1_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ATS_PRI_CAP_EN) {1} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ECRC_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_EXT_CFG_SPACE_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_FLR_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_IDE_CAP_EN) {1} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D0_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D1_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D3COLD_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D3HOT_SUPPORT) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PRI_OST_PR_CAPACITY) {4} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PROTOCOL) PCIE_6_1 \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PTM_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_SELECTIVE_IDE_STREAM_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_TPH_CAP_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_VPD_CAP_EN) {1} \
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL1_LINK_WIDTH) $link_width \
    CONFIG.PS_PMC_CONFIG(CPM6_CTRL1_PROTOCOL) PCIE_6_1 \
    CONFIG.PS_PMC_CONFIG(PMC_CRP_PL0_REF_CTRL_FREQMHZ) {300} \
