...
class basic_cxl0_ep_type3_hdm2_nfm extends base_cxl_ep_type3_hdm2_nfm;

  `uvm_component_utils(basic_cxl0_ep_type3_hdm2_nfm)
  ...
  virtual function void end_of_elaboration_phase(uvm_phase phase);
    ...
    dut_cfg.cxl_cfg[0].dvsec_cxl_cap.hdm_range[2].hi = '0;
    dut_cfg.cxl_cfg[0].dvsec_cxl_cap.hdm_range[2].lo = 1'b1; //256 MB
  endfunction
