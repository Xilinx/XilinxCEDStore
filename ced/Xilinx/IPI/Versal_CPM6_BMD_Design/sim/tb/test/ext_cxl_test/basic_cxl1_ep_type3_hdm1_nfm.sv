 ...
 * EXTENDS
 * base_cxl_ep_type3_hdm1_nfm 
 * ACRONYMS
 * hdm = "host managed device memory"
 * nfm = "non-flit mode"
|*/

class basic_cxl1_ep_type3_hdm1_nfm extends base_cxl_ep_type3_hdm1_nfm;

  `uvm_component_utils(basic_cxl1_ep_type3_hdm1_nfm)
  ...
  function new(string name, uvm_component parent);
    ...
    timeout = $test$plusargs("AVERY_CPM6_COSIM") ? 999s : 400us;
  endfunction
