class seq_pl_isr_src extends seq_base_isr_src;

  `uvm_object_utils(seq_pl_isr_src)

  // Determine what to read
  bit [2:0] irq; //{corr, uncorr, misc}

  function new(string name = "seq_pl_isr_src");
    super.new(name);
    // Build the array 
    irqs[MISC]     = '{"PL_MISC",   32'hFCDD_03A0, 1'b1, 64'h0, 32'h0, 32'h0};
    irqs[UNCORR]   = '{"PL_UNCORR", 32'hFCDD_0380, 1'b1, 64'h0, 32'h0, 32'h0};
    irqs[CORR]     = '{"PL_CORR",   32'hFCDD_0360, 1'b1, 64'h0, 32'h0, 32'h0};
