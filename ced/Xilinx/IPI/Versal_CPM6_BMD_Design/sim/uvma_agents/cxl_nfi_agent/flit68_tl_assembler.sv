        ...
        _H0 : begin
                ...
                if (h0.dir == H2C) begin
                  ...
                  if (h0.d2hdat_hdr.val) begin
                    ...
                    d2hdat_h[0].txfer_64B = h0.hdr.sz;
                    if (d2hdat_h[0].txfer_64B) begin //full cacheline
                      d2hdat_h[0].be = !h0.hdr.be ? '1 : 'x;
                    end
                    else begin  // half cacheline (two chunks); specified by chunk valid (ch)
                      d2hdat_h[0].be[63:32] =  d2hdat_h[0].hdr68.ch && !h0.hdr.be ? '1 : 'x;
                      d2hdat_h[0].be[31: 0] = !d2hdat_h[0].hdr68.ch && !h0.hdr.be ? '1 : 'x;
        ...
        _H1 : begin
                ...
                if (h1.dir == H2C) begin
                  ...
                  if (h1.h2ddat_hdr.val) begin
                    ...
                    h2ddat_h[0].txfer_64B = h1.hdr.sz;
                  ...
                  if (h1.d2hdat_hdr.val) begin
                    ...
                    d2hdat_h[0].txfer_64B = h1.hdr.sz;
                    if (d2hdat_h[0].txfer_64B) begin //full cacheline
                      d2hdat_h[0].be = !h1.hdr.be ? '1 : 'x;
                    end
                    else begin  // half cacheline (two chunks); specified by chunk valid (ch)
                      d2hdat_h[0].be[63:32] =  d2hdat_h[0].hdr68.ch && !h1.hdr.be ? '1 : 'x;
                      d2hdat_h[0].be[31: 0] = !d2hdat_h[0].hdr68.ch && !h1.hdr.be ? '1 : 'x;
                      if (d2hdat_h[0].hdr68.ch && (dat_q.size==1)) 
                        dat_chunk_ptr = 2;
                    end
                  end
        ...
        _H2 : begin
                ...
                if (h2.dir == H2C) begin
                  ...
                  if (h2.h2ddat_hdr.val) begin
                    ...
                    h2ddat_h[0].txfer_64B = h2.hdr.sz;
                    if (!h2ddat_h[0].txfer_64B && h2ddat_h[0].hdr68.ch && (dat_q.size==1))
                      dat_chunk_ptr = 2;
                  end
                end 
                  ...
                  for (jj=0; jj<4; jj++) begin
                    if (h2.d2hdat_hdr[jj].val) begin
                      ...
                      d2hdat_h[jj].txfer_64B = h2.hdr.sz;
                      // MDH; sz=1 and BE=0 ALWAYS
                      if (d2hdat_h[jj].txfer_64B) begin //full cacheline
                        d2hdat_h[jj].be = !h2.hdr.be ? '1 : 'x;
                      end
                      else begin  // half cacheline (two chunks); specified by chunk valid (ch)
                        d2hdat_h[jj].be[63:32] =  d2hdat_h[jj].hdr68.ch && !h2.hdr.be ? '1 : 'x;
                        d2hdat_h[jj].be[31: 0] = !d2hdat_h[jj].hdr68.ch && !h2.hdr.be ? '1 : 'x;
                      end
                    end
                  end
                end
                ...
                if (h3.dir == H2C) begin
                  for (jj=0; jj<4; jj++) begin
                    if (h3.h2ddat_hdr[jj].val) begin
                      ...
                      h2ddat_h[jj].txfer_64B = h3.hdr.sz;
                      // MDH; sz=1 ALWAYS
                    end
                  end
                end 
                  ...
                  if (h3.s2mdrs_hdr.val) begin
                    ...
                    s2mdrs_h[0].txfer_64B = h3.hdr.sz;
                ...
                if (h5.dir == H2C) begin
                  ...
                  for (jj=0; jj<2; jj++) begin
                    if (h5.s2mdrs_hdr[jj].val) begin
                      ...
                      s2mdrs_h[jj].txfer_64B = h5.hdr.sz;
                    end
                  end
                end
              end 
                ...
                if (g3.dir == H2C) begin
                  ...
                  for (jj=0; jj<4; jj++) begin
                    if (g3.d2hdat_hdr[jj].val) begin
                      ...
                      d2hdat_h[jj].txfer_64B = hdr_sz;
                      // MDH; sz=1 and BE=0 ALWAYS
                      if (d2hdat_h[jj].txfer_64B) begin //full cacheline
                        d2hdat_h[jj].be = !hdr_be ? '1 : 'x;
                      end
                      else begin  // half cacheline (two chunks); specified by chunk valid (ch)
                        d2hdat_h[jj].be[63:32] =  d2hdat_h[jj].hdr68.ch && !hdr_be ? '1 : 'x;
                        d2hdat_h[jj].be[31: 0] = !d2hdat_h[jj].hdr68.ch && !hdr_be ? '1 : 'x;
                      end
                    end
                  end
                end
