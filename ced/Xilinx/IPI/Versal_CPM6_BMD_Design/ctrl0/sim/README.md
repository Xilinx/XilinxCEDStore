# Versal CPM6 BMD Example Design (CTRL0)

| Item | Summary |
|---|---|
| **Primary Purpose** | Demonstrates PCIe Gen6 Bus Master DMA (BMD) capability of the Versal CPM6 hard IP, using Controller 0 (CTRL0) as the Endpoint |
...
## Overview
This example design demonstrates Bus Master DMA (BMD) capability of the Versal CPM6 hard IP in a CTRL0-only PCIe Endpoint simulation configuration.

By working through this example design, you will learn how to:
- Configure CPM6 lane rate (16/32/64 GT/s) and link width (X1/X2/X4/X8) for Controller 0
