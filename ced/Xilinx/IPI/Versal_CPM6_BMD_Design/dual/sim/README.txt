================================================================================
  Versal CPM6 BMD Gen6 PIPE Simulation -- DUAL CTRL EP
  Controller: CTRL0 + CTRL1 (Dual Endpoint)
  Mode      : PIPE Simulation
================================================================================

Steps to run CPM6 BMD (Dual Controller) simulation
...
--------------------------------------------------------------------------------
Write (DMA):
  test_bmd_write_min_size_min_count
...
Custom (write + read, concurrent, hand-editable):
  test_bmd_write_read_custom   (default)
    -- Runs write and read DMA together. wr_size/wr_count/rd_size/rd_count
       are hardcoded in the test source -- edit
       test/tests/ext/traffic/other/test_bmd_write_read_custom.sv directly
       to change the traffic shape for a quick one-off run.
