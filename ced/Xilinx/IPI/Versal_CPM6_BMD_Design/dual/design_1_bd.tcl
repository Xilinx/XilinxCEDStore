...
proc create_root_design { parentCell link_width lane_rate } {
  ...
  set pcie1_cfg_status_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_cpm6:pcie_cfg_status_rtl:1.0 pcie1_cfg_status_0 ]

  set pcie1_flr_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_cpm6:pcie_flr_rtl:1.0 pcie1_flr_0 ]

  set pcie1_msi_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_cpm6:pcie_msi_rtl:1.0 pcie1_msi_0 ]

  set pcie1_msix_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_cpm6:pcie_msix_rtl:1.0 pcie1_msix_0 ]

  set pcie1_strm_0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:display_cpm6:pcie_strm_rtl:1.0 pcie1_strm_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_DSN_CAP_EN) {0} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PME_D0_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PME_D1_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PME_D3COLD_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PME_D3HOT_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PRI_OST_PR_CAPACITY) {4} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PROTOCOL) PCIE_6_1 \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_PTM_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_SELECTIVE_IDE_STREAM_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_TPH_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL0_VPD_CAP_EN) {0} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_DSN_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_ECRC_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_FLR_EN) {1} \
    ...
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_INTX_PIN) {INTA} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_BIR) {BAR_1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_PBA_OFFSET) {0x8000} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_TABLE_OFFSET) {0x0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSIX_VECTORS) {2048} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSI_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PF0_MSI_VECTORS) {32} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D0_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D1_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D3COLD_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PME_D3HOT_SUPPORT) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PRI_OST_PR_CAPACITY) {4} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PROTOCOL) PCIE_6_1 \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_PTM_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_SELECTIVE_IDE_STREAM_EN) {1} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_TPH_CAP_EN) {0} \
    CONFIG.CPM6_CONFIG(CPM6_CTRL1_VPD_CAP_EN) {0} \
  ...
  connect_bd_intf_net -intf_net pcie1_flr_0_1 [get_bd_intf_ports pcie1_flr_0] [get_bd_intf_pins ps_wizard_0/pcie1_flr]
  connect_bd_intf_net -intf_net pcie1_msi_0_1 [get_bd_intf_ports pcie1_msi_0] [get_bd_intf_pins ps_wizard_0/pcie1_msi]
  connect_bd_intf_net -intf_net pcie1_msix_0_1 [get_bd_intf_ports pcie1_msix_0] [get_bd_intf_pins ps_wizard_0/pcie1_msix]
  connect_bd_intf_net -intf_net pcie1_strm_0_1 [get_bd_intf_ports pcie1_strm_0] [get_bd_intf_pins ps_wizard_0/pcie1_strm]
  ...
  connect_bd_intf_net -intf_net ps_wizard_0_pcie1_cfg_status [get_bd_intf_ports pcie1_cfg_status_0] [get_bd_intf_pins ps_wizard_0/pcie1_cfg_status]
