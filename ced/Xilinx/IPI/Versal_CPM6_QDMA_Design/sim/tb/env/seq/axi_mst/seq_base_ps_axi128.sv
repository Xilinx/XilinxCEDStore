...
`ifdef CPM6_RTL
    ...
    // 4-10 cycle random band: small, nonzero handshake delay to inject
    // realistic WVALID/BREADY backpressure/jitter without materially
    // slowing the sim; not derived from any spec value.
