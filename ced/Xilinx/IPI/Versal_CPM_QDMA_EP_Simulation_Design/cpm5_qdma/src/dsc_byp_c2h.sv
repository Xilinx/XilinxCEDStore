...
//   assign c2h_st_marker_rsp = c2h_byp_out_rdy & c2h_byp_out_fmt & c2h_byp_out_vld;
   ...
   assign c2h_byp_out_rdy        = (c2h_byp_out_fmt == 3'b1) ? 1'b1 :
				   c2h_csh_byp & c2h_byp_out_st_mm ? (c2h_byp_out_mm_chn ? c2h_byp_in_mm_1_rdy : c2h_byp_in_mm_0_rdy) :
...
// MM
   ...
   assign c2h_byp_in_mm_0_vld    = (c2h_mm_marker_req | (c2h_csh_byp & ~c2h_byp_out_fmt[0] ? c2h_byp_out_st_mm & c2h_byp_out_vld : 1'b0)) && !c2h_byp_out_mm_chn;
   assign c2h_byp_in_mm_1_vld    = (c2h_mm_marker_req | (c2h_csh_byp & ~c2h_byp_out_fmt[0] ? c2h_byp_out_st_mm & c2h_byp_out_vld : 1'b0)) &&  c2h_byp_out_mm_chn;
