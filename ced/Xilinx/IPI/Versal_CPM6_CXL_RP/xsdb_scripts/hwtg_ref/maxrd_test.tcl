...
# performance monitors with read traffic to accurately measure read latency/bandwidth. 
# Each performance monitor uses a single URAM, which holds up to 4096 entries.
#   - Command 0 : 4096 reads to the CXL EP, incrementing by 64B
perf::reset_all
