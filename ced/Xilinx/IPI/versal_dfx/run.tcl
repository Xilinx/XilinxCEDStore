...
proc createDesign {design_name options} {
	...
	set clk_options { clk_out1 625 0 true clk_out2 250 1 false clk_out3 104.167 2 false }
	...
	set_property USER_COMMENTS.comment0 {An Example Versal DFX Extensible Embedded Platform
		...
		--> For Next steps, Refer to README.md : https://github.com/Xilinx/XilinxCEDStore/tree/2025.2/ced/Xilinx/IPI/versal_dfx/README.md}  [current_bd_design] 
	...
	regenerate_bd_layout -layout_string {
			   ...
			   "comment_0":"An Example Versal DFX Extensible Embedded Platform
				...
				--> BD has VIPs on the accelerator SmartConnect IPs because IPI platform can't handle export with no slaves on SmartConnect IP.
						Hence VIPs are there to have at least one slave on a smart connect.
				--> For Next steps, Refer to README.md : https://github.com/Xilinx/XilinxCEDStore/tree/2025.2/ced/Xilinx/IPI/versal_dfx/README.md ",
			   "commentid":"comment_0|",
			   "font_comment_0":"14",
			   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
				#  -string -flagsOSRD
				preplace cgraphic comment_0 place top 750 -150 textcolor 4 linecolor 3
				",
			   "linktoobj_comment_0":"",
