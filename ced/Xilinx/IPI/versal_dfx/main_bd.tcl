...
if { $use_intc } {
	...
	set_property CONFIG.ALL_PARAMS {HAS_SIGNAL_CONTROL 0 HAS_SIGNAL_STATUS 0 HAS_AXI_LITE 1 INTF {intf_0 {ID 0 VLNV xilinx.com:interface:aximm_rtl:1.0 MODE slave PROTOCOL AXI4 SIGNALS {ARVALID {WIDTH 1 PRESENT\ 
	1} ARREADY {WIDTH 1 PRESENT 1} AWVALID {WIDTH 1 PRESENT 1} AWREADY {WIDTH 1 PRESENT 1} BVALID {WIDTH 1 PRESENT 1} BREADY {WIDTH 1 PRESENT 1} RVALID {WIDTH 1 PRESENT 1} RREADY {WIDTH 1 PRESENT 1} WVALID\
	{WIDTH 1 PRESENT 1} WREADY {WIDTH 1 PRESENT 1} AWID {WIDTH 16 PRESENT 1} AWADDR {WIDTH 44 PRESENT 1} AWLEN {WIDTH 8 PRESENT 1} AWSIZE {WIDTH 3 PRESENT 1} AWBURST {WIDTH 2 PRESENT 1} AWLOCK {WIDTH 1 PRESENT 1}\
	AWCACHE {WIDTH 4 PRESENT 1} AWPROT {WIDTH 3 PRESENT 1} AWREGION {WIDTH 4 PRESENT 0} AWQOS {WIDTH 4 PRESENT 1} AWUSER {WIDTH 16 PRESENT 1} WID {WIDTH 16 PRESENT 1} WDATA {WIDTH 32 PRESENT 1} WSTRB {WIDTH\
	 4 PRESENT 1} WLAST {WIDTH 1 PRESENT 1} WUSER {WIDTH 4 PRESENT 1} BID {WIDTH 16 PRESENT 1} BRESP {WIDTH 2 PRESENT 1} BUSER {WIDTH 0 PRESENT 0} ARID {WIDTH 16 PRESENT 1} ARADDR {WIDTH 44 PRESENT 1} ARLEN\
	 {WIDTH 8 PRESENT 1} ARSIZE {WIDTH 3 PRESENT 1} ARBURST {WIDTH 2 PRESENT 1} ARLOCK {WIDTH 1 PRESENT 1} ARCACHE {WIDTH 4 PRESENT 1} ARPROT {WIDTH 3 PRESENT 1} ARREGION {WIDTH 4 PRESENT 0} ARQOS {WIDTH 4\
	 PRESENT 1} ARUSER {WIDTH 16 PRESENT 1} RID {WIDTH 16 PRESENT 1} RDATA {WIDTH 32 PRESENT 1} RRESP {WIDTH 2 PRESENT 1} RLAST {WIDTH 1 PRESENT 1} RUSER {WIDTH 4 PRESENT 1}}} intf_1 {ID 1 VLNV xilinx.com:signal:interrupt_rtl:1.0\
	MODE master SIGNALS {INTERRUPT {PRESENT 1 WIDTH 32}}} intf_3 {ID 2 VLNV xilinx.com:signal:clock_rtl:1.0 MODE slave SIGNALS {CLK {PRESENT 1 WIDTH 1 RESOURCE clk_buffer}}} intf_4 {ID 3 VLNV xilinx.com:signal:reset_rtl:1.0 MODE\
	slave SIGNALS {RST {PRESENT 1 WIDTH 1}}}} ALWAYS_HAVE_AXI_CLK 1 IPI_PROP_COUNT 0} $dfx_decoupler
}

if { $use_cascaded_irqs } {
	#set dfx_decoupler [create_bd_cell -type ip -vlnv xilinx.com:ip:dfx_decoupler:1.0 dfx_decoupler]
	set_property -dict [list CONFIG.ALL_PARAMS {HAS_SIGNAL_CONTROL 0 HAS_SIGNAL_STATUS 0 HAS_AXI_LITE 1 INTF {intf_0 {ID 0 VLNV xilinx.com:interface:aximm_rtl:1.0 MODE slave} intf_1 {ID 1 VLNV xilinx.com:signal:interrupt_rtl:1.0 MODE master} intf_2 {ID 2 VLNV xilinx.com:signal:interrupt_rtl:1.0 MODE master} intf_3 {ID 3 VLNV xilinx.com:signal:clock_rtl:1.0 MODE slave SIGNALS {CLK {PRESENT 1 WIDTH 1 RESOURCE clk_buffer}}} intf_4 {ID 4 VLNV xilinx.com:signal:reset_rtl:1.0 MODE slave}}}] $dfx_decoupler
}
...
if { $use_cascaded_irqs } {
	...
	set_property -dict [list CONFIG.IN0_WIDTH {31} CONFIG.NUM_PORTS {2} ] $ilconcat_0
}

# Create interface connections
connect_bd_intf_net -intf_net ShellSide_M_AXI [get_bd_intf_pins CIPS_0/M_AXI_FPD] [get_bd_intf_pins icn_ctrl_0/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins VitisRegion/${ddr_int}_0] [get_bd_intf_pins default_mem/S04_INI]
connect_bd_intf_net [get_bd_intf_pins VitisRegion/${ddr_int}_1] [get_bd_intf_pins default_mem/S05_INI]
connect_bd_intf_net [get_bd_intf_pins VitisRegion/${ddr_int}_2] [get_bd_intf_pins default_mem/S06_INI]
connect_bd_intf_net [get_bd_intf_pins VitisRegion/${ddr_int}_3] [get_bd_intf_pins default_mem/S07_INI]

if { $use_lpddr } {

	connect_bd_intf_net [get_bd_intf_pins VitisRegion/${LPDDR_int}_0] [get_bd_intf_pins additional_mem/S04_INI]
	connect_bd_intf_net [get_bd_intf_pins VitisRegion/${LPDDR_int}_1] [get_bd_intf_pins additional_mem/S05_INI]
	connect_bd_intf_net [get_bd_intf_pins VitisRegion/${LPDDR_int}_2] [get_bd_intf_pins additional_mem/S06_INI]
	connect_bd_intf_net [get_bd_intf_pins VitisRegion/${LPDDR_int}_3] [get_bd_intf_pins additional_mem/S07_INI]
	connect_bd_intf_net [get_bd_intf_pins additional_mem/S00_INI] [get_bd_intf_pins ps_noc/M04_INI]
	connect_bd_intf_net [get_bd_intf_pins additional_mem/S01_INI] [get_bd_intf_pins ps_noc/M05_INI]
	connect_bd_intf_net [get_bd_intf_pins additional_mem/S02_INI] [get_bd_intf_pins ps_noc/M06_INI]
	connect_bd_intf_net [get_bd_intf_pins additional_mem/S03_INI] [get_bd_intf_pins ps_noc/M07_INI]
...
connect_bd_net -net CtrlReset_peripheral_aresetn [get_bd_pins IsoReset/peripheral_aresetn]  [get_bd_pins dfx_decoupler/intf_0_arstn] [get_bd_pins dfx_decoupler/s_axi_reg_aresetn] [get_bd_pins icn_ctrl_0/aresetn]

connect_bd_net -net VitisRegion_Interrupt [get_bd_pins VitisRegion/Interrupt] [get_bd_pins dfx_decoupler/rp_intf_1_INTERRUPT]

connect_bd_net -net dfx_decoupler_clk_out [get_bd_pins VitisRegion/ExtClk] [get_bd_pins dfx_decoupler/rp_intf_3_CLK]
connect_bd_net -net dfx_decoupler_reset_out [get_bd_pins VitisRegion/ExtReset] [get_bd_pins dfx_decoupler/rp_intf_4_RST]
connect_bd_net [get_bd_pins dfx_decoupler/s_intf_3_CLK] [get_bd_pins clk_wizard_1/clk_out1]
connect_bd_net [get_bd_pins dfx_decoupler/s_intf_4_RST] [get_bd_pins IsoReset/peripheral_aresetn]
...
connect_bd_net -net clk_wizard_1_clk_out1 [get_bd_pins CIPS_0/m_axi_fpd_aclk] [get_bd_pins IsoReset/slowest_sync_clk]  [get_bd_pins clk_wizard_1/clk_out1] [get_bd_pins dfx_decoupler/aclk] [get_bd_pins dfx_decoupler/intf_0_aclk] [get_bd_pins icn_ctrl_0/aclk]
...
if { $use_cascaded_irqs } {
	...
	connect_bd_net -net axi_intc_cascaded_1_irq [get_bd_pins axi_intc_cascaded_1/irq] [get_bd_pins ilconcat_0/In1] 
	connect_bd_net -net axi_intc_parent_irq [get_bd_pins CIPS_0/pl_ps_irq0] [get_bd_pins axi_intc_parent/irq] 
	connect_bd_net -net ilconcat_0_dout [get_bd_pins axi_intc_parent/intr] [get_bd_pins ilconcat_0/dout]
	...
	connect_bd_net -net dfx_decoupler_s_intf_2_INTERRUPT [get_bd_pins dfx_decoupler/s_intf_2_INTERRUPT] [get_bd_pins ilconcat_0/In0]     
}

if { $use_intc } {
	connect_bd_net [get_bd_pins dfx_decoupler/s_intf_1_INTERRUPT] [get_bd_pins axi_intc_0/intr]
...
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 6G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_0]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 6G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_1]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 6G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_2]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 6G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_3]
} else {                                          
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 2G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_0]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 2G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_1]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 2G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_2]
set_property APERTURES { {{0x0 2G} {0x8_0000_0000 2G}}} [get_bd_intf_pins /VitisRegion/${ddr_int}_3]
}

if { $use_lpddr } {
set_property APERTURES { {{0x500_0000_0000 8G}}} [get_bd_intf_pins /VitisRegion/${LPDDR_int}_0]
set_property APERTURES { {{0x500_0000_0000 8G}}} [get_bd_intf_pins /VitisRegion/${LPDDR_int}_1]
set_property APERTURES { {{0x500_0000_0000 8G}}} [get_bd_intf_pins /VitisRegion/${LPDDR_int}_2]
set_property APERTURES { {{0x500_0000_0000 8G}}} [get_bd_intf_pins /VitisRegion/${LPDDR_int}_3]
}
set_property APERTURES { {{0xA700_0000 144M}}} [get_bd_intf_pins /VitisRegion/PL_CTRL_S_AXI]
