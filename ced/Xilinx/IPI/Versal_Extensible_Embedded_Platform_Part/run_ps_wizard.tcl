proc create_root_design {currentDir design_name use_lpddr clk_options irqs use_aie} {
	...
	if {[regexp "xc2v" $fpga_part] || [regexp "xa2ve3288" $fpga_part] || [regexp "xc10T21" $fpga_part]} {
	...
	} elseif {[regexp "xcvr1652" $fpga_part]|| [regexp "xcvr1602" $fpga_part] || [regexp "xc10S70" $fpga_part] } {
