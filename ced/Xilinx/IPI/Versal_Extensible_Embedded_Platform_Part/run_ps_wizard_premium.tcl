...
if { $bdc eq "true" } {
	set noc_ddr [get_bd_cells /ps_wiz_noc]
	set noc_lpddr [get_bd_cells /axi_noc_1]
	set pfm_bd_name "ext_bdc"
} else {
	set noc_ddr [get_bd_cells /noc_ddr4]
	set noc_lpddr [get_bd_cells /noc_lpddr4]
