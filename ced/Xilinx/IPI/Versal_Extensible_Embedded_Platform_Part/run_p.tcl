...
proc create_root_design {currentDir design_name use_lpddr clk_options irqs use_aie} {
	...
	# Create instance: ps_wizard, and set properties
	...
	CONFIG.PS_PMC_CONFIG(PMC_SD0_30AD_PERIPHERAL) {PRIMARY_ENABLE 0 SECONDARY_ENABLE 0 IO PMC_MIO_37:49 IO_TYPE MIO} \
	CONFIG.PS_PMC_CONFIG(PMC_SD0_30_PERIPHERAL) {PRIMARY_ENABLE 1 SECONDARY_ENABLE 0 IO PMC_MIO_37:49 IO_TYPE MIO} \
	CONFIG.PS_PMC_CONFIG(PMC_SD1_30_PERIPHERAL) {PRIMARY_ENABLE 0 SECONDARY_ENABLE 0 IO PMC_MIO_26:36 IO_TYPE MIO} \
	...
	create_bd_cell -type ip -vlnv xilinx.com:ip:axi_noc ps_wiz_noc
	...
	] [get_bd_cells ps_wiz_noc]
	set_property -dict [list CONFIG.CATEGORY {ps_cci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S00_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_cci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S01_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_cci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S02_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_cci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S03_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_nci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S04_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_nci} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S05_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_rpu} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S06_AXI]
	set_property -dict [list CONFIG.CATEGORY {ps_pmc} CONFIG.CONNECTIONS {M01_INI {read_bw {500} write_bw {500}} M00_INI {read_bw {500} write_bw {500}}}] [get_bd_intf_pins /ps_wiz_noc/S07_AXI]
	...
	set_property -dict [list CONFIG.CONNECTIONS {MC_0 {read_bw {500} write_bw {500} read_avg_burst {4} write_avg_burst {4}}}] [get_bd_intf_pins /noc_ddr4/S00_INI]
	...
	set_property -dict [list CONFIG.CONNECTIONS {MC_0 {read_bw {500} write_bw {500} read_avg_burst {4} write_avg_burst {4}}}] [get_bd_intf_pins /noc_lpddr4/S00_INI]

	make_bd_intf_pins_external  [get_bd_intf_pins noc_lpddr4/CH0_LPDDR4_0] [get_bd_intf_pins noc_ddr4/CH0_DDR4_0] [get_bd_intf_pins noc_lpddr4/CH1_LPDDR4_0] [get_bd_intf_pins noc_ddr4/sys_clk0] [get_bd_intf_pins noc_lpddr4/sys_clk0]

	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_CCI_NOC0] [get_bd_intf_pins ps_wiz_noc/S00_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_CCI_NOC1] [get_bd_intf_pins ps_wiz_noc/S01_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_CCI_NOC2] [get_bd_intf_pins ps_wiz_noc/S02_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_CCI_NOC3] [get_bd_intf_pins ps_wiz_noc/S03_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_AXI_NOC0] [get_bd_intf_pins ps_wiz_noc/S04_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_AXI_NOC1] [get_bd_intf_pins ps_wiz_noc/S05_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/LPD_AXI_NOC0] [get_bd_intf_pins ps_wiz_noc/S06_AXI]
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/PMC_AXI_NOC0] [get_bd_intf_pins ps_wiz_noc/S07_AXI]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_cci_noc0_clk] [get_bd_pins ps_wiz_noc/aclk0]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_cci_noc1_clk] [get_bd_pins ps_wiz_noc/aclk1]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_cci_noc2_clk] [get_bd_pins ps_wiz_noc/aclk2]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_cci_noc3_clk] [get_bd_pins ps_wiz_noc/aclk3]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_axi_noc0_clk] [get_bd_pins ps_wiz_noc/aclk4]
	connect_bd_net [get_bd_pins ps_wizard_0/fpd_axi_noc1_clk] [get_bd_pins ps_wiz_noc/aclk5]
	connect_bd_net [get_bd_pins ps_wizard_0/lpd_axi_noc0_clk] [get_bd_pins ps_wiz_noc/aclk6]
	connect_bd_net [get_bd_pins ps_wizard_0/pmc_axi_noc0_clk] [get_bd_pins ps_wiz_noc/aclk7]

	connect_bd_intf_net [get_bd_intf_pins ps_wiz_noc/M00_INI] [get_bd_intf_pins noc_ddr4/S00_INI]
	connect_bd_intf_net [get_bd_intf_pins ps_wiz_noc/M01_INI] [get_bd_intf_pins noc_lpddr4/S00_INI]
	
	# set slr_cnt [get_property SLRS [get_parts [get_property PART [current_project]]]]
	# if { $slr_cnt > 1 } {
		# set_property CONFIG.PS_PMC_CONFIG [subst { PMC_USE_PMC_NOC_AXI[ format %d [expr $slr_cnt - 1]] {1} SLR[format %d [expr $slr_cnt - 1]]_PMC_CRP_HSM0_REF_CTRL_FREQMHZ {33.333} }] [get_bd_cells ps_wizard_0]
	# }
	...
	#connect_bd_net -net $default_clock_net [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins ps_wiz_noc/aclk0] [get_bd_pins icn_ctrl/aclk] 
	connect_bd_net -net $default_clock_net [get_bd_pins ps_wizard_0/fpd_axi_pl_aclk] [get_bd_pins icn_ctrl/aclk] 
	...
	connect_bd_intf_net [get_bd_intf_pins ps_wizard_0/FPD_AXI_PL] [get_bd_intf_pins icn_ctrl/S00_AXI]
	...
	# catch {
		# exclude_bd_addr_seg [get_bd_addr_segs to_delete_kernel/S_AXI/Reg] -target_address_space [get_bd_addr_spaces ps_wizard_0/FPD_AXI_PL]
		# exclude_bd_addr_seg [get_bd_addr_segs to_delete_kernel_ctrl_0/S_AXI/Reg] -target_address_space [get_bd_addr_spaces ps_wizard_0/FPD_AXI_PL]
		# exclude_bd_addr_seg [get_bd_addr_segs to_delete_kernel_ctrl_1/S_AXI/Reg] -target_address_space [get_bd_addr_spaces ps_wizard_0/FPD_AXI_PL]
		# exclude_bd_addr_seg [get_bd_addr_segs to_delete_kernel_ctrl_2/S_AXI/Reg] -target_address_space [get_bd_addr_spaces ps_wizard_0/FPD_AXI_PL]
		# exclude_bd_addr_seg [get_bd_addr_segs to_delete_kernel_ctrl_3/S_AXI/Reg] -target_address_space [get_bd_addr_spaces ps_wizard_0/FPD_AXI_PL] 
	# }
...
foreach ddrmc_prop $fpga_part_prop {
	...
	if {([regexp "DDRMC" [lindex $ddrmc_prop 1 ]] == 1) && ([lindex $ddrmc_prop 3 ] < 2) } {
		set ddrmc_flag 0
	} elseif {$ddrmc_flag == 1} {
		set ddrmc_flag 1
	}
...
#Open BDC BD to Apply PFM properties
...
if { $bdc eq "true" } {
set_property PFM.AXI_PORT {S00_AXI {memport "S_AXI_NOC" sptag "DDR"} S01_AXI {memport "S_AXI_NOC" sptag "DDR"} S02_AXI {memport "S_AXI_NOC" sptag "DDR"} S03_AXI {memport "S_AXI_NOC" sptag "DDR"} S04_AXI {memport "S_AXI_NOC" sptag "DDR"} S05_AXI {memport "S_AXI_NOC" sptag "DDR"} S06_AXI {memport "S_AXI_NOC" sptag "DDR"} S07_AXI {memport "S_AXI_NOC" sptag "DDR"} S08_AXI {memport "S_AXI_NOC" sptag "DDR"} S09_AXI {memport "S_AXI_NOC" sptag "DDR"} S10_AXI {memport "S_AXI_NOC" sptag "DDR"} S11_AXI {memport "S_AXI_NOC" sptag "DDR"} S12_AXI {memport "S_AXI_NOC" sptag "DDR"} S13_AXI {memport "S_AXI_NOC" sptag "DDR"}} [get_bd_cells /ps_wiz_noc]

if { $use_lpddr } {
set_property PFM.AXI_PORT {S00_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S01_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S02_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S03_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S04_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S05_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S06_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S07_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S08_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S09_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S10_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S11_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S12_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S13_AXI {memport "S_AXI_NOC" sptag "LPDDR"}} [get_bd_cells /axi_noc_1]
set_property SELECTED_SIM_MODEL tlm [get_bd_cells /axi_noc_1] }

set_property SELECTED_SIM_MODEL tlm [get_bd_cells /ps_wiz_noc]
set_property PFM_NAME  $pfmName [get_files ext_bdc.bd]

} else {
set_property PFM.AXI_PORT {S00_AXI {memport "S_AXI_NOC" sptag "DDR"} S01_AXI {memport "S_AXI_NOC" sptag "DDR"} S02_AXI {memport "S_AXI_NOC" sptag "DDR"} S03_AXI {memport "S_AXI_NOC" sptag "DDR"} S04_AXI {memport "S_AXI_NOC" sptag "DDR"} S05_AXI {memport "S_AXI_NOC" sptag "DDR"} S06_AXI {memport "S_AXI_NOC" sptag "DDR"} S07_AXI {memport "S_AXI_NOC" sptag "DDR"} S08_AXI {memport "S_AXI_NOC" sptag "DDR"} S09_AXI {memport "S_AXI_NOC" sptag "DDR"} S10_AXI {memport "S_AXI_NOC" sptag "DDR"} S11_AXI {memport "S_AXI_NOC" sptag "DDR"} S12_AXI {memport "S_AXI_NOC" sptag "DDR"} S13_AXI {memport "S_AXI_NOC" sptag "DDR"}} [get_bd_cells /noc_ddr4]

if { $use_lpddr } {
set_property PFM.AXI_PORT {S00_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S01_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S02_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S03_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S04_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S05_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S06_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S07_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S08_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S09_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S10_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S11_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S12_AXI {memport "S_AXI_NOC" sptag "LPDDR"} S13_AXI {memport "S_AXI_NOC" sptag "LPDDR"}} [get_bd_cells /noc_lpddr4]
