...
module tb();
    ...
    always @ (posedge DUT.ext_platform_part_i.psx_wizard_0_pl_clk0) begin
        
        ps_0_pl_clk0_cnt = ps_0_pl_clk0_cnt + 1;
        
        if (DUT.ext_platform_part_i.psx_wizard_0_pl_resetn1) 
            begin 
            if(reset_cnt < 10)
            begin
    ...
    always @ (posedge DUT.ext_platform_part_i.clk_wizard_0_clk_out1) begin
