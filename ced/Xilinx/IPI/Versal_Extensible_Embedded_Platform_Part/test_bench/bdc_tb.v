...
module tb();
    ...
    // Process  to poll the pl_resetn
      always @ (posedge DUT.ext_platform_part_i.CIPS_0_pl_clk0) begin
      CIPS_0_pl_clk0_cnt = CIPS_0_pl_clk0_cnt + 1;
        if (DUT.ext_platform_part_i.CIPS_0_pl_resetn1) 
        begin 
          if(reset_cnt < 10)
          begin
      ...
      always @ (posedge DUT.ext_platform_part_i.ext_bdc.clk_wizard_0_clk_out1) begin
