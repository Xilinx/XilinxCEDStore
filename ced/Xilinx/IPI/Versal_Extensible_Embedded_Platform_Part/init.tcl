...
proc getSupportedParts {} {
	#return "versal"
	set mylist [get_parts -filter {C_FAMILY =~ versal && FAMILY !~ *versalnetes1*}]
	set newitem ""
foreach item $mylist {
...
proc addOptions {DESIGNOBJ PROJECT_PARAM.PART} {
    ...
    lappend x [dict create name "Clock_Options" type "string" value "clk_out1 156.250000 0 true clk_out2 104.166666 1 false clk_out3 312.500000 2 false" enabled true]
