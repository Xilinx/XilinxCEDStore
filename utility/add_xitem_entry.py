...
#    parser.add_argument('--catalog_file', help="Path of the store catalog file", required = False)
    parser.add_argument('--store_dir', help="Store Root Directory which has all the examples, catalog files", required = True)
    parser.add_argument('--output_file', help="Path of the design.xml file", required = False)
